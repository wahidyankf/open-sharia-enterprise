...
- **[Container Diagram](./blank-container-diagram.md)**: Shows the high-level technical building blocks of [Your System Name]
- **[Deployment Diagram](./blank-deployment-diagram.md)**: Shows how [Your System Name] is deployed to infrastructure
...
**See**: [Level 1: System Context](../ex-c4armo__01-level-1-system-context.md) for detailed guidance.
