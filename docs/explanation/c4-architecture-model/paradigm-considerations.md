...
- Component Diagram: See "Example: Order Service Components" in [Level 3: Component Diagram](./level-3-component.md#example-order-service-components-java-spring-boot-microservice)
- Code Diagram: See "Example 1" and "Example 2" in [Level 4: Code Diagram](./level-4-code.md)

**FP Examples**:

- Component Diagram: See "Functional Programming Approach" in [Level 3: Component (FP)](./level-3-component-fp.md)
- Code Diagram: See "Functional Programming Approach" in [Level 4: Code (FP)](./level-4-code-fp.md)

**Paradigm-Agnostic Examples**:

- System Context: See examples in [Level 1: System Context](./level-1-system-context.md)
- Container: See examples in [Level 2: Container](./level-2-container.md)
