...
See [Bounded Context Canvas Template](./ex-ddd__19-templates/bounded-context-canvas.md) for full template.
...
- [Event Storming Template](./ex-ddd__19-templates/event-storming-output.md)
...
- **[Event Storming Template](./ex-ddd__19-templates/event-storming-output.md)** - Run your first Event Storming workshop
- **[Bounded Context Canvas Template](./ex-ddd__19-templates/bounded-context-canvas.md)** - Document each bounded context
- **[Ubiquitous Language](./ex-ddd__02-ubiquitous-language.md)** - Refine terminology from workshops
- **[Bounded Contexts](./ex-ddd__03-bounded-contexts.md)** - Deepen understanding of context boundaries
- **[Context Mapping](./ex-ddd__04-context-mapping.md)** - Formalize context relationships
- **[Subdomains](./ex-ddd__05-subdomains.md)** - Classify and prioritize subdomains
