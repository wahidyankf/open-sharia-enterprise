...
- [Introduction to DDD](./ex-ddd__01-introduction-and-philosophy.md) - Core concepts overview
- [Strategic Design](./ex-ddd__03-bounded-contexts.md) - Bounded contexts and context mapping
- [Tactical Patterns](./ex-ddd__09-aggregates.md) - Entities, value objects, aggregates
- [Templates](./ex-ddd__19-templates/) - Practical templates for DDD artifacts
