...
See [Decision Trees and Best Practices](./ex-ddd__16-decision-trees-and-best-practices.md) for comprehensive decision guidance.
...
- **[Entities](./ex-ddd__07-entities.md)** - Understand identity-based objects within aggregates
- **[Value Objects](./ex-ddd__08-value-objects.md)** - Immutable values within aggregates
- **[Repositories](./ex-ddd__10-repositories.md)** - Persistence abstraction for aggregates
- **[Domain Events](./ex-ddd__12-domain-events.md)** - Eventual consistency between aggregates
- **[Decision Trees and Best Practices](./ex-ddd__16-decision-trees-and-best-practices.md)** - Practical aggregate design guidance
- **[Aggregate Design Template](./ex-ddd__19-templates/aggregate-design-template.md)** - Document your aggregates
