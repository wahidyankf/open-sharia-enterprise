...
- [Bounded Context Canvas](./bounded-context-canvas.md) for Zakat Calculation Context
- [Aggregate Design Template](./aggregate-design-template.md) for ZakatAssessment
- [Context Map Diagram](./context-map-diagram.md) showing all 4 contexts
- [Ubiquitous Language Glossary](./ubiquitous-language-glossary.md) for Zakat domain terms
...
- **[Bounded Context Canvas](./bounded-context-canvas.md)**: Formalize each discovered bounded context
- **[Aggregate Design Template](./aggregate-design-template.md)**: Detail aggregate structure and invariants
- **[Context Map Diagram](./context-map-diagram.md)**: Visualize context relationships
- **[Domain Event Catalog](./domain-event-catalog.md)**: Comprehensive event inventory
...
- **[Domain Events](../ex-ddd__12-domain-events.md)** - Event-driven architecture guide
