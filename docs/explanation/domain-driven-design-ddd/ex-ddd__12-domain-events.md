...
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Understand what publishes events
- **[Domain Services](./ex-ddd__11-domain-services.md)** - Services responding to events
- **[Bounded Contexts](./ex-ddd__03-bounded-contexts.md)** - Integration via events
- **[Context Mapping](./ex-ddd__04-context-mapping.md)** - Event publishing patterns
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - FP-style events
- **[Domain Event Catalog Template](./ex-ddd__19-templates/domain-event-catalog.md)** - Document your events
