...
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - Pure functional core fits naturally with layered architecture
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Core domain layer building blocks
- **[Repositories](./ex-ddd__10-repositories.md)** - Infrastructure layer persistence abstraction
- **[DDD and C4 Integration](./ex-ddd__17-ddd-and-c4-integration.md)** - Visualizing layers with C4 diagrams
