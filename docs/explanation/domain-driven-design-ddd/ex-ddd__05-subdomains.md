...
- **[Context Mapping](./ex-ddd__04-context-mapping.md)** - Map relationships between subdomains/contexts
- **[Bounded Contexts](./ex-ddd__03-bounded-contexts.md)** - Design solution-space models for subdomains
- **[Strategic Design Process](./ex-ddd__06-strategic-design-process.md)** - Discover subdomains through Event Storming
- **[Subdomain Classification Template](./ex-ddd__19-templates/README.md)** - Document your subdomain analysis
