...
- **[Layered Architecture](./ex-ddd__15-layered-architecture.md)** - Organizing pure domain core with impure infrastructure
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Consistency boundaries (applicable to both OOP and FP)
- **[Domain Events](./ex-ddd__12-domain-events.md)** - Event-driven patterns
- **[Decision Trees and Best Practices](./ex-ddd__16-decision-trees-and-best-practices.md)** - Practical guidance
