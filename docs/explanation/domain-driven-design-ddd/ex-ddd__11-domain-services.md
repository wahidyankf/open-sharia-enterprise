...
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Understand what domain services operate on
- **[Entities](./ex-ddd__07-entities.md)** - Objects domain services work with
- **[Value Objects](./ex-ddd__08-value-objects.md)** - Inputs/outputs of domain services
- **[Repositories](./ex-ddd__10-repositories.md)** - Data access abstraction
- **[Layered Architecture](./ex-ddd__15-layered-architecture.md)** - Where domain services fit
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - FP-style domain services
