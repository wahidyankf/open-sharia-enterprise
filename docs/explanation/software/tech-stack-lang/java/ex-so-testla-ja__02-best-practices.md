...
**Companion Document**: Before reading this document, familiarize yourself with common [Java Antipatterns](./ex-so-testla-ja__03-antipatterns.md) to understand what practices to avoid.
...
- [Java Idioms](./ex-so-testla-ja__01-idioms.md) - Common Java patterns and idiomatic constructs
- [Java Antipatterns](./ex-so-testla-ja__03-antipatterns.md) - Common mistakes and what to avoid
