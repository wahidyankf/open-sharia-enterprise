...
**Language Standards**: Also follow [Java](../../stack-lang/java/README.md) language standards.
...
- **[Java](../../stack-lang/java/README.md)** - Core Java language documentation
- **[Java Idioms](../../stack-lang/java/ex-so-stla-ja__idioms.md)** - Modern Java patterns
- **[Java Best Practices](../../stack-lang/java/ex-so-stla-ja__best-practices.md)** - Java coding standards
- **[Java Security](../../stack-lang/java/ex-so-stla-ja__security.md)** - Secure Java coding
- **[Java Performance](../../stack-lang/java/ex-so-stla-ja__performance.md)** - JVM tuning
...
- **[Java Programming Language](../../stack-lang/java/README.md)** - Java idioms and standards
