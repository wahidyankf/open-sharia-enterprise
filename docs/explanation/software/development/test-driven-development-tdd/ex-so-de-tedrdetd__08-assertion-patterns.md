...
- **[04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)** - FIRST principles and test structure
- **[06. Testing Patterns](ex-so-de-tedrdetd__06-testing-patterns.md)** - AAA pattern and test organization
- **[11. TDD and Functional Programming](ex-so-de-tedrdetd__11-tdd-and-functional-programming.md)** - Property-based testing assertions
- **[18. Best Practices](ex-so-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-so-de-tedrdetd__19-anti-patterns.md)** - Common assertion mistakes
