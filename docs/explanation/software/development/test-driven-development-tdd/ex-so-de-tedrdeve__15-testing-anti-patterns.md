...
- **[04. Unit Testing Fundamentals](./ex-so-de-tedrdeve__04-unit-testing-fundamentals.md)** - FIRST principles
- **[05. Test Doubles](./ex-so-de-tedrdeve__05-test-doubles.md)** - When to mock
- **[14. Refactoring with Tests](./ex-so-de-tedrdeve__14-refactoring-with-tests.md)** - Safe refactoring
- **[16. Decision Trees and Best Practices](./ex-so-de-tedrdeve__16-decision-trees-and-best-practices.md)** - When to use which test type
