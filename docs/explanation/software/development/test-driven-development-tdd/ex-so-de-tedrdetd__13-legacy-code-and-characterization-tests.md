...
- **[02. Red-Green-Refactor Cycle](ex-so-de-tedrdetd__02-red-green-refactor-cycle.md)** - Refactoring discipline
- **[05. Test Doubles](ex-so-de-tedrdetd__05-test-doubles.md)** - Fakes for breaking dependencies
- **[14. Refactoring with Tests](ex-so-de-tedrdetd__14-refactoring-with-tests.md)** - Safe refactoring patterns
- **[18. Best Practices](ex-so-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-so-de-tedrdetd__19-anti-patterns.md)** - Avoiding testability pitfalls
