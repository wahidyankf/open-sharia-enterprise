...
- **Related Files**:
  - [Core Concepts](ex-so-de-tedrdetd__01-introduction-and-philosophy.md)
  - [Decision Trees and Best Practices](ex-so-de-tedrdetd__15-decision-trees-and-best-practices.md)
...
- [Core Concepts](ex-so-de-tedrdetd__01-introduction-and-philosophy.md)
- [Red-Green-Refactor](ex-so-de-tedrdetd__02-red-green-refactor-cycle.md)
- [Testing Pyramid](ex-so-de-tedrdetd__03-test-types-and-pyramid.md)
