...
- **[03. Test Types and Testing Pyramid](./ex-so-de-tedrdeve__03-test-types-and-pyramid.md)** - Where integration tests fit
- **[04. Unit Testing Fundamentals](./ex-so-de-tedrdeve__04-unit-testing-fundamentals.md)** - Contrast with unit tests
- **[05. Test Doubles](./ex-so-de-tedrdeve__05-test-doubles.md)** - When to use real vs fake dependencies
