...
- **[Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)**: Deep dive into unit testing techniques
- **[Integration Testing](ex-so-de-tedrdetd__09-integration-testing.md)**: Contract testing, database integration
- **[End-to-End Testing](ex-so-de-tedrdetd__10-end-to-end-testing.md)**: Playwright, user journeys, Page Object Model
...
- **Related Files**:
  ...
  - [04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md) - Detailed unit testing
  - [09. Integration Testing](ex-so-de-tedrdetd__09-integration-testing.md) - Integration test patterns
  - [10. End-to-End Testing](ex-so-de-tedrdetd__10-end-to-end-testing.md) - E2E testing with Playwright
- **Prerequisites**: [02. Red-Green-Refactor Cycle](ex-so-de-tedrdetd__02-red-green-refactor-cycle.md)
- **Next Steps**: [04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)
