...
- **[03. Test Types and Testing Pyramid](ex-so-de-tedrdetd__03-test-types-and-pyramid.md)** - Where integration tests fit
- **[04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)** - Contrast with unit tests
- **[05. Test Doubles](ex-so-de-tedrdetd__05-test-doubles.md)** - When to use real vs fake dependencies
- **[07. Test Data Builders](ex-so-de-tedrdetd__07-test-data-builders.md)** - Building complex test data
- **[10. End-to-End Testing](ex-so-de-tedrdetd__10-end-to-end-testing.md)** - Next level up in pyramid
- **[12. TDD and DDD](ex-so-de-tedrdetd__12-tdd-and-ddd.md)** - Testing repositories and bounded contexts
