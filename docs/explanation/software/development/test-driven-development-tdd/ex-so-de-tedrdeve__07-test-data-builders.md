...
- **[04. Unit Testing Fundamentals](./ex-so-de-tedrdeve__04-unit-testing-fundamentals.md)** - Test structure and organization
- **[06. Testing Patterns](./ex-so-de-tedrdeve__06-testing-patterns.md)** - AAA pattern and test organization
- **[11. TDD and Functional Programming](./ex-so-de-tedrdeve__11-tdd-and-functional-programming.md)** - Builders for functional data structures
- **[12. TDD and DDD](./ex-so-de-tedrdeve__12-tdd-and-ddd.md)** - Builders for aggregates and value objects
