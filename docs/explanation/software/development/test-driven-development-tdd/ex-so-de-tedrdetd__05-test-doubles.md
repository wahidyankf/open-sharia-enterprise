...
- **[04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)** - Test structure and isolation principles
- **[06. Testing Patterns](ex-so-de-tedrdetd__06-testing-patterns.md)** - AAA, Given-When-Then, table-driven tests
- **[09. Integration Testing](ex-so-de-tedrdetd__09-integration-testing.md)** - When to use real dependencies vs test doubles
- **[18. Best Practices](ex-so-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-so-de-tedrdetd__19-anti-patterns.md)** - Common mistakes with test doubles
