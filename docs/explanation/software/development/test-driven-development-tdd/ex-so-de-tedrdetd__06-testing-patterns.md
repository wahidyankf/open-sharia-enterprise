...
See **[07. Test Data Builders](ex-so-de-tedrdetd__07-test-data-builders.md)** for comprehensive coverage.
...
- **[04. Unit Testing Fundamentals](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md)** - Test structure and FIRST principles
- **[05. Test Doubles](ex-so-de-tedrdetd__05-test-doubles.md)** - Mocks, stubs, fakes, spies
- **[07. Test Data Builders](ex-so-de-tedrdetd__07-test-data-builders.md)** - Builder pattern and Object Mother
- **[08. Assertion Patterns](ex-so-de-tedrdetd__08-assertion-patterns.md)** - Effective assertions and custom matchers
- **[11. TDD and Functional Programming](ex-so-de-tedrdetd__11-tdd-and-functional-programming.md)** - Property-based testing in depth
