...
- **[07. Test Data Builders](ex-so-de-tedrdetd__07-test-data-builders.md)** - Builders for aggregates and value objects
- **[09. Integration Testing](ex-so-de-tedrdetd__09-integration-testing.md)** - Repository persistence testing
- **[11. TDD and Functional Programming](ex-so-de-tedrdetd__11-tdd-and-functional-programming.md)** - Value objects as pure data
- **[14. Refactoring with Tests](ex-so-de-tedrdetd__14-refactoring-with-tests.md)** - Refactoring domain models safely
