...
> **Companion Document**: For common pitfalls to avoid, see [TDD Antipatterns](ex-so-de-tedrdetd__19-anti-patterns.md)
...
- [TDD Core Concepts](ex-so-de-tedrdetd__01-introduction-and-philosophy.md) - Three-phase cycle, benefits, principles
- [TDD vs Traditional Testing](ex-so-de-tedrdetd__02-red-green-refactor-cycle.md) - Comparison and contrasts
- [Red-Green-Refactor Cycle](ex-so-de-tedrdetd__03-test-types-and-pyramid.md) - Detailed cycle explanation

**TDD in Practice**:

- [Unit Testing in TDD](ex-so-de-tedrdetd__04-unit-testing-fundamentals.md) - Unit test strategies
- [Test Doubles and Mocking](ex-so-de-tedrdetd__05-test-doubles.md) - Mocks, stubs, fakes
- [TDD for Different Architectures](ex-so-de-tedrdetd__11-tdd-and-functional-programming.md) - TDD across architectures
- [TDD Metrics and Measurement](ex-so-de-tedrdetd__16-tdd-in-nx-monorepo.md) - Coverage and quality metrics

**Antipatterns**:

- [TDD Antipatterns](ex-so-de-tedrdetd__19-anti-patterns.md) - Common pitfalls and how to avoid them

**Related Testing Approaches**:

- [BDD Best Practices](../behavior-driven-development-bdd/ex-so-de-bedrdebd__17-best-practices.md) - BDD best practices
- [BDD Antipatterns](../behavior-driven-development-bdd/ex-so-de-bedrdebd__18-anti-patterns.md) - BDD antipatterns

**Process Integration**:

- [TDD in Agile Workflows](ex-so-de-tedrdetd__12-tdd-and-ddd.md) - Agile integration
- [TDD in CI/CD Pipelines](ex-so-de-tedrdetd__13-legacy-code-and-characterization-tests.md) - Continuous integration
