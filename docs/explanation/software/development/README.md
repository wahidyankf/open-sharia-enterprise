...
4. **Avoid common pitfalls** - Read [Testing Anti-Patterns](./test-driven-development-tdd/ex-so-de-tedrdeve__15-testing-anti-patterns.md) and [BDD Anti-Patterns](./behavior-driven-development-bdd/ex-so-de-bdd__16-anti-patterns-and-pitfalls.md)
