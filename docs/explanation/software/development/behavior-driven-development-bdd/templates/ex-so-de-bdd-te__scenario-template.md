...
- **Related Templates**:
  - [Feature File Template](./ex-so-de-bdd-te__feature-file-template.md)
  - [Scenario Outline Template](./ex-so-de-bdd-te__scenario-outline-template.md)
  - [Step Definition Template](./ex-so-de-bdd-te__step-definition-template.md)
...
- [Feature File Template](./ex-so-de-bdd-te__feature-file-template.md) - Organize scenarios into features
