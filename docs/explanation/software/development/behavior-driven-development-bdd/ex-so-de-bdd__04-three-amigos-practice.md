...
- **Related Files**:
  ...
  - [05. Example Mapping](./ex-so-de-bdd__05-example-mapping.md) - Structured Three Amigos technique
  - [06. Specification by Example](./ex-so-de-bdd__06-specification-by-example.md) - Concrete examples principle
...
- **Next Steps**: Read [Example Mapping](./ex-so-de-bdd__05-example-mapping.md) for structured workshop technique
