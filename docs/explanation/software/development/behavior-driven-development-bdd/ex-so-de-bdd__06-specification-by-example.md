...
(See [File 05: Example Mapping](./ex-so-de-bdd__05-example-mapping.md) for detailed technique)
...
- **Related Files**:
  ...
  - [05. Example Mapping](./ex-so-de-bdd__05-example-mapping.md) - Visual specification technique
  - [07. Discovery and Formulation](./ex-so-de-bdd__07-discovery-and-formulation.md) - Two-phase requirements process
...
- **Next Steps**: Read [Discovery and Formulation](./ex-so-de-bdd__07-discovery-and-formulation.md) for requirements process
