...
- [Best Practices](./ex-so-plwe-fera__best-practices.md)
- [Anti-Patterns](./ex-so-plwe-fera__anti-patterns.md)
- [TypeScript Best Practices](../../prog-lang/typescript/ex-so-prla-ts__best-practices.md)
- [Functional Programming](../../prog-lang/typescript/ex-so-prla-ts__functional-programming.md)
...
- **[TypeScript Best Practices](../../prog-lang/typescript/ex-so-prla-ts__best-practices.md)** - TypeScript standards
- **[Functional Programming](../../prog-lang/typescript/ex-so-prla-ts__functional-programming.md)** - FP patterns
