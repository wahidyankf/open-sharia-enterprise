...
- **[React Idioms](ex-so-plwe-fere__idioms.md)** - Idiomatic patterns
- **[React Best Practices](ex-so-plwe-fere__best-practices.md)** - Production standards
- **[Performance](ex-so-plwe-fere__performance.md)** - Optimization strategies
- **[TypeScript Anti-Patterns](../../prog-lang/typescript/ex-so-prla-ty__anti-patterns.md)** - TypeScript language anti-patterns
- **[Security Best Practices](ex-so-plwe-fere__security.md)** - Frontend security
