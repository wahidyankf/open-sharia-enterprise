...
- **[Best Practices](./ex-so-plwe-jvsp__best-practices.md)** - Production standards
- **[Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md)** - Common mistakes
- **[Configuration](./ex-so-plwe-jvsp__configuration.md)** - Configuration approaches
- **[Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md)** - IoC container deep-dive

### Language Standards

- **[Java](../../prog-lang/java/README.md)** - Java language documentation
- **[Java Idioms](../../prog-lang/java/ex-so-prla-ja__idioms.md)** - Java patterns
