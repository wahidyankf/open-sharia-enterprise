...
1. **[Idioms](./ex-so-plwe-jvsp__idioms.md)** - Spring Framework-specific patterns
2. **[Best Practices](./ex-so-plwe-jvsp__best-practices.md)** - Framework standards
3. **[Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md)** - Common mistakes
4. **[Configuration](./ex-so-plwe-jvsp__configuration.md)** - Configuration approaches
5. **[Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md)** - IoC patterns

**For Agents**: Reference this documentation when building Spring applications.

**Language Standards**: Also follow [Java](../../prog-lang/java/README.md) language standards. Kotlin language standards documentation is planned for future addition.

### Quick Standards Reference

- **Project Structure**: See [Architecture Integration](#architecture-integration)
- **IoC Container**: See [Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md)
- **AOP**: See [Aspect-Oriented Programming](./ex-so-plwe-jvsp__aop.md)
- **Data Access**: See [Data Access](./ex-so-plwe-jvsp__data-access.md)
- **Web MVC**: See [Web MVC](./ex-so-plwe-jvsp__web-mvc.md)
- **Testing**: See [Testing](./ex-so-plwe-jvsp__testing.md)
...
- [Idioms](./ex-so-plwe-jvsp__idioms.md) - Spring Framework patterns (IoC, DI, AOP, bean lifecycle)
- [Best Practices](./ex-so-plwe-jvsp__best-practices.md) - Framework coding standards
- [Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md) - Common Spring Framework mistakes
- [Configuration](./ex-so-plwe-jvsp__configuration.md) - Java config, XML, annotations, profiles
- [Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md) - IoC container, bean wiring
- [AOP](./ex-so-plwe-jvsp__aop.md) - Aspect-oriented programming, cross-cutting concerns
- [Data Access](./ex-so-plwe-jvsp__data-access.md) - JDBC, transactions, Spring Data
- [Web MVC](./ex-so-plwe-jvsp__web-mvc.md) - Web layer, controllers, REST
- [REST APIs](./ex-so-plwe-jvsp__rest-apis.md) - RESTful services with Spring MVC
- [Security](./ex-so-plwe-jvsp__security.md) - Spring Security fundamentals
- [Testing](./ex-so-plwe-jvsp__testing.md) - Spring TestContext framework
- [Performance](./ex-so-plwe-jvsp__performance.md) - Optimization, caching
- [Observability](./ex-so-plwe-jvsp__observability.md) - Monitoring and metrics
- [Deployment](./ex-so-plwe-jvsp__deployment.md) - Deployment strategies
- [Version Migration](./ex-so-plwe-jvsp__version-migration.md)- Upgrading Spring versions
...
### [Spring Framework Idioms](./ex-so-plwe-jvsp__idioms.md)
...
### [Spring Framework Best Practices](./ex-so-plwe-jvsp__best-practices.md)
...
### [Spring Framework Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md)
...
#### [Spring Framework Configuration](./ex-so-plwe-jvsp__configuration.md)
...
#### [Spring Framework Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md)
...
#### [Spring Framework AOP](./ex-so-plwe-jvsp__aop.md)
...
#### [Spring Framework Data Access](./ex-so-plwe-jvsp__data-access.md)
...
#### [Spring Framework Web MVC](./ex-so-plwe-jvsp__web-mvc.md)
...
#### [Spring Framework REST APIs](./ex-so-plwe-jvsp__rest-apis.md)
...
#### [Spring Framework Security](./ex-so-plwe-jvsp__security.md)
...
#### [Spring Framework Testing](./ex-so-plwe-jvsp__testing.md)
...
#### [Spring Framework Performance](./ex-so-plwe-jvsp__performance.md)
...
#### [Spring Framework Observability](./ex-so-plwe-jvsp__observability.md)
...
#### [Spring Framework Deployment](./ex-so-plwe-jvsp__deployment.md)
...
#### [Spring Framework Version Migration](./ex-so-plwe-jvsp__version-migration.md)
...
Read [Spring Framework Idioms](./ex-so-plwe-jvsp__idioms.md) and [Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md) to understand core concepts:
...
Read [Configuration](./ex-so-plwe-jvsp__configuration.md) for setup strategies:
...
Read [AOP](./ex-so-plwe-jvsp__aop.md) for cross-cutting concerns:
...
Read [Data Access](./ex-so-plwe-jvsp__data-access.md) for persistence:
...
Read [Web MVC](./ex-so-plwe-jvsp__web-mvc.md) and [REST APIs](./ex-so-plwe-jvsp__rest-apis.md):
...
Read [Best Practices](./ex-so-plwe-jvsp__best-practices.md) and [Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md):
...
- **[Java](../../prog-lang/java/README.md)** - Core Java language documentation
- **[Java Idioms](../../prog-lang/java/ex-so-prla-ja__idioms.md)** - Modern Java patterns
- **[Java Best Practices](../../prog-lang/java/ex-so-prla-ja__best-practices.md)** - Java coding standards
...
- **[Spring Framework Idioms](./ex-so-plwe-jvsp__idioms.md)** - Framework patterns
- **[Spring Framework Best Practices](./ex-so-plwe-jvsp__best-practices.md)** - Production standards
- **[Spring Framework Anti-Patterns](./ex-so-plwe-jvsp__anti-patterns.md)** - Common mistakes

### Core Concepts Documentation

- **[Configuration](./ex-so-plwe-jvsp__configuration.md)** - Configuration management
- **[Dependency Injection](./ex-so-plwe-jvsp__dependency-injection.md)** - IoC container
- **[AOP](./ex-so-plwe-jvsp__aop.md)** - Aspect-oriented programming
- **[Data Access](./ex-so-plwe-jvsp__data-access.md)** - JDBC and transactions

### Application Layer Documentation

- **[Web MVC](./ex-so-plwe-jvsp__web-mvc.md)** - Web applications
- **[REST APIs](./ex-so-plwe-jvsp__rest-apis.md)** - RESTful services
- **[Testing](./ex-so-plwe-jvsp__testing.md)** - Testing strategies
- **[Performance](./ex-so-plwe-jvsp__performance.md)** - Optimization
...
- **[Observability](./ex-so-plwe-jvsp__observability.md)** - Monitoring and metrics
- **[Deployment](./ex-so-plwe-jvsp__deployment.md)** - Deployment strategies
- **[Version Migration](./ex-so-plwe-jvsp__version-migration.md)** - Upgrading versions
...
- **[Java Programming Language](../../prog-lang/java/README.md)** - Java idioms and standards
