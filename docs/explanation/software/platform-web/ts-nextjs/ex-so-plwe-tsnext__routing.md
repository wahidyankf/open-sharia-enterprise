...
related:
  ...
  - ./ex-so-plwe-tsnext__middleware.md
  - ./ex-so-plwe-tsnext__idioms.md
principles:
...
- [App Router](./ex-so-plwe-tsnext__app-router.md) - File-system routing fundamentals
- [Middleware](./ex-so-plwe-tsnext__middleware.md) - Request-time routing logic
- [API Routes](./ex-so-plwe-tsnext__api-routes.md) - Backend routing
- [Server Components](./ex-so-plwe-tsnext__server-components.md) - Component-based routing

**Patterns**:

- [Idioms](./ex-so-plwe-tsnext__idioms.md) - Next.js routing patterns
