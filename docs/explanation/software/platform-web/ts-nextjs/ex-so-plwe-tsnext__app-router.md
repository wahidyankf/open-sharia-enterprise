...
- [Next.js Routing](./ex-so-plwe-tsnext__routing.md) - Advanced routing patterns
- [Server Components](./ex-so-plwe-tsnext__server-components.md) - RSC architecture
- [Data Fetching](./ex-so-plwe-tsnext__data-fetching.md) - Server-side data patterns
- [Idioms](./ex-so-plwe-tsnext__idioms.md) - Next.js patterns
...
- [Testing](./ex-so-plwe-tsnext__testing.md) - Testing App Router
