...
**Language Standards**: Also follow [TypeScript](../../prog-lang/typescript/README.md) and [React](../ts-react/README.md) standards.
...
- **[React Framework](../ts-react/README.md)** - React standards
