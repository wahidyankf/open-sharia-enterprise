...
- [Routing](./ex-so-plwe-tsnext__routing.md) - Route configuration
- [API Routes](./ex-so-plwe-tsnext__api-routes.md) - Backend endpoints
- [Security](./ex-so-plwe-tsnext__security.md) - Security patterns
