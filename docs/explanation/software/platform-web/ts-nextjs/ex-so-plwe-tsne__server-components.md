...
tags:
  ...
  - performance
related:
  - ./ex-so-plwe-tsnext__app-router.md
  - ./ex-so-plwe-tsnext__data-fetching.md
  - ./ex-so-plwe-tsnext__rendering.md
principles:
  - pure-functions
  - immutability
...
- [App Router](ex-so-plwe-tsne__app-router.md) - File-system routing
- [Data Fetching](ex-so-plwe-tsne__data-fetching.md) - Data patterns
- [Rendering](ex-so-plwe-tsne__rendering.md) - Rendering strategies
- [Streaming](ex-so-plwe-tsne__rendering.md#streaming) - Progressive rendering
...
- [TypeScript](ex-so-plwe-tsne__typescript.md) - Type patterns
- [Testing](ex-so-plwe-tsne__testing.md) - Testing Server Components
