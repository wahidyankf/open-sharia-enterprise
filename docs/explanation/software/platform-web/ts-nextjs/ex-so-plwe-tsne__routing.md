...
- [App Router](ex-so-plwe-tsne__app-router.md) - File-system routing fundamentals
- [Middleware](ex-so-plwe-tsne__middleware.md) - Request-time routing logic
- [API Routes](ex-so-plwe-tsne__api-routes.md) - Backend routing
- [Server Components](ex-so-plwe-tsne__server-components.md) - Component-based routing

**Patterns**:

- [Idioms](ex-so-plwe-tsne__idioms.md) - Next.js routing patterns
