...
- [API Routes](ex-so-plwe-tsne__api-routes.md) - Route handlers
- [Caching](ex-so-plwe-tsne__performance.md#caching-strategies) - Performance optimization

**Patterns**:

- [Idioms](ex-so-plwe-tsne__idioms.md) - Data fetching patterns
