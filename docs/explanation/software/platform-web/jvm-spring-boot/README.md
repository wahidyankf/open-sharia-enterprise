...
1. **[Idioms](./ex-so-plwe-jvspbo__idioms.md)** - Spring Boot-specific patterns
2. **[Best Practices](./ex-so-plwe-jvspbo__best-practices.md)** - Framework standards
3. **[Anti-Patterns](./ex-so-plwe-jvspbo__anti-patterns.md)** - Common mistakes
4. **[Configuration](./ex-so-plwe-jvspbo__configuration.md)** - Configuration management
5. **[Dependency Injection](./ex-so-plwe-jvspbo__dependency-injection.md)** - DI patterns

**For Agents**: Reference this documentation when building Spring Boot applications.

**Language Standards**: Also follow [Java](../../prog-lang/java/README.md) language standards.

### Quick Standards Reference

- **Project Structure**: See [Architecture Integration](#architecture-integration)
- **REST APIs**: See [REST APIs](./ex-so-plwe-jvspbo__rest-apis.md)
- **Data Access**: See [Data Access](./ex-so-plwe-jvspbo__data-access.md)
- **Security**: See [Security](./ex-so-plwe-jvspbo__security.md)
- **Testing**: See [Testing](./ex-so-plwe-jvspbo__testing.md)
...
**See Also**: [Functional Programming](./ex-so-plwe-jvspbo__functional-programming.md) for FP patterns with Spring Boot.
...
- [Idioms](./ex-so-plwe-jvspbo__idioms.md) - Spring Boot patterns (auto-configuration, component scanning, profiles)
- [Best Practices](./ex-so-plwe-jvspbo__best-practices.md) - Framework coding standards
- [Anti-Patterns](./ex-so-plwe-jvspbo__anti-patterns.md) - Common Spring Boot mistakes
- [Configuration](./ex-so-plwe-jvspbo__configuration.md) - application.yml, profiles, externalized config
- [Dependency Injection](./ex-so-plwe-jvspbo__dependency-injection.md) - Constructor injection, bean scopes
- [REST APIs](./ex-so-plwe-jvspbo__rest-apis.md) - RESTful services, validation, exception handling
- [Data Access](./ex-so-plwe-jvspbo__data-access.md) - Spring Data JPA, repositories, transactions
- [Security](./ex-so-plwe-jvspbo__security.md) - Spring Security, OAuth2, JWT
- [Testing](./ex-so-plwe-jvspbo__testing.md) - @SpringBootTest, slices, TestContainers
- [Observability](./ex-so-plwe-jvspbo__observability.md) - Actuator, metrics, health checks
- [Performance](./ex-so-plwe-jvspbo__performance.md) - Optimization, caching, async processing
- [Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md) - DDD with Spring Boot
- [Functional Programming](./ex-so-plwe-jvspbo__functional-programming.md) - FP patterns with Spring
- [Version Migration](./ex-so-plwe-jvspbo__version-migration.md) - Upgrading Spring Boot versions
...
### [Spring Boot Idioms](./ex-so-plwe-jvspbo__idioms.md)
...
### [Spring Boot Best Practices](./ex-so-plwe-jvspbo__best-practices.md)
...
### [Spring Boot Anti-Patterns](./ex-so-plwe-jvspbo__anti-patterns.md)
...
#### [Spring Boot Configuration](./ex-so-plwe-jvspbo__configuration.md)
...
#### [Spring Boot Dependency Injection](./ex-so-plwe-jvspbo__dependency-injection.md)
...
#### [Spring Boot REST APIs](./ex-so-plwe-jvspbo__rest-apis.md)
...
#### [Spring Boot Data Access](./ex-so-plwe-jvspbo__data-access.md)
...
#### [Spring Boot Security](./ex-so-plwe-jvspbo__security.md)
...
#### [Spring Boot Testing](./ex-so-plwe-jvspbo__testing.md)
...
#### [Spring Boot Observability](./ex-so-plwe-jvspbo__observability.md)
...
#### [Spring Boot Performance](./ex-so-plwe-jvspbo__performance.md)
...
#### [Spring Boot Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md)
...
#### [Spring Boot Functional Programming](./ex-so-plwe-jvspbo__functional-programming.md)
...
#### [Spring Boot Version Migration](./ex-so-plwe-jvspbo__version-migration.md)
...
Read [Spring Boot Idioms](./ex-so-plwe-jvspbo__idioms.md) to understand framework patterns:
...
Read [Spring Boot Best Practices](./ex-so-plwe-jvspbo__best-practices.md) for production standards:
...
Read [Spring Boot Anti-Patterns](./ex-so-plwe-jvspbo__anti-patterns.md) to prevent common mistakes:
...
- [Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md)
- [Java DDD Patterns](../../prog-lang/java/ex-so-prla-ja__domain-driven-design.md)
- [Functional Programming](./ex-so-plwe-jvspbo__functional-programming.md)
...
- **[Java Security](../../prog-lang/java/ex-so-prla-ja__security.md)** - Secure Java coding
- **[Java Performance](../../prog-lang/java/ex-so-prla-ja__performance.md)** - JVM tuning
...
- **[Dependency Injection](./ex-so-plwe-jvspbo__dependency-injection.md)** - IoC container
- **[REST APIs](./ex-so-plwe-jvspbo__rest-apis.md)** - RESTful web services
- **[Data Access](./ex-so-plwe-jvspbo__data-access.md)** - Spring Data JPA

### Advanced Topics

- **[Security](./ex-so-plwe-jvspbo__security.md)** - Spring Security integration
- **[Testing](./ex-so-plwe-jvspbo__testing.md)** - Testing strategies
- **[Observability](./ex-so-plwe-jvspbo__observability.md)** - Monitoring and metrics
- **[Performance](./ex-so-plwe-jvspbo__performance.md)** - Optimization

### Integration Documentation

- **[Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md)** - DDD with Spring Boot
- **[Functional Programming](./ex-so-plwe-jvspbo__functional-programming.md)** - FP patterns
- **[Version Migration](./ex-so-plwe-jvspbo__version-migration.md)** - Upgrading versions
