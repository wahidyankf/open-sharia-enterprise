...
related:
  ...
  - ./ex-so-plwe-jvspbo__domain-driven-design.md
...
- [Idioms](./ex-so-plwe-jvspbo__idioms.md) - Common Spring Boot patterns
- [Best Practices](./ex-so-plwe-jvspbo__best-practices.md) - Production best practices
- [Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md) - DDD patterns
- [Data Access](./ex-so-plwe-jvspbo__data-access.md) - Database access patterns
...
- Review [Domain-Driven Design](./ex-so-plwe-jvspbo__domain-driven-design.md) for DDD patterns
- Explore [Data Access](./ex-so-plwe-jvspbo__data-access.md) for database patterns
