...
Production-ready code templates for Spring Boot applications in the open-sharia-enterprise platform.
...
Copy templates and adapt to your domain model. All templates follow platform conventions and best practices.
