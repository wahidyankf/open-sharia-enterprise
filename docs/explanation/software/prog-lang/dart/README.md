...
1. **[Idioms](./ex-so-prla-da__idioms.md)** - Dart-specific patterns and conventions
2. **[Best Practices](./ex-so-prla-da__best-practices.md)** - Clean code standards
3. **[Anti-Patterns](./ex-so-prla-da__anti-patterns.md)** - Common mistakes to avoid

**For Agents**: Reference this documentation when writing Dart code.

### Quick Standards Reference

- **Naming Conventions**: See [Best Practices - Code Organization](./ex-so-prla-da__best-practices.md#code-organization)
- **Null Safety**: See [Null Safety](./ex-so-prla-da__null-safety.md)
- **Error Handling**: See [Error Handling](./ex-so-prla-da__error-handling.md)
- **Async Patterns**: See [Async Programming](./ex-so-prla-da__async-programming.md)
- **Testing Standards**: See [Testing](./ex-so-prla-da__testing.md)
- **Security Practices**: See [Security](./ex-so-prla-da__security.md)
...
**See Also**: [Functional Programming](./ex-so-prla-da__functional-programming.md) for pure functions patterns, [Best Practices](./ex-so-prla-da__best-practices.md) for explicit coding standards, [Null Safety](./ex-so-prla-da__null-safety.md) for type-safe patterns.
...
### [Dart Idioms](./ex-so-prla-da__idioms.md)
...
### [Dart Best Practices](./ex-so-prla-da__best-practices.md)
...
### [Dart Anti-Patterns](./ex-so-prla-da__anti-patterns.md)
...
#### [Null Safety](./ex-so-prla-da__null-safety.md)
...
#### [Async Programming](./ex-so-prla-da__async-programming.md)
...
#### [Collections](./ex-so-prla-da__collections.md)
...
#### [Object-Oriented Programming](./ex-so-prla-da__oop.md)
...
#### [Functional Programming](./ex-so-prla-da__functional-programming.md)
...
#### [Error Handling](./ex-so-prla-da__error-handling.md)
...
#### [Testing](./ex-so-prla-da__testing.md)
...
#### [Performance](./ex-so-prla-da__performance.md)
...
#### [Security](./ex-so-prla-da__security.md)
...
#### [Flutter Integration](./ex-so-prla-da__flutter.md)
...
#### [Server-Side Dart](./ex-so-prla-da__server-side.md)
...
#### [Version Migration](./ex-so-prla-da__version-migration.md)
...
- [Dart Idioms](./ex-so-prla-da__idioms.md) - Learn Dart-specific patterns
- [Null Safety](./ex-so-prla-da__null-safety.md) - Master null safety system
- [Collections](./ex-so-prla-da__collections.md) - Work with List, Set, Map

### 2. Master Async Programming

**For Intermediate Developers**:

- [Async Programming](./ex-so-prla-da__async-programming.md) - Future and Stream
- [Error Handling](./ex-so-prla-da__error-handling.md) - Robust error management
- [Testing](./ex-so-prla-da__testing.md) - Write reliable tests

### 3. Advanced Patterns

**For Advanced Developers**:

- [Object-Oriented Programming](./ex-so-prla-da__oop.md) - Advanced OOP
- [Functional Programming](./ex-so-prla-da__functional-programming.md) - FP patterns
- [Performance](./ex-so-prla-da__performance.md) - Optimization techniques

### 4. Platform-Specific

**For Flutter Development**:

- [Flutter Integration](./ex-so-prla-da__flutter.md) - Flutter-specific patterns

**For Backend Development**:

- [Server-Side Dart](./ex-so-prla-da__server-side.md) - Building APIs
...
- **[Dart Idioms](./ex-so-prla-da__idioms.md)** - Language patterns
- **[Dart Best Practices](./ex-so-prla-da__best-practices.md)** - Coding standards
- **[Dart Anti-Patterns](./ex-so-prla-da__anti-patterns.md)** - Common mistakes

### Language Features

- **[Null Safety](./ex-so-prla-da__null-safety.md)** - Sound null safety system
- **[Async Programming](./ex-so-prla-da__async-programming.md)** - Future and Stream
- **[Collections](./ex-so-prla-da__collections.md)** - List, Set, Map
- **[OOP](./ex-so-prla-da__oop.md)** - Object-oriented programming
- **[Functional Programming](./ex-so-prla-da__functional-programming.md)** - FP patterns

### Application Development

- **[Flutter Integration](./ex-so-prla-da__flutter.md)** - Flutter-specific patterns
- **[Server-Side Dart](./ex-so-prla-da__server-side.md)** - Backend development
- **[Testing](./ex-so-prla-da__testing.md)** - Testing strategies
- **[Performance](./ex-so-prla-da__performance.md)** - Optimization
- **[Security](./ex-so-prla-da__security.md)** - Security best practices
