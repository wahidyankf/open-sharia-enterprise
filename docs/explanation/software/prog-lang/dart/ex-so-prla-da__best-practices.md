...
tags:
  ...
  - performance
related:
  - ./ex-so-prla-da__idioms.md
  - ./ex-so-prla-da__anti-patterns.md
  - ./ex-so-prla-da__null-safety.md
  - ./ex-so-prla-da__testing.md
  - ./ex-so-prla-da__performance.md
...
- [Null Safety](./ex-so-prla-da__null-safety.md) - Sound null safety
...
- [Error Handling](./ex-so-prla-da__error-handling.md) - Exception handling
