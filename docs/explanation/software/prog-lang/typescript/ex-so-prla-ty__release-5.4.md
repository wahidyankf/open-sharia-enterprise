...
- **[TypeScript Best Practices](ex-so-prla-ty__best-practices.md)** - Coding standards and patterns
- **[TypeScript 5.0 Release](ex-so-prla-ty__release-5.0.md)** - Previous major release (decorators, const type parameters)
