...
If you need a Component diagram, use the [Blank Component Diagram Template](./ex-so-ar-c4armo-te__blank-component-diagram.md) to document the internal structure of one container (typically the API Service).
...
For detailed infrastructure mapping, see [Deployment Diagram Template](./ex-so-ar-c4armo-te__blank-deployment-diagram.md).
...
- **[Blank Context Diagram](./ex-so-ar-c4armo-te__blank-context-diagram.md)** - Template for creating system context diagrams
- **[Blank Container Diagram](./ex-so-ar-c4armo-te__blank-container-diagram.md)** - Template for creating container diagrams
- **[Blank Component Diagram](./ex-so-ar-c4armo-te__blank-component-diagram.md)** - Template for creating component diagrams
- **[Blank Deployment Diagram](./ex-so-ar-c4armo-te__blank-deployment-diagram.md)** - Template for creating deployment diagrams
- **[Color Palette Reference](./ex-so-ar-c4armo-te__color-palette.md)** - WCAG-compliant color palette
