...
- **[Container Diagram](./ex-so-ar-c4armo-te__blank-container-diagram.md)**: Shows the containers involved in this workflow
- **[Component Diagram](./ex-so-ar-c4armo-te__blank-component-diagram.md)**: Shows internal components of API Service
...
**See**: [Supplementary Diagrams: Dynamic Diagram](../ex-so-ar-c4armo__07-supplementary-diagrams.md#dynamic-diagram) for detailed guidance.
