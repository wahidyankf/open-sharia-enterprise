...
- **[Container Diagram](./ex-so-ar-c4armo-te__blank-container-diagram.md)**: Shows the containers being deployed
- **[System Context Diagram](./ex-so-ar-c4armo-te__blank-context-diagram.md)**: Shows where this system fits in the broader ecosystem
...
**See**: [Supplementary Diagrams: Deployment Diagram](../ex-so-ar-c4armo__07-supplementary-diagrams.md#deployment-diagram) for detailed guidance and additional examples (Kubernetes, serverless, edge computing, multi-region).
