...
**See**: [Paradigm Considerations](../ex-so-ar-c4armo__10-paradigm-considerations.md) for detailed examples.
...
- **[Best Practices](../ex-so-ar-c4armo__09-best-practices.md)** - When to use C4, common mistakes
