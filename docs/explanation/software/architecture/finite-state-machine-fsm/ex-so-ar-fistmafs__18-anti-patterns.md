...
> **Companion Document**: For positive guidance on what to do, see [Best Practices](ex-so-ar-fistmafs__17-best-practices.md)
...
- **Best Practices**: [ex-so-ar-fsm\_\_18-best-practices.md](ex-so-ar-fistmafs__17-best-practices.md)
...
When you catch yourself implementing any of these anti-patterns, step back and ask: **Am I adding clarity or confusion?** If the answer is confusion, refactor to follow FSM best practices. For positive guidance, refer to the [Best Practices](ex-so-ar-fistmafs__17-best-practices.md) document.
