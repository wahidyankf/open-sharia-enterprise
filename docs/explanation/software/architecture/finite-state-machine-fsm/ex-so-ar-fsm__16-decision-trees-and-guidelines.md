...
- Knowledge of different frameworks (see `ex-so-ar-fsm__13-framework-spring-state-machine-xstate.md` and `ex-so-ar-fsm__14-framework-statecharts-temporal-cadence.md`)
