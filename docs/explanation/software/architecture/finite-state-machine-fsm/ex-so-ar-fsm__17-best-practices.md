...
> **Companion Document**: For common mistakes to avoid, see [Anti-Patterns](./ex-so-ar-fsm__18-anti-patterns.md)
...
- **Decision Guidelines**: [ex-so-ar-fsm\_\_16-decision-trees-and-guidelines.md](./ex-so-ar-fsm__16-decision-trees-and-guidelines.md)
- **Anti-Patterns**: [ex-so-ar-fsm\_\_19-anti-patterns.md](./ex-so-ar-fsm__18-anti-patterns.md)
