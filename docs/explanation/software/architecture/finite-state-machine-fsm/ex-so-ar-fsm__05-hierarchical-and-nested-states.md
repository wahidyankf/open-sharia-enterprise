...
- [FSM Types and Classifications](./ex-so-ar-fsm__03-fsm-types-and-classifications.md) - Introduction to hierarchical FSMs
- [State Explosion and Mitigation](./ex-so-ar-fsm__04-state-explosion-and-mitigation.md) - Hierarchy as mitigation strategy
- [Events, Guards, and Actions](./ex-so-ar-fsm__06-events-guards-and-actions.md) - Event propagation in hierarchies
- [Decision Trees and Guidelines](./ex-so-ar-fsm__16-decision-trees-and-guidelines.md) - When to use hierarchy
...
1. **Learn transition mechanics**: Read [Events, Guards, and Actions](./ex-so-ar-fsm__06-events-guards-and-actions.md)
2. **Study design patterns**: Read [Design Patterns and Best Practices](./ex-so-ar-fsm__07-design-patterns-and-best-practices.md)
