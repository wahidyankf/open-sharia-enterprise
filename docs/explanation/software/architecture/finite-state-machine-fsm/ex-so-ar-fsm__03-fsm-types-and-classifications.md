...
- [Core Concepts and Terminology](./ex-so-ar-fsm__02-core-concepts-and-terminology.md) - Foundation concepts
- [State Explosion and Mitigation](./ex-so-ar-fsm__04-state-explosion-and-mitigation.md) - Deep dive on avoiding state explosion
- [Hierarchical and Nested States](./ex-so-ar-fsm__05-hierarchical-and-nested-states.md) - Comprehensive hierarchical FSM patterns
- [Decision Trees and Guidelines](./ex-so-ar-fsm__16-decision-trees-and-guidelines.md) - Which FSM type to choose
...
1. **Avoid state explosion**: Read [State Explosion and Mitigation](./ex-so-ar-fsm__04-state-explosion-and-mitigation.md)
2. **Master hierarchical states**: Read [Hierarchical and Nested States](./ex-so-ar-fsm__05-hierarchical-and-nested-states.md)
3. **Learn transition mechanics**: Read [Events, Guards, and Actions](./ex-so-ar-fsm__06-events-guards-and-actions.md)
