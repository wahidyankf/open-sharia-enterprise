...
- [Introduction and Philosophy](./ex-so-ar-fsm__01-introduction-and-philosophy.md) - Why FSMs matter
- [FSM Types and Classifications](./ex-so-ar-fsm__03-fsm-types-and-classifications.md) - Next: FSM variants
- [Events, Guards, and Actions](./ex-so-ar-fsm__06-events-guards-and-actions.md) - Deep dive into transition mechanics
- [Hierarchical and Nested States](./ex-so-ar-fsm__05-hierarchical-and-nested-states.md) - Composite states and sub-states
...
1. **Understand FSM variants**: Read [FSM Types and Classifications](./ex-so-ar-fsm__03-fsm-types-and-classifications.md)
2. **Learn state explosion mitigation**: Read [State Explosion and Mitigation](./ex-so-ar-fsm__04-state-explosion-and-mitigation.md)
3. **Master hierarchical states**: Read [Hierarchical and Nested States](./ex-so-ar-fsm__05-hierarchical-and-nested-states.md)
