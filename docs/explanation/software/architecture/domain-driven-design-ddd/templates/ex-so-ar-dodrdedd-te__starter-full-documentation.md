...
- **[Context Map](./ex-so-ar-dodrdedd-te__context-map-diagram.md)**: Visualize bounded context relationships
- **[Bounded Context Canvas](./ex-so-ar-dodrdedd-te__bounded-context-canvas.md)**: Detailed canvas for each context
- **[Aggregate Design Template](./ex-so-ar-dodrdedd-te__aggregate-design-template.md)**: Deep dive into aggregate structure
- **[Event Storming Output](./ex-so-ar-dodrdedd-te__event-storming-output.md)**: Workshop discoveries
...
- **Exploratory Event Storming**: Use [Event Storming Output Template](./ex-so-ar-dodrdedd-te__event-storming-output.md) for workshop discoveries
- **Mature bounded contexts**: Use [Bounded Context Canvas](./ex-so-ar-dodrdedd-te__bounded-context-canvas.md) for focused updates
- **Single aggregate design**: Use [Aggregate Design Template](./ex-so-ar-dodrdedd-te__aggregate-design-template.md) for tactical deep dive
...
- **[Event Storming Output](./ex-so-ar-dodrdedd-te__event-storming-output.md)**: Input discoveries into this documentation
- **[Bounded Context Canvas](./ex-so-ar-dodrdedd-te__bounded-context-canvas.md)**: Focused canvas for each bounded context
- **[Context Map Diagram](./ex-so-ar-dodrdedd-te__context-map-diagram.md)**: Visualize context relationships
- **[Aggregate Design Template](./ex-so-ar-dodrdedd-te__aggregate-design-template.md)**: Deep dive into aggregate structure

## Related Documentation

- **[Strategic Design Process](../ex-so-ar-dodrdedd__06-strategic-design-process.md)** - Event Storming and context mapping
...
- **[Domain Events](../ex-so-ar-dodrdedd__12-domain-events.md)** - Event-driven architecture
