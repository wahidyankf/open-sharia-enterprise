...
- [Aggregates](../ex-so-ar-dodrdedd__09-aggregates.md) - Aggregate concepts and patterns
- [Entities](../ex-so-ar-dodrdedd__07-entities.md) - Entity design principles
- [Value Objects](../ex-so-ar-dodrdedd__08-value-objects.md) - Value object patterns
- [Domain Events](../ex-so-ar-dodrdedd__12-domain-events.md) - Event design and usage
- [Repositories](../ex-so-ar-dodrdedd__10-repositories.md) - Persisting aggregates
- [Factories](../ex-so-ar-dodrdedd__13-factories.md) - Creating aggregates
