...
See [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md) for a comprehensive overview.
...
- **[01. Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md)** - Overview, history, when to use DDD, decision matrix
- **[02. Ubiquitous Language](./ex-so-ar-dodrdedd__02-ubiquitous-language.md)** - Creating shared vocabulary with domain experts
...
- **[03. Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md)** - Defining clear boundaries around domain models
- **[04. Context Mapping](./ex-so-ar-dodrdedd__04-context-mapping.md)** - 9 patterns for integrating bounded contexts
- **[05. Subdomains](./ex-so-ar-dodrdedd__05-subdomains.md)** - Core, Supporting, and Generic subdomains
- **[06. Strategic Design Process](./ex-so-ar-dodrdedd__06-strategic-design-process.md)** - Event Storming and Bounded Context Canvas workshops

### Tactical Design

Tactical patterns are building blocks for implementing domain models:

- **[07. Entities](./ex-so-ar-dodrdedd__07-entities.md)** - Objects with identity and lifecycle
- **[08. Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md)** - Immutable objects with structural equality
- **[09. Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md)** - Consistency boundaries and transactional units ⭐ **Most Important**
- **[10. Repositories](./ex-so-ar-dodrdedd__10-repositories.md)** - Persistence abstraction for aggregates
- **[11. Domain Services](./ex-so-ar-dodrdedd__11-domain-services.md)** - Stateless operations on domain objects
- **[12. Domain Events](./ex-so-ar-dodrdedd__12-domain-events.md)** - Capturing business occurrences
- **[13. Factories](./ex-so-ar-dodrdedd__13-factories.md)** - Complex object construction

### Advanced Topics

Integration with programming paradigms and architectures:

- **[14. DDD and Functional Programming](./ex-so-ar-dodrdedd__14-ddd-and-functional-programming.md)** - Adapting DDD to FP paradigm
- **[15. Layered Architecture](./ex-so-ar-dodrdedd__15-layered-architecture.md)** - Domain layer in broader architecture
- **[16. Decision Trees and Best Practices](./ex-so-ar-dodrdedd__16-decision-trees-and-best-practices.md)** - Practical guidance and common pitfalls
...
1. Read [Introduction and Philosophy - Decision Matrix](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md#decision-matrix) (3 minutes)
2. Review [When to Use DDD](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md#when-to-use-domain-driven-design) (2 minutes)
...
1. **Strategic Foundation** (10 minutes)
   - [Ubiquitous Language](./ex-so-ar-dodrdedd__02-ubiquitous-language.md) - Create shared vocabulary (5 min)
   - [Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md#defining-bounded-contexts) - Define boundaries (5 min)

2. **Tactical Basics** (15 minutes)
   - [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md#what-is-an-aggregate) - Understand consistency boundaries (7 min)
   - [Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md#what-is-a-value-object) - Immutable domain primitives (5 min)
...
1. [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md) (15 min)
2. [Ubiquitous Language](./ex-so-ar-dodrdedd__02-ubiquitous-language.md) (10 min)
3. [Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md) (15 min)
4. [Context Mapping](./ex-so-ar-dodrdedd__04-context-mapping.md) - 9 integration patterns (15 min)
5. [Subdomains](./ex-so-ar-dodrdedd__05-subdomains.md) - Core, Supporting, Generic (5 min)

**Tactical Design** (45 minutes):

1. [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md) - Most important tactical pattern (15 min)
2. [Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md) (10 min)
3. [Entities](./ex-so-ar-dodrdedd__07-entities.md) (7 min)
4. [Domain Events](./ex-so-ar-dodrdedd__12-domain-events.md) (8 min)
5. [Repositories](./ex-so-ar-dodrdedd__10-repositories.md) (5 min)

**Decision Making** (15 minutes):

1. [Decision Trees and Best Practices](./ex-so-ar-dodrdedd__16-decision-trees-and-best-practices.md) (10 min)
2. [FAQ](./ex-so-ar-dodrdedd__18-faq.md) (5 min)
...
1. [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md)
2. [Entities](./ex-so-ar-dodrdedd__07-entities.md) - Focus on OOP sections
3. [Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md) - Focus on OOP sections
4. [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md) - Class-based aggregate roots
5. [Domain Services](./ex-so-ar-dodrdedd__11-domain-services.md) - Stateless classes
6. [Layered Architecture](./ex-so-ar-dodrdedd__15-layered-architecture.md) - Traditional 4-layer
...
1. [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md)
2. [DDD and Functional Programming](./ex-so-ar-dodrdedd__14-ddd-and-functional-programming.md) ⭐ **Start Here**
3. [Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md) - Focus on FP sections (immutable records)
4. [Entities](./ex-so-ar-dodrdedd__07-entities.md) - Focus on FP sections (identity-based equality)
5. [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md) - Pure functions for validation
6. [Domain Events](./ex-so-ar-dodrdedd__12-domain-events.md) - Event-driven FP
7. [Repositories](./ex-so-ar-dodrdedd__10-repositories.md) - Pure data access interfaces
...
1. [Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md) - Each microservice is a bounded context
2. [Context Mapping](./ex-so-ar-dodrdedd__04-context-mapping.md) - API integration patterns
3. [Subdomains](./ex-so-ar-dodrdedd__05-subdomains.md) - Service decomposition strategy
4. [Domain Events](./ex-so-ar-dodrdedd__12-domain-events.md) - Event-driven inter-service communication
5. [DDD and C4 Integration](./ex-so-ar-dodrdedd__17-ddd-and-c4-integration.md) - C4 Container = Bounded Context

**For Monolithic Architecture**:

DDD provides modular organization within a single deployment:

1. [Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md) - Logical modules within monolith
2. [Layered Architecture](./ex-so-ar-dodrdedd__15-layered-architecture.md) - Traditional 4-layer structure
3. [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md) - Transactional consistency within database
4. [Context Mapping](./ex-so-ar-dodrdedd__04-context-mapping.md) - Module integration via Shared Kernel
5. [Subdomains](./ex-so-ar-dodrdedd__05-subdomains.md) - Investment prioritization for future extraction
...
1. [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md) - Decision matrix for DDD adoption
2. [Bounded Contexts](./ex-so-ar-dodrdedd__03-bounded-contexts.md) - System decomposition
3. [Context Mapping](./ex-so-ar-dodrdedd__04-context-mapping.md) - 9 integration patterns
4. [Subdomains](./ex-so-ar-dodrdedd__05-subdomains.md) - Core vs. Supporting vs. Generic
5. [Strategic Design Process](./ex-so-ar-dodrdedd__06-strategic-design-process.md) - Event Storming facilitation
6. [DDD and C4 Integration](./ex-so-ar-dodrdedd__17-ddd-and-c4-integration.md) - Architecture visualization
7. [Layered Architecture](./ex-so-ar-dodrdedd__15-layered-architecture.md) - Hexagonal Architecture variant

**For Developers**:

Focus on tactical patterns and implementation:

1. [Introduction and Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md) - Core concepts
2. [Ubiquitous Language](./ex-so-ar-dodrdedd__02-ubiquitous-language.md) - Naming conventions
3. [Aggregates](./ex-so-ar-dodrdedd__09-aggregates.md) ⭐ **Most Critical** - Transactional boundaries
4. [Value Objects](./ex-so-ar-dodrdedd__08-value-objects.md) - Immutable domain primitives
5. [Entities](./ex-so-ar-dodrdedd__07-entities.md) - Identity and lifecycle
6. [Domain Events](./ex-so-ar-dodrdedd__12-domain-events.md) - Event publishing
7. [Repositories](./ex-so-ar-dodrdedd__10-repositories.md) - Persistence abstraction
8. [Domain Services](./ex-so-ar-dodrdedd__11-domain-services.md) - Stateless operations
9. [Factories](./ex-so-ar-dodrdedd__13-factories.md) - Complex construction
10. [Decision Trees and Best Practices](./ex-so-ar-dodrdedd__16-decision-trees-and-best-practices.md) - Practical guidance
11. [DDD and Functional Programming](./ex-so-ar-dodrdedd__14-ddd-and-functional-programming.md) - If using FP

**For Domain Experts**:

Focus on collaboration and model validation:

1. [Introduction and Philosophy - Core Philosophy](./ex-so-ar-dodrdedd__01-introduction-and-philosophy.md#core-philosophy) - What is domain modeling?
2. [Ubiquitous Language](./ex-so-ar-dodrdedd__02-ubiquitous-language.md) - Creating shared vocabulary
3. [Strategic Design Process](./ex-so-ar-dodrdedd__06-strategic-design-process.md) - Event Storming workshop participation
...
**Yes.** While Eric Evans' original book used OOP (Java), DDD principles translate naturally to FP. Immutability, pure functions, and explicit data flow align well with DDD goals. See [DDD and Functional Programming](./ex-so-ar-dodrdedd__14-ddd-and-functional-programming.md).
...
See [FAQ](./ex-so-ar-dodrdedd__18-faq.md) for comprehensive Q&A covering common misconceptions and advanced topics.
...
- [ ] Identify aggregates using [decision trees](./ex-so-ar-dodrdedd__16-decision-trees-and-best-practices.md#aggregate-boundary-decision-tree)
...
- [ ] Create C4 diagrams mapping to bounded contexts (see [DDD and C4 Integration](./ex-so-ar-dodrdedd__17-ddd-and-c4-integration.md))
