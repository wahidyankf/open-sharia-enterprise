...
| ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [Repository Rules Quality Gate](./ex-wf__repository-rules-quality-gate.md)           | Validate repository consistency and apply fixes iteratively until ZERO findings                                        | repo-rules-checker, repo-rules-fixer                                                                                                                                                                                                                                                                                                        | Medium     |
| [Plan Quality Gate](./ex-wf__plan-quality-gate.md)                                   | Validate plan completeness and accuracy, apply fixes iteratively until ZERO findings                                   | plan-checker, plan-fixer                                                                                                                                                                                                                                                                                                                    | Medium     |
| [AyoKoding Web Content Quality Gate](./ex-wf__ayokoding-web-content-quality-gate.md) | Validate ayokoding-web content across all dimensions, fix issues, regenerate titles and navigation until ZERO findings | ayokoding-web-general-checker, ayokoding-web-by-example-checker, ayokoding-web-facts-checker, ayokoding-web-structure-checker, ayokoding-web-link-checker, ayokoding-web-general-fixer, ayokoding-web-by-example-fixer, ayokoding-web-facts-fixer, ayokoding-web-structure-fixer, ayokoding-web-title-maker, ayokoding-web-navigation-maker | High       |
