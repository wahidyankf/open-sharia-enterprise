...
See [Programming Language Content Standard](./ex-co__programming-language-content.md) for complete pedagogical requirements including:
...
See [Hugo Content Convention - ayokoding](./ex-co__hugo-content-ayokoding.md) for complete level-based weight system details.
...
See [Hugo Content Convention - ayokoding](./ex-co__hugo-content-ayokoding.md#internal-link-requirements) for complete details.
...
Follow [By Example Tutorial Convention](./ex-co__by-example-tutorial.md) to create 75-90 annotated examples.
...
- **[Diátaxis Framework](./ex-co__diataxis-framework.md)** - Documentation categorization (tutorials vs how-to vs reference vs explanation)
