...
- **[Progressive Disclosure](../principles/content/ex-pr-co__progressive-disclosure.md)**: Dual-path structure allows learners to choose their entry point based on experience level. By-concept path for gradual learning, by-example path for rapid exploration.
- **[Accessibility First](../principles/content/ex-pr-co__accessibility-first.md)**: Multiple learning paths serve diverse learning styles - narrative-driven for methodical learners, code-first for experienced developers.
- **[Explicit Over Implicit](../principles/software-engineering/ex-pr-se__explicit-over-implicit.md)**: Clear directory structure makes learning path choices obvious. Foundational tutorials at root signal prerequisite status.
...
See [Programming Language Content Standard](./ex-co-tu__programming-language-content.md) for complete pedagogical requirements including:
...
See [By Example Tutorial Convention](./ex-co-tu__by-example.md) for complete by-example standards including:
...
See [Hugo Content Convention - ayokoding](../hugo/ex-co-hu__ayokoding.md) for complete level-based weight system details.
...
See [Hugo Content Convention - ayokoding](../hugo/ex-co-hu__ayokoding.md#internal-link-requirements) for complete details.
...
Follow [By Example Tutorial Convention](./ex-co-tu__by-example.md) to create 75-90 annotated examples.
...
- **[Programming Language Content Standard](./ex-co-tu__programming-language-content.md)** - Universal content architecture for programming languages (5 tutorial levels, coverage philosophy, quality metrics, pedagogical patterns)
- **[By Example Tutorial Convention](./ex-co-tu__by-example.md)** - Complete standards for creating code-first by-example tutorials (five-part structure, self-containment, educational comments, coverage progression)
- **[Hugo Content Convention - ayokoding](../hugo/ex-co-hu__ayokoding.md)** - Hextra theme specifics (level-based weights, absolute paths, navigation depth, frontmatter requirements)
- **[Tutorial Naming Convention](./ex-co-tu__naming.md)** - Tutorial type definitions (Initial Setup, Quick Start, Beginner, Intermediate, Advanced coverage percentages)
- **[Content Quality Principles](../content/ex-co-co__quality.md)** - Universal markdown quality standards (active voice, heading hierarchy, accessibility)
- **[Diátaxis Framework](../meta/ex-co-me__diataxis-framework.md)** - Documentation categorization (tutorials vs how-to vs reference vs explanation)
