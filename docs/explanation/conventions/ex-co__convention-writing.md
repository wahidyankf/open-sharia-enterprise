...
**❌ Software development practices** (use `docs/explanation/development/` instead):
...
- [ ] Referenced in `docs/explanation/conventions/README.md`
...
1. **Search existing conventions** - Check `docs/explanation/conventions/README.md` for related topics
...
- **ayokoding-content-general-checker** - Validates general Hugo content conventions
- **ayokoding-content-by-example-checker** - Validates by-example tutorial conventions
