...
1. **[Idioms](./ex-soen-plwe-jvsp__idioms.md)** - Spring Framework-specific patterns
2. **[Best Practices](./ex-soen-plwe-jvsp__best-practices.md)** - Framework standards
3. **[Anti-Patterns](./ex-soen-plwe-jvsp__anti-patterns.md)** - Common mistakes
4. **[Configuration](./ex-soen-plwe-jvsp__configuration.md)** - Configuration approaches
5. **[Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md)** - IoC patterns
...
- **IoC Container**: See [Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md)
- **AOP**: See [Aspect-Oriented Programming](./ex-soen-plwe-jvsp__aop.md)
- **Data Access**: See [Data Access](./ex-soen-plwe-jvsp__data-access.md)
- **Web MVC**: See [Web MVC](./ex-soen-plwe-jvsp__web-mvc.md)
- **Testing**: See [Testing](./ex-soen-plwe-jvsp__testing.md)
...
- [Idioms](./ex-soen-plwe-jvsp__idioms.md) - Spring Framework patterns (IoC, DI, AOP, bean lifecycle)
- [Best Practices](./ex-soen-plwe-jvsp__best-practices.md) - Framework coding standards
- [Anti-Patterns](./ex-soen-plwe-jvsp__anti-patterns.md) - Common Spring Framework mistakes
- [Configuration](./ex-soen-plwe-jvsp__configuration.md) - Java config, XML, annotations, profiles
- [Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md) - IoC container, bean wiring
- [AOP](./ex-soen-plwe-jvsp__aop.md) - Aspect-oriented programming, cross-cutting concerns
- [Data Access](./ex-soen-plwe-jvsp__data-access.md) - JDBC, transactions, Spring Data
- [Web MVC](./ex-soen-plwe-jvsp__web-mvc.md) - Web layer, controllers, REST
- [REST APIs](./ex-soen-plwe-jvsp__rest-apis.md) - RESTful services with Spring MVC
- [Security](./ex-soen-plwe-jvsp__security.md) - Spring Security fundamentals
- [Testing](./ex-soen-plwe-jvsp__testing.md) - Spring TestContext framework
- [Performance](./ex-soen-plwe-jvsp__performance.md) - Optimization, caching
- [Observability](./ex-soen-plwe-jvsp__observability.md) - Monitoring and metrics
- [Deployment](./ex-soen-plwe-jvsp__deployment.md) - Deployment strategies
- [Version Migration](./ex-soen-plwe-jvsp__version-migration.md)- Upgrading Spring versions
...
### [Spring Framework Idioms](./ex-soen-plwe-jvsp__idioms.md)
...
### [Spring Framework Best Practices](./ex-soen-plwe-jvsp__best-practices.md)
...
### [Spring Framework Anti-Patterns](./ex-soen-plwe-jvsp__anti-patterns.md)
...
#### [Spring Framework Configuration](./ex-soen-plwe-jvsp__configuration.md)
...
#### [Spring Framework Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md)
...
#### [Spring Framework AOP](./ex-soen-plwe-jvsp__aop.md)
...
#### [Spring Framework Data Access](./ex-soen-plwe-jvsp__data-access.md)
...
#### [Spring Framework Web MVC](./ex-soen-plwe-jvsp__web-mvc.md)
...
#### [Spring Framework REST APIs](./ex-soen-plwe-jvsp__rest-apis.md)
...
#### [Spring Framework Security](./ex-soen-plwe-jvsp__security.md)
...
#### [Spring Framework Testing](./ex-soen-plwe-jvsp__testing.md)
...
#### [Spring Framework Performance](./ex-soen-plwe-jvsp__performance.md)
...
#### [Spring Framework Observability](./ex-soen-plwe-jvsp__observability.md)
...
#### [Spring Framework Deployment](./ex-soen-plwe-jvsp__deployment.md)
...
#### [Spring Framework Version Migration](./ex-soen-plwe-jvsp__version-migration.md)
...
Read [Spring Framework Idioms](./ex-soen-plwe-jvsp__idioms.md) and [Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md) to understand core concepts:
...
Read [Configuration](./ex-soen-plwe-jvsp__configuration.md) for setup strategies:
...
Read [AOP](./ex-soen-plwe-jvsp__aop.md) for cross-cutting concerns:
...
Read [Data Access](./ex-soen-plwe-jvsp__data-access.md) for persistence:
...
Read [Web MVC](./ex-soen-plwe-jvsp__web-mvc.md) and [REST APIs](./ex-soen-plwe-jvsp__rest-apis.md):
...
Read [Best Practices](./ex-soen-plwe-jvsp__best-practices.md) and [Anti-Patterns](./ex-soen-plwe-jvsp__anti-patterns.md):
...
- **[Spring Framework Idioms](./ex-soen-plwe-jvsp__idioms.md)** - Framework patterns
- **[Spring Framework Best Practices](./ex-soen-plwe-jvsp__best-practices.md)** - Production standards
- **[Spring Framework Anti-Patterns](./ex-soen-plwe-jvsp__anti-patterns.md)** - Common mistakes

### Core Concepts Documentation

- **[Configuration](./ex-soen-plwe-jvsp__configuration.md)** - Configuration management
- **[Dependency Injection](./ex-soen-plwe-jvsp__dependency-injection.md)** - IoC container
- **[AOP](./ex-soen-plwe-jvsp__aop.md)** - Aspect-oriented programming
- **[Data Access](./ex-soen-plwe-jvsp__data-access.md)** - JDBC and transactions

### Application Layer Documentation

- **[Web MVC](./ex-soen-plwe-jvsp__web-mvc.md)** - Web applications
- **[REST APIs](./ex-soen-plwe-jvsp__rest-apis.md)** - RESTful services
- **[Testing](./ex-soen-plwe-jvsp__testing.md)** - Testing strategies
- **[Performance](./ex-soen-plwe-jvsp__performance.md)** - Optimization
...
- **[Observability](./ex-soen-plwe-jvsp__observability.md)** - Monitoring and metrics
- **[Deployment](./ex-soen-plwe-jvsp__deployment.md)** - Deployment strategies
- **[Version Migration](./ex-soen-plwe-jvsp__version-migration.md)** - Upgrading versions
