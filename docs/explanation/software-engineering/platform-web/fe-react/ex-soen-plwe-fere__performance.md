...
- [Best Practices](./ex-soen-plwe-fere__best-practices.md) - Performance standards
- [Idioms](./ex-soen-plwe-fere__idioms.md) - useMemo/useCallback patterns
- [Hooks](./ex-soen-plwe-fere__hooks.md) - Hook optimization
- [Component Architecture](./ex-soen-plwe-fere__component-architecture.md) - Component patterns
...
- **[Hooks](./ex-soen-plwe-fere__hooks.md)** - Hook optimization
- **[Component Architecture](./ex-soen-plwe-fere__component-architecture.md)** - Component patterns
- **[Build & Deployment](./ex-soen-plwe-fere__build-deployment.md)** - Production optimization
