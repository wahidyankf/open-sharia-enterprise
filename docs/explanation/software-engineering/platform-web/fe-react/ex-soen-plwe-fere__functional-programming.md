...
- [Idioms](./ex-soen-plwe-fere__idioms.md) - Functional patterns
- [Hooks](./ex-soen-plwe-fere__hooks.md) - Hooks as FP abstractions
...
- **[Hooks](./ex-soen-plwe-fere__hooks.md)** - Hooks as FP abstractions
- **[Component Architecture](./ex-soen-plwe-fere__component-architecture.md)** - Component patterns
- **[State Management](./ex-soen-plwe-fere__state-management.md)** - Immutable state
