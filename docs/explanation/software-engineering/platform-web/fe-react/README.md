...
1. **[Idioms](./ex-soen-plwe-fere__idioms.md)** - React-specific patterns
2. **[Best Practices](./ex-soen-plwe-fere__best-practices.md)** - Framework standards
3. **[Anti-Patterns](./ex-soen-plwe-fere__anti-patterns.md)** - Common mistakes
4. **[Component Architecture](./ex-soen-plwe-fere__component-architecture.md)** - Component design
5. **[State Management](./ex-soen-plwe-fere__state-management.md)** - State patterns
...
- **Component Patterns**: See [Component Architecture](./ex-soen-plwe-fere__component-architecture.md)
- **State Management**: See [State Management](./ex-soen-plwe-fere__state-management.md)
- **Testing**: See [Testing](./ex-soen-plwe-fere__testing.md)
- **Performance**: See [Performance](./ex-soen-plwe-fere__performance.md)
...
**See Also**: [Functional Programming](./ex-soen-plwe-fere__functional-programming.md) for FP patterns with React.
...
- [Idioms](./ex-soen-plwe-fere__idioms.md) - React patterns (functional components, hooks, composition)
- [Best Practices](./ex-soen-plwe-fere__best-practices.md) - Framework coding standards
- [Anti-Patterns](./ex-soen-plwe-fere__anti-patterns.md) - Common React mistakes
- [Component Architecture](./ex-soen-plwe-fere__component-architecture.md) - Component design patterns
- [State Management](./ex-soen-plwe-fere__state-management.md) - State patterns and tools
- [Hooks](./ex-soen-plwe-fere__hooks.md) - useState, useEffect, custom hooks
- [TypeScript](./ex-soen-plwe-fere__typescript.md) - TypeScript integration
- [Testing](./ex-soen-plwe-fere__testing.md) - React Testing Library, Jest
- [Performance](./ex-soen-plwe-fere__performance.md) - Optimization strategies
- [Routing](./ex-soen-plwe-fere__routing.md) - React Router patterns
- [Forms](./ex-soen-plwe-fere__forms.md) - Form handling and validation
- [Data Fetching](./ex-soen-plwe-fere__data-fetching.md) - API integration
- [Styling](./ex-soen-plwe-fere__styling.md) - CSS strategies
- [Accessibility](./ex-soen-plwe-fere__accessibility.md) - WCAG compliance
- [Security](./ex-soen-plwe-fere__security.md) - Security best practices
- [Build & Deployment](./ex-soen-plwe-fere__build-deployment.md) - Build tools and deployment
- [Version Migration](./ex-soen-plwe-fere__version-migration.md) - Upgrading React versions
- [Domain-Driven Design](./ex-soen-plwe-fere__domain-driven-design.md) - DDD with React
- [Functional Programming](./ex-soen-plwe-fere__functional-programming.md) - FP patterns with React
...
### [React Idioms](./ex-soen-plwe-fere__idioms.md)
...
### [React Best Practices](./ex-soen-plwe-fere__best-practices.md)
...
### [React Anti-Patterns](./ex-soen-plwe-fere__anti-patterns.md)
...
#### [React Component Architecture](./ex-soen-plwe-fere__component-architecture.md)
...
#### [React State Management](./ex-soen-plwe-fere__state-management.md)
...
#### [React Hooks](./ex-soen-plwe-fere__hooks.md)
...
#### [React TypeScript Integration](./ex-soen-plwe-fere__typescript.md)
...
#### [React Testing](./ex-soen-plwe-fere__testing.md)
...
#### [React Performance](./ex-soen-plwe-fere__performance.md)
...
#### [React Routing](./ex-soen-plwe-fere__routing.md)
...
#### [React Forms](./ex-soen-plwe-fere__forms.md)
...
#### [React Data Fetching](./ex-soen-plwe-fere__data-fetching.md)
...
#### [React Styling](./ex-soen-plwe-fere__styling.md)
...
#### [React Accessibility](./ex-soen-plwe-fere__accessibility.md)
...
#### [React Security](./ex-soen-plwe-fere__security.md)
...
#### [React Build & Deployment](./ex-soen-plwe-fere__build-deployment.md)
...
#### [React Version Migration](./ex-soen-plwe-fere__version-migration.md)
...
#### [React Domain-Driven Design](./ex-soen-plwe-fere__domain-driven-design.md)
...
#### [React Functional Programming](./ex-soen-plwe-fere__functional-programming.md)
...
Read [React Idioms](./ex-soen-plwe-fere__idioms.md) to understand framework patterns:
...
Read [React Best Practices](./ex-soen-plwe-fere__best-practices.md) for production standards:
...
Read [React Anti-Patterns](./ex-soen-plwe-fere__anti-patterns.md) to prevent common mistakes:
...
- [Component Architecture](./ex-soen-plwe-fere__component-architecture.md)
- [State Management](./ex-soen-plwe-fere__state-management.md)
- [Hooks](./ex-soen-plwe-fere__hooks.md)
- [TypeScript](./ex-soen-plwe-fere__typescript.md)
- [Performance](./ex-soen-plwe-fere__performance.md)

### 5. Integrate with DDD

Read complementary documentation:

- [Domain-Driven Design](./ex-soen-plwe-fere__domain-driven-design.md)
- [TypeScript DDD Patterns](../../programming-languages/typescript/ex-soen-prla-ty__domain-driven-design.md)
- [Functional Programming](./ex-soen-plwe-fere__functional-programming.md)
...
- **[React Idioms](./ex-soen-plwe-fere__idioms.md)** - Framework patterns
- **[React Best Practices](./ex-soen-plwe-fere__best-practices.md)** - Production standards
- **[React Anti-Patterns](./ex-soen-plwe-fere__anti-patterns.md)** - Common mistakes

### Application Layer Documentation

- **[Component Architecture](./ex-soen-plwe-fere__component-architecture.md)** - Component design
- **[State Management](./ex-soen-plwe-fere__state-management.md)** - State patterns
- **[Hooks](./ex-soen-plwe-fere__hooks.md)** - React hooks
- **[TypeScript](./ex-soen-plwe-fere__typescript.md)** - TypeScript integration

### Advanced Topics

- **[Performance](./ex-soen-plwe-fere__performance.md)** - Optimization
- **[Testing](./ex-soen-plwe-fere__testing.md)** - Testing strategies
- **[Accessibility](./ex-soen-plwe-fere__accessibility.md)** - WCAG compliance
- **[Security](./ex-soen-plwe-fere__security.md)** - Security best practices
...
- **[Domain-Driven Design](./ex-soen-plwe-fere__domain-driven-design.md)** - DDD with React
- **[Functional Programming](./ex-soen-plwe-fere__functional-programming.md)** - FP patterns
- **[Version Migration](./ex-soen-plwe-fere__version-migration.md)** - Upgrading versions
