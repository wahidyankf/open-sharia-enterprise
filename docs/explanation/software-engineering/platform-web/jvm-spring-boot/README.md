...
1. **[Idioms](./ex-soen-plwe-jvspbo__idioms.md)** - Spring Boot-specific patterns
2. **[Best Practices](./ex-soen-plwe-jvspbo__best-practices.md)** - Framework standards
3. **[Anti-Patterns](./ex-soen-plwe-jvspbo__anti-patterns.md)** - Common mistakes
4. **[Configuration](./ex-soen-plwe-jvspbo__configuration.md)** - Configuration management
5. **[Dependency Injection](./ex-soen-plwe-jvspbo__dependency-injection.md)** - DI patterns
...
- **REST APIs**: See [REST APIs](./ex-soen-plwe-jvspbo__rest-apis.md)
- **Data Access**: See [Data Access](./ex-soen-plwe-jvspbo__data-access.md)
- **Security**: See [Security](./ex-soen-plwe-jvspbo__security.md)
- **Testing**: See [Testing](./ex-soen-plwe-jvspbo__testing.md)
...
**See Also**: [Functional Programming](./ex-soen-plwe-jvspbo__functional-programming.md) for FP patterns with Spring Boot.
...
- [Idioms](./ex-soen-plwe-jvspbo__idioms.md) - Spring Boot patterns (auto-configuration, component scanning, profiles)
- [Best Practices](./ex-soen-plwe-jvspbo__best-practices.md) - Framework coding standards
- [Anti-Patterns](./ex-soen-plwe-jvspbo__anti-patterns.md) - Common Spring Boot mistakes
- [Configuration](./ex-soen-plwe-jvspbo__configuration.md) - application.yml, profiles, externalized config
- [Dependency Injection](./ex-soen-plwe-jvspbo__dependency-injection.md) - Constructor injection, bean scopes
- [REST APIs](./ex-soen-plwe-jvspbo__rest-apis.md) - RESTful services, validation, exception handling
- [Data Access](./ex-soen-plwe-jvspbo__data-access.md) - Spring Data JPA, repositories, transactions
- [Security](./ex-soen-plwe-jvspbo__security.md) - Spring Security, OAuth2, JWT
- [Testing](./ex-soen-plwe-jvspbo__testing.md) - @SpringBootTest, slices, TestContainers
- [Observability](./ex-soen-plwe-jvspbo__observability.md) - Actuator, metrics, health checks
- [Performance](./ex-soen-plwe-jvspbo__performance.md) - Optimization, caching, async processing
- [Domain-Driven Design](./ex-soen-plwe-jvspbo__domain-driven-design.md) - DDD with Spring Boot
- [Functional Programming](./ex-soen-plwe-jvspbo__functional-programming.md) - FP patterns with Spring
- [Version Migration](./ex-soen-plwe-jvspbo__version-migration.md) - Upgrading Spring Boot versions
...
### [Spring Boot Idioms](./ex-soen-plwe-jvspbo__idioms.md)
...
### [Spring Boot Best Practices](./ex-soen-plwe-jvspbo__best-practices.md)
...
### [Spring Boot Anti-Patterns](./ex-soen-plwe-jvspbo__anti-patterns.md)
...
#### [Spring Boot Configuration](./ex-soen-plwe-jvspbo__configuration.md)
...
#### [Spring Boot Dependency Injection](./ex-soen-plwe-jvspbo__dependency-injection.md)
...
#### [Spring Boot REST APIs](./ex-soen-plwe-jvspbo__rest-apis.md)
...
#### [Spring Boot Data Access](./ex-soen-plwe-jvspbo__data-access.md)
...
#### [Spring Boot Security](./ex-soen-plwe-jvspbo__security.md)
...
#### [Spring Boot Testing](./ex-soen-plwe-jvspbo__testing.md)
...
#### [Spring Boot Observability](./ex-soen-plwe-jvspbo__observability.md)
...
#### [Spring Boot Performance](./ex-soen-plwe-jvspbo__performance.md)
...
#### [Spring Boot Domain-Driven Design](./ex-soen-plwe-jvspbo__domain-driven-design.md)
...
#### [Spring Boot Functional Programming](./ex-soen-plwe-jvspbo__functional-programming.md)
...
#### [Spring Boot Version Migration](./ex-soen-plwe-jvspbo__version-migration.md)
...
Read [Spring Boot Idioms](./ex-soen-plwe-jvspbo__idioms.md) to understand framework patterns:
...
Read [Spring Boot Best Practices](./ex-soen-plwe-jvspbo__best-practices.md) for production standards:
...
Read [Spring Boot Anti-Patterns](./ex-soen-plwe-jvspbo__anti-patterns.md) to prevent common mistakes:
...
- [Domain-Driven Design](./ex-soen-plwe-jvspbo__domain-driven-design.md)
- [Java DDD Patterns](../../programming-languages/java/ex-soen-prla-ja__domain-driven-design.md)
- [Functional Programming](./ex-soen-plwe-jvspbo__functional-programming.md)
...
- **[Spring Boot Best Practices](./ex-soen-plwe-jvspbo__best-practices.md)** - Production standards
- **[Spring Boot Anti-Patterns](./ex-soen-plwe-jvspbo__anti-patterns.md)** - Common mistakes

### Application Layer Documentation

- **[Configuration](./ex-soen-plwe-jvspbo__configuration.md)** - Configuration management
- **[Dependency Injection](./ex-soen-plwe-jvspbo__dependency-injection.md)** - IoC container
- **[REST APIs](./ex-soen-plwe-jvspbo__rest-apis.md)** - RESTful web services
- **[Data Access](./ex-soen-plwe-jvspbo__data-access.md)** - Spring Data JPA

### Advanced Topics

- **[Security](./ex-soen-plwe-jvspbo__security.md)** - Spring Security integration
- **[Testing](./ex-soen-plwe-jvspbo__testing.md)** - Testing strategies
- **[Observability](./ex-soen-plwe-jvspbo__observability.md)** - Monitoring and metrics
- **[Performance](./ex-soen-plwe-jvspbo__performance.md)** - Optimization

### Integration Documentation

- **[Domain-Driven Design](./ex-soen-plwe-jvspbo__domain-driven-design.md)** - DDD with Spring Boot
- **[Functional Programming](./ex-soen-plwe-jvspbo__functional-programming.md)** - FP patterns
- **[Version Migration](./ex-soen-plwe-jvspbo__version-migration.md)** - Upgrading versions
