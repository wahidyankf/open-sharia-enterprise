...
- **[Best Practices](./ex-soen-plwe-elph__best-practices.md)** - Modern Phoenix patterns
- **[LiveView](./ex-soen-plwe-elph__liveview.md)** - Latest LiveView features
- **[Components](./ex-soen-plwe-elph__best-practices.md#components)** - Component patterns
- **[Testing](./ex-soen-plwe-elph__testing.md)** - Testing migrated code
