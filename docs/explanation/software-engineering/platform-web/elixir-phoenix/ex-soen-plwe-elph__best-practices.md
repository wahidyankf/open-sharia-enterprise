...
- **[Phoenix Idioms](./ex-soen-plwe-elph__idioms.md)** - Framework patterns
...
- **[Data Access](./ex-soen-plwe-elph__data-access.md)** - Ecto patterns
- **[Security](./ex-soen-plwe-elph__security.md)** - Security practices
