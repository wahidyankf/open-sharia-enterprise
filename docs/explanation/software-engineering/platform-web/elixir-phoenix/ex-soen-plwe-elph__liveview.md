...
- [Channels](./ex-soen-plwe-elph__channels.md) - Traditional real-time communication
- [Testing](./ex-soen-plwe-elph__testing.md) - LiveView testing strategies
- [Security](./ex-soen-plwe-elph__security.md) - Authentication and authorization
- [Performance](./ex-soen-plwe-elph__performance.md) - Optimization techniques
...
- **[Channels Guide](./ex-soen-plwe-elph__channels.md)** - Traditional real-time with WebSockets
- **[Testing Guide](./ex-soen-plwe-elph__testing.md)** - Comprehensive testing strategies
