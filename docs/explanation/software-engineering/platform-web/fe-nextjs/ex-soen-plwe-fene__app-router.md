...
- [Next.js Routing](ex-soen-plwe-fene__routing.md) - Advanced routing patterns
- [Server Components](ex-soen-plwe-fene__server-components.md) - RSC architecture
- [Data Fetching](ex-soen-plwe-fene__data-fetching.md) - Server-side data patterns
- [Idioms](ex-soen-plwe-fene__idioms.md) - Next.js patterns
...
- [Testing](ex-soen-plwe-fene__testing.md) - Testing App Router
