...
- [App Router](ex-soen-plwe-fene__app-router.md) - File-system routing fundamentals
- [Middleware](ex-soen-plwe-fene__middleware.md) - Request-time routing logic
- [API Routes](ex-soen-plwe-fene__api-routes.md) - Backend routing
- [Server Components](ex-soen-plwe-fene__server-components.md) - Component-based routing

**Patterns**:

- [Idioms](ex-soen-plwe-fene__idioms.md) - Next.js routing patterns
