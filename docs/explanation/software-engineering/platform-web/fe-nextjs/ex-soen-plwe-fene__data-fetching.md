...
- [API Routes](ex-soen-plwe-fene__api-routes.md) - Route handlers
- [Caching](ex-soen-plwe-fene__performance.md#caching-strategies) - Performance optimization

**Patterns**:

- [Idioms](ex-soen-plwe-fene__idioms.md) - Data fetching patterns
