...
1. **[Idioms](ex-soen-plwe-fene__idioms.md)** - Next.js-specific patterns
2. **[Best Practices](ex-soen-plwe-fene__best-practices.md)** - Framework standards
3. **[Anti-Patterns](ex-soen-plwe-fene__anti-patterns.md)** - Common mistakes
4. **[App Router](ex-soen-plwe-fene__app-router.md)** - App Router architecture
5. **[Server Components](ex-soen-plwe-fene__server-components.md)** - Server Components patterns
...
- **Routing**: See [Routing](ex-soen-plwe-fene__routing.md)
- **Data Fetching**: See [Data Fetching](ex-soen-plwe-fene__data-fetching.md)
- **Testing**: See [Testing](ex-soen-plwe-fene__testing.md)
- **Performance**: See [Performance](ex-soen-plwe-fene__performance.md)
...
**See Also**: [Functional Programming](ex-soen-plwe-fene__functional-programming.md) for FP patterns with Next.js.
...
- [Idioms](ex-soen-plwe-fene__idioms.md) - Next.js patterns (App Router, Server Components, Server Actions)
- [Best Practices](ex-soen-plwe-fene__best-practices.md) - Framework coding standards
- [Anti-Patterns](ex-soen-plwe-fene__anti-patterns.md) - Common Next.js mistakes
- [App Router](ex-soen-plwe-fene__app-router.md) - File-system routing, layouts, loading states
- [Routing](ex-soen-plwe-fene__routing.md) - Dynamic routes, route groups, parallel routes
- [Server Components](ex-soen-plwe-fene__server-components.md) - RSC patterns, composition, streaming
- [Data Fetching](ex-soen-plwe-fene__data-fetching.md) - Server-side fetching, caching, revalidation
- [Rendering](ex-soen-plwe-fene__rendering.md) - SSR, SSG, ISR, CSR strategies
- [API Routes](ex-soen-plwe-fene__api-routes.md) - Route handlers, API design
- [Middleware](ex-soen-plwe-fene__middleware.md) - Edge middleware, request modification
- [Performance](ex-soen-plwe-fene__performance.md) - Optimization strategies
- [Testing](ex-soen-plwe-fene__testing.md) - Testing Next.js applications
- [Deployment](ex-soen-plwe-fene__deployment.md) - Vercel, self-hosting, Docker
- [Configuration](ex-soen-plwe-fene__configuration.md) - next.config.js, environment variables
- [Styling](ex-soen-plwe-fene__styling.md) - CSS Modules, Tailwind, CSS-in-JS
- [TypeScript](ex-soen-plwe-fene__typescript.md) - TypeScript integration
- [Security](ex-soen-plwe-fene__security.md) - Security best practices
- [Accessibility](ex-soen-plwe-fene__accessibility.md) - WCAG compliance
- [Domain-Driven Design](ex-soen-plwe-fene__domain-driven-design.md) - DDD with Next.js
- [Functional Programming](ex-soen-plwe-fene__functional-programming.md) - FP patterns
- [Version Migration](ex-soen-plwe-fene__version-migration.md) - Upgrading Next.js
...
### [Next.js Idioms](ex-soen-plwe-fene__idioms.md)
...
### [Next.js Best Practices](ex-soen-plwe-fene__best-practices.md)
...
### [Next.js Anti-Patterns](ex-soen-plwe-fene__anti-patterns.md)
...
#### [Next.js App Router](ex-soen-plwe-fene__app-router.md)
...
#### [Next.js Routing](ex-soen-plwe-fene__routing.md)
...
#### [Next.js Server Components](ex-soen-plwe-fene__server-components.md)
...
#### [Next.js Data Fetching](ex-soen-plwe-fene__data-fetching.md)
...
#### [Next.js Rendering](ex-soen-plwe-fene__rendering.md)
...
#### [Next.js API Routes](ex-soen-plwe-fene__api-routes.md)
...
#### [Next.js Middleware](ex-soen-plwe-fene__middleware.md)
...
#### [Next.js Performance](ex-soen-plwe-fene__performance.md)
...
#### [Next.js Testing](ex-soen-plwe-fene__testing.md)
...
#### [Next.js Deployment](ex-soen-plwe-fene__deployment.md)
...
#### [Next.js Configuration](ex-soen-plwe-fene__configuration.md)
...
#### [Next.js Styling](ex-soen-plwe-fene__styling.md)
...
#### [Next.js TypeScript](ex-soen-plwe-fene__typescript.md)
...
#### [Next.js Security](ex-soen-plwe-fene__security.md)
...
#### [Next.js Accessibility](ex-soen-plwe-fene__accessibility.md)
...
#### [Next.js Domain-Driven Design](ex-soen-plwe-fene__domain-driven-design.md)
...
#### [Next.js Functional Programming](ex-soen-plwe-fene__functional-programming.md)
...
#### [Next.js Version Migration](ex-soen-plwe-fene__version-migration.md)
...
Read [Next.js Idioms](ex-soen-plwe-fene__idioms.md) to understand framework patterns:
...
Read [Next.js Best Practices](ex-soen-plwe-fene__best-practices.md) for production standards:
...
Read [Next.js Anti-Patterns](ex-soen-plwe-fene__anti-patterns.md) to prevent mistakes:
...
- [App Router](ex-soen-plwe-fene__app-router.md)
- [Server Components](ex-soen-plwe-fene__server-components.md)
- [Data Fetching](ex-soen-plwe-fene__data-fetching.md)
- [Rendering](ex-soen-plwe-fene__rendering.md)

### 5. Integrate with DDD

Read complementary documentation:

- [Domain-Driven Design](ex-soen-plwe-fene__domain-driven-design.md)
- [Functional Programming](ex-soen-plwe-fene__functional-programming.md)
...
- **[React Best Practices](../fe-react/ex-soen-plwe-fere__best-practices.md)** - React standards
...
- **[Next.js Idioms](ex-soen-plwe-fene__idioms.md)** - Framework patterns
- **[Next.js Best Practices](ex-soen-plwe-fene__best-practices.md)** - Production standards
- **[Next.js Anti-Patterns](ex-soen-plwe-fene__anti-patterns.md)** - Common mistakes

### Architecture Documentation

- **[App Router](ex-soen-plwe-fene__app-router.md)** - Routing architecture
- **[Server Components](ex-soen-plwe-fene__server-components.md)** - RSC patterns
- **[Data Fetching](ex-soen-plwe-fene__data-fetching.md)** - Data strategies
- **[Rendering](ex-soen-plwe-fene__rendering.md)** - Rendering modes

### Advanced Topics

- **[Performance](ex-soen-plwe-fene__performance.md)** - Optimization
- **[Testing](ex-soen-plwe-fene__testing.md)** - Testing strategies
- **[Security](ex-soen-plwe-fene__security.md)** - Security practices
- **[Deployment](ex-soen-plwe-fene__deployment.md)** - Deployment patterns

### Integration Documentation

- **[Domain-Driven Design](ex-soen-plwe-fene__domain-driven-design.md)** - DDD with Next.js
- **[Functional Programming](ex-soen-plwe-fene__functional-programming.md)** - FP patterns
- **[Version Migration](ex-soen-plwe-fene__version-migration.md)** - Upgrading
