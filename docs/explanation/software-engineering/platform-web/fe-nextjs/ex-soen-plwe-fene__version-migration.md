...
- [Next.js App Router](ex-soen-plwe-fene__app-router.md) - App Router features
- [Next.js Server Components](ex-soen-plwe-fene__server-components.md) - RSC patterns
- [Next.js Configuration](ex-soen-plwe-fene__configuration.md) - Configuration updates
- [Next.js Testing](ex-soen-plwe-fene__testing.md) - Testing migrated code

---

**Next Steps:**

- Review [Next.js App Router](ex-soen-plwe-fene__app-router.md) for App Router features
- Check [Next.js Server Components](ex-soen-plwe-fene__server-components.md) for RSC patterns
- Read [Next.js Configuration](ex-soen-plwe-fene__configuration.md) for config updates
- Explore [Next.js Testing](ex-soen-plwe-fene__testing.md) for migration testing
