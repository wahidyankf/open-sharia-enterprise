...
- [Java Performance](./ex-soen-prla-ja__performance.md) - Performance optimization including memory profiling
- [Java Concurrency](./ex-soen-prla-ja__concurrency-and-parallelism.md) - Thread memory considerations
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - General best practices including memory efficiency
- [Java Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Common memory-related mistakes
- [Go Memory Management](../golang/ex-soen-prla-go__memory-management.md) - Comparison with Go's simpler GC
...
- [Java Performance](./ex-soen-prla-ja__performance.md) - Performance optimization including CPU profiling, JIT compilation
- [Java Concurrency](./ex-soen-prla-ja__concurrency-and-parallelism.md) - Thread memory, concurrent collections, memory visibility
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - General coding standards including memory efficiency
- [Java Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Memory leak patterns, resource management mistakes
- [Go Memory Management](../golang/ex-soen-prla-go__memory-management.md) - Comparison with Go's simpler GC approach
