...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Records for value objects, sealed classes for aggregates
- [Java Type Safety](./ex-soen-prla-ja__type-safety.md) - Type-safe domain models
- [Java Functional Programming](./ex-soen-prla-ja__functional-programming.md) - Immutable domain models
- [Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md) - Testing domain models
...
- **[Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md)** - TDD for domain models
- **[Java Security](./ex-soen-prla-ja__security.md)** - Secure domain models
- **[Java Concurrency](./ex-soen-prla-ja__concurrency-and-parallelism.md)** - Thread-safe aggregates
