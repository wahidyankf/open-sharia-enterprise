...
- [Type Safety](./ex-soen-prla-ja__type-safety.md) - Compile-time safety
...
- **[Type Safety](./ex-soen-prla-ja__type-safety.md)** - Compile-time safety with NullAway
- **[Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md)** - Testing code quality
- **[Security](./ex-soen-prla-ja__security.md)** - Security-focused linting
