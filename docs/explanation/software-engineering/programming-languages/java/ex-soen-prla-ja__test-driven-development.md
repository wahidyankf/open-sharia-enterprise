...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Modern Java patterns for testable code
- [Java Functional Programming](./ex-soen-prla-ja__functional-programming.md) - Pure functions are easy to test
- [Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - Testing aggregates and value objects
- [Behavior-Driven Development](./ex-soen-prla-ja__behaviour-driven-development.md) - BDD complements TDD
...
- **[Java Idioms](./ex-soen-prla-ja__idioms.md)** - Modern patterns for testable code
- **[Java Functional Programming](./ex-soen-prla-ja__functional-programming.md)** - Pure functions are easy to test
- **[Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md)** - Testing domain models

### Specialized Topics

- **[Behavior-Driven Development](./ex-soen-prla-ja__behaviour-driven-development.md)** - BDD complements TDD
- **[Java Type Safety](./ex-soen-prla-ja__type-safety.md)** - Type-safe tests
- **[Java Best Practices](./ex-soen-prla-ja__best-practices.md)** - Testing best practices
