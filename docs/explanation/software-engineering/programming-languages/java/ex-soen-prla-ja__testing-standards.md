...
- **[Java By Example](https://ayokoding.com/en/learn/software-engineering/programming-languages/java/by-example)** - 157+ annotated code examples
  - **[Intermediate Examples](https://ayokoding.com/en/learn/software-engineering/programming-languages/java/by-example/intermediate)** - Testing with JUnit, Mockito, AssertJ
  - **[Advanced Examples](https://ayokoding.com/en/learn/software-engineering/programming-languages/java/by-example/advanced)** - TestContainers, integration testing
- **[Java In Practice](https://ayokoding.com/en/learn/software-engineering/programming-languages/java/in-practice)** - Test-Driven Development (TDD) and Behavior-Driven Development (BDD) practices
