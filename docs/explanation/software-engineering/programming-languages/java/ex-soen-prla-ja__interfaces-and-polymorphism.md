...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Modern Java patterns including sealed classes, pattern matching
- [Java Type Safety](./ex-soen-prla-ja__type-safety.md) - Type-safe interfaces with JSpecify, sealed types
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - Clean code guidelines
- [Java Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - DDD with type-safe domain models
- [Go Interfaces and Composition](../golang/ex-soen-prla-go__interfaces-and-composition.md) - Go's implicit interfaces (comparison)
...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Modern patterns including sealed classes, records
- [Java Type Safety](./ex-soen-prla-ja__type-safety.md) - Type-safe interfaces with JSpecify
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - Composition over inheritance
- [Java Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Fat interfaces, marker interfaces

**Specialized Topics**:

- [Java Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - Domain interfaces and bounded contexts
- [Java Error Handling](./ex-soen-prla-ja__error-handling.md) - Sealed result types for type-safe errors
- [Java Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md) - Testing with interfaces

**Comparison with Other Languages**:

- [Go Interfaces and Composition](../golang/ex-soen-prla-go__interfaces-and-composition.md) - Implicit vs explicit interfaces
