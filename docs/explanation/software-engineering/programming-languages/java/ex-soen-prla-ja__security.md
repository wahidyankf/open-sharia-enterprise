...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Secure coding patterns
- [Best Practices](./ex-soen-prla-ja__best-practices.md) - General development guidelines
- [Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Security anti-patterns
- [Performance](./ex-soen-prla-ja__performance.md) - Security vs performance trade-offs
