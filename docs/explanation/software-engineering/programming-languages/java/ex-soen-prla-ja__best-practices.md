...
**See Also**: [Java Linting and Formatting](./ex-soen-prla-ja__linting-and-formatting.md)
...
**Companion Document**: Before reading this document, familiarize yourself with common [Java Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) to understand what practices to avoid.
...
- [Java Idioms - Records](./ex-soen-prla-ja__idioms.md#1-records-for-immutable-data)
- [Java Type Safety - Static Analysis](./ex-soen-prla-ja__type-safety.md#static-analysis-with-checker-framework)
...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Common Java patterns and idiomatic constructs
- [Java Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Common mistakes and what to avoid
