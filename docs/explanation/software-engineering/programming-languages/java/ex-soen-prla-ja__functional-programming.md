...
- [Java Idioms](./ex-soen-prla-ja__idioms.md) - Modern Java patterns including streams and lambdas
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - Clean code with functional style
- [Java Type Safety](./ex-soen-prla-ja__type-safety.md) - Type-safe functional code
- [Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - Functional domain models
- [Java Concurrency](./ex-soen-prla-ja__concurrency-and-parallelism.md) - Immutability for thread safety
...
**For comprehensive immutable Money value object**, see [Domain-Driven Design - Value Objects](./ex-soen-prla-ja__domain-driven-design.md#example-money-value-object).
...
- **[Java Idioms](./ex-soen-prla-ja__idioms.md)** - Streams, Optional, method references, lambdas
- **[Java Best Practices](./ex-soen-prla-ja__best-practices.md)** - Immutability and functional style
- **[Java Type Safety](./ex-soen-prla-ja__type-safety.md)** - Type-safe functional programming

### Specialized Topics

- **[Java Concurrency](./ex-soen-prla-ja__concurrency-and-parallelism.md)** - Immutability for thread safety
- **[Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md)** - Functional domain models
- **[Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md)** - Testing pure functions

### Release Documentation

- **[Java 17 LTS](./ex-soen-prla-ja__release-17.md)** - Sealed classes for functional patterns
- **[Java 21 LTS](./ex-soen-prla-ja__release-21.md)** - Record patterns for functional decomposition
- **[Java 25 LTS](./ex-soen-prla-ja__release-25.md)** - Primitive patterns in functional code
