...
related:
  ...
  - ./ex-soen-prla-ja__performance.md
principles:
...
- [Performance](./ex-soen-prla-ja__performance.md) - Performance implications of concurrency
- [Security](./ex-soen-prla-ja__security.md) - Thread-safe security patterns
- [Best Practices](./ex-soen-prla-ja__best-practices.md) - General concurrency practices
- [Anti-Patterns](./ex-soen-prla-ja__anti-patterns.md) - Concurrency anti-patterns
...
See [Java 21 Release Documentation](./ex-soen-prla-ja__release-21.md#when-not-to-use-virtual-threads) for detailed guidance.
