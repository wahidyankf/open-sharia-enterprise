...
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - Clean code, composition over inheritance
- [Java Security](./ex-soen-prla-ja__security.md) - Secure coding, authentication, authorization
- [Java Performance](./ex-soen-prla-ja__performance.md) - API performance optimization
- [Java Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md) - Testing strategies
- [Java Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - DDD patterns for APIs
- [Go Web Services](../golang/ex-soen-prla-go__web-services.md) - Go web services comparison
...
- [Java Best Practices](./ex-soen-prla-ja__best-practices.md) - Clean code, composition over inheritance
- [Java Security](./ex-soen-prla-ja__security.md) - Authentication, authorization, secure coding
- [Java Performance](./ex-soen-prla-ja__performance.md) - API performance optimization
- [Java Error Handling](./ex-soen-prla-ja__error-handling.md) - Exception handling patterns
- [Java Interfaces and Polymorphism](./ex-soen-prla-ja__interfaces-and-polymorphism.md) - Service interfaces

**Specialized Topics**:

- [Java Domain-Driven Design](./ex-soen-prla-ja__domain-driven-design.md) - DDD patterns for APIs
- [Java Test-Driven Development](./ex-soen-prla-ja__test-driven-development.md) - Testing web services

**Comparison with Other Languages**:

- [Go Web Services](../golang/ex-soen-prla-go__web-services.md) - Go's net/http, Gin, gRPC comparison
