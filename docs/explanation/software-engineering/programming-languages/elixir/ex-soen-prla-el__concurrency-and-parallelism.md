...
related:
  ...
  - ./ex-soen-prla-el__performance.md
principles:
...
- [Error Handling](./ex-soen-prla-el__error-handling.md) - "Let it crash" philosophy
- [OTP GenServer](./ex-soen-prla-el__otp-genserver.md) - Stateful concurrent processes
- [OTP Supervisor](./ex-soen-prla-el__otp-supervisor.md) - Process supervision
- [Anti-Patterns](./ex-soen-prla-el__anti-patterns.md) - Common concurrency mistakes
- [Performance](./ex-soen-prla-el__performance.md) - Optimizing concurrent systems
