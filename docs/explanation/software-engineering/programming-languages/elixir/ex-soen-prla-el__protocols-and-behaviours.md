...
- [Functional Programming](ex-soen-prla-el__functional-programming.md) - Functional approach to polymorphism
- [Testing](ex-soen-prla-el__test-driven-development.md) - Testing protocols and behaviours
- [OTP: GenServer](ex-soen-prla-el__otp-genserver.md) - GenServer behaviour implementation
- [Type Safety](ex-soen-prla-el__type-safety.md) - Typespecs for callbacks
