...
- [Best Practices](./ex-soen-prla-el__best-practices.md) - What to do instead
- [OTP GenServer](./ex-soen-prla-el__otp-genserver.md) - Proper GenServer patterns
- [OTP Supervisor](./ex-soen-prla-el__otp-supervisor.md) - Supervision strategies
- [Performance](./ex-soen-prla-el__performance.md) - Optimization techniques
- [Test-Driven Development](./ex-soen-prla-el__test-driven-development.md) - Testing best practices
