...
- [Best Practices](./ex-soen-prla-el__best-practices.md)
- [Functional Programming](./ex-soen-prla-el__functional-programming.md)
- [Protocols and Behaviours](./ex-soen-prla-el__protocols-and-behaviours.md)
...
- [Functional Programming](./ex-soen-prla-el__functional-programming.md) - Pure functions and immutability
- [Error Handling](./ex-soen-prla-el__error-handling.md) - Error handling patterns
- [Best Practices](./ex-soen-prla-el__best-practices.md) - Elixir coding standards
- [Protocols and Behaviours](./ex-soen-prla-el__protocols-and-behaviours.md) - Deep dive into protocols
