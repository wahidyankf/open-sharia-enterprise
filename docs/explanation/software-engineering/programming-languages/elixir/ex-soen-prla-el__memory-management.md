...
- [Concurrency and Parallelism](ex-soen-prla-el__concurrency-and-parallelism.md) - Process-based concurrency
- [Performance](ex-soen-prla-el__performance.md) - Performance optimization techniques
- [Error Handling](ex-soen-prla-el__error-handling.md) - Supervision and fault tolerance
- [OTP: GenServer](ex-soen-prla-el__otp-genserver.md) - Process memory patterns
- [Best Practices](ex-soen-prla-el__best-practices.md) - Memory-efficient patterns
