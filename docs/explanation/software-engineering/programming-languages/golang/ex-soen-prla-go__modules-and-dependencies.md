...
- [Best Practices](./ex-soen-prla-go__best-practices.md) - Code organization and project structure
- [Linting and Formatting](./ex-soen-prla-go__linting-and-formatting.md) - CI/CD integration with modules
- [Web Services](./ex-soen-prla-go__web-services.md) - Framework dependencies
