...
- [Idioms](./ex-soen-prla-go__idioms.md) - Go-specific patterns including functional options
- [Type Safety](./ex-soen-prla-go__type-safety.md) - Generics enabling functional patterns
- [Best Practices](./ex-soen-prla-go__best-practices.md) - When to use functional programming
- [Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md) - Closures with goroutines
