...
- [Best Practices](./ex-soen-prla-go__best-practices.md) - What to do
- [Go Idioms](./ex-soen-prla-go__idioms.md) - Idiomatic patterns
- [Error Handling](./ex-soen-prla-go__error-handling.md) - Error patterns
- [Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md) - Concurrency patterns
