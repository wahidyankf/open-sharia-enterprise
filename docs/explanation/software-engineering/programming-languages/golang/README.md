...
1. **[Idioms](./ex-soen-prla-go__idioms.md)** - Go-specific patterns and conventions
2. **[Best Practices](./ex-soen-prla-go__best-practices.md)** - Clean code standards
3. **[Anti-Patterns](./ex-soen-prla-go__anti-patterns.md)** - Common mistakes to avoid
...
- **Naming Conventions**: See [Best Practices - Code Organization](./ex-soen-prla-go__best-practices.md#code-organization)
- **Error Handling**: See [Error Handling](./ex-soen-prla-go__error-handling.md)
- **Type Safety**: See [Type Safety](./ex-soen-prla-go__type-safety.md)
- **Testing Standards**: See [Test-Driven Development](./ex-soen-prla-go__test-driven-development.md)
- **Security Practices**: See [Security](./ex-soen-prla-go__security.md)
...
**See Also**: [Functional Programming](./ex-soen-prla-go__functional-programming.md) for pure functions patterns, [Best Practices](./ex-soen-prla-go__best-practices.md) for explicit coding standards.
...
- [Best Practices](./ex-soen-prla-go__best-practices.md) - Modern Go coding standards (2025-2026)
- [Idioms](./ex-soen-prla-go__idioms.md) - Go-specific patterns (interfaces, embedding, error handling)
- [Anti-Patterns](./ex-soen-prla-go__anti-patterns.md) - Common mistakes to avoid (expanded with financial domain patterns)
- [Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md) - Goroutines, channels, sync package
- [Interfaces and Composition](./ex-soen-prla-go__interfaces-and-composition.md) - Interface design, composition over inheritance
- [Error Handling](./ex-soen-prla-go__error-handling.md) - Error patterns, wrapping, custom errors
- [Type Safety](./ex-soen-prla-go__type-safety.md) - Type system, interfaces, generics
- [Functional Programming](./ex-soen-prla-go__functional-programming.md) - FP patterns in Go
- [Finite State Machine](./ex-soen-prla-go__finite-state-machine.md) - FSM patterns for enterprise state management
- [Domain-Driven Design](./ex-soen-prla-go__domain-driven-design.md) - DDD patterns in Go
- [Performance](./ex-soen-prla-go__performance.md) - Profiling, optimization, memory management
- [Security](./ex-soen-prla-go__security.md) - Secure coding practices
- [Memory Management](./ex-soen-prla-go__memory-management.md) - GC, pointers, escape analysis
- [Modules and Dependencies](./ex-soen-prla-go__modules-and-dependencies.md) - Go modules, dependency management
- [Web Services](./ex-soen-prla-go__web-services.md) - HTTP servers, REST APIs, gRPC
- [Linting and Formatting](./ex-soen-prla-go__linting-and-formatting.md) - golangci-lint, gofmt, staticcheck
- [Test-Driven Development](./ex-soen-prla-go__test-driven-development.md) - TDD with testing package, testify
- [Behaviour-Driven Development](./ex-soen-prla-go__behaviour-driven-development.md) - BDD with Godog (Gherkin for Go)
...
### [Go Best Practices](./ex-soen-prla-go__best-practices.md)
...
### [Go Anti-Patterns](./ex-soen-prla-go__anti-patterns.md)
...
#### [Go Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md)
...
#### [Go Interfaces and Composition](./ex-soen-prla-go__interfaces-and-composition.md)
...
#### [Go Error Handling](./ex-soen-prla-go__error-handling.md)
...
#### [Go Type Safety](./ex-soen-prla-go__type-safety.md)
...
#### [Go Performance](./ex-soen-prla-go__performance.md)
...
#### [Go Security](./ex-soen-prla-go__security.md)
...
#### [Go Memory Management](./ex-soen-prla-go__memory-management.md)
...
#### [Go Modules and Dependencies](./ex-soen-prla-go__modules-and-dependencies.md)
...
#### [Go Web Services](./ex-soen-prla-go__web-services.md)
...
#### [Go Linting and Formatting](./ex-soen-prla-go__linting-and-formatting.md)
...
#### [Go Test-Driven Development](./ex-soen-prla-go__test-driven-development.md)
...
#### [Go Behaviour-Driven Development](./ex-soen-prla-go__behaviour-driven-development.md)
...
#### [Go Domain-Driven Design](./ex-soen-prla-go__domain-driven-design.md)
...
#### [Go Functional Programming](./ex-soen-prla-go__functional-programming.md)
...
#### [Go Finite State Machine](./ex-soen-prla-go__finite-state-machine.md)
...
Read [Go Idioms](./ex-soen-prla-go__idioms.md) to understand Go-specific patterns:
...
Read [Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md) for concurrent programming:
...
Read [Go Best Practices](./ex-soen-prla-go__best-practices.md) to write clean code:
...
Read [Go Anti-Patterns](./ex-soen-prla-go__anti-patterns.md) to prevent common mistakes:
...
- **[Go Idioms](./ex-soen-prla-go__idioms.md)** - Go-specific patterns and conventions
- **[Go Best Practices](./ex-soen-prla-go__best-practices.md)** - Clean code guidelines
- **[Go Anti-Patterns](./ex-soen-prla-go__anti-patterns.md)** - Common mistakes to avoid

### Specialized Topics

- **[Go Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md)** - Goroutines, channels, sync
- **[Go Interfaces and Composition](./ex-soen-prla-go__interfaces-and-composition.md)** - Interface design, embedding
- **[Go Error Handling](./ex-soen-prla-go__error-handling.md)** - Error patterns, wrapping, custom errors
- **[Go Type Safety](./ex-soen-prla-go__type-safety.md)** - Type system, generics, type assertions
- **[Go Finite State Machine](./ex-soen-prla-go__finite-state-machine.md)** - FSM patterns, concurrent state machines, financial workflows
- **[Go Performance](./ex-soen-prla-go__performance.md)** - Profiling, optimization, GC tuning
- **[Go Security](./ex-soen-prla-go__security.md)** - Secure coding, cryptography, OWASP
- **[Go Memory Management](./ex-soen-prla-go__memory-management.md)** - GC, pointers, escape analysis
- **[Go Modules and Dependencies](./ex-soen-prla-go__modules-and-dependencies.md)** - Module management
- **[Go Web Services](./ex-soen-prla-go__web-services.md)** - HTTP, REST, gRPC
- **[Go Linting and Formatting](./ex-soen-prla-go__linting-and-formatting.md)** - golangci-lint, gofmt
- **[Go Functional Programming](./ex-soen-prla-go__functional-programming.md)** - FP patterns in Go
- **[Go Domain-Driven Design](./ex-soen-prla-go__domain-driven-design.md)** - DDD without classes
- **[Go Test-Driven Development](./ex-soen-prla-go__test-driven-development.md)** - TDD with testing package
- **[Go Behaviour-Driven Development](./ex-soen-prla-go__behaviour-driven-development.md)** - BDD with Godog
