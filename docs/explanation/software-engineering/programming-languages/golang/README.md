...
- rhino-cli MUST use Go for repository management (RHINO = Repository Hygiene & INtegration Orchestrator; includes `validate-java-annotations` for Java null-safety annotation validation)
