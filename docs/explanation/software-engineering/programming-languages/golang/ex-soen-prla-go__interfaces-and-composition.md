...
- [Go Best Practices](./ex-soen-prla-go__best-practices.md) - Interface design best practices
- [Go Idioms](./ex-soen-prla-go__idioms.md) - Interface usage patterns
- [Go Type Safety](./ex-soen-prla-go__type-safety.md) - Type system and interfaces
- [Go Anti-Patterns](./ex-soen-prla-go__anti-patterns.md) - Common interface mistakes
- [Go Domain-Driven Design](./ex-soen-prla-go__domain-driven-design.md) - Interfaces in DDD
