...
tags:
  ...
  - go-1.25
related:
  - ./ex-soen-prla-go__performance.md
  - ./ex-soen-prla-go__best-practices.md
principles:
...
- [Performance](./ex-soen-prla-go__performance.md) - Performance optimization including memory profiling
- [Best Practices](./ex-soen-prla-go__best-practices.md) - General best practices including memory efficiency
- [Concurrency and Parallelism](./ex-soen-prla-go__concurrency-and-parallelism.md) - Goroutine memory considerations
- [Anti-Patterns](./ex-soen-prla-go__anti-patterns.md) - Common memory-related mistakes
