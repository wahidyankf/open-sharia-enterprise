...
**Core specification unit** - see [File 02: Gherkin Syntax and Scenarios](ex-soen-de-bedrdebd__02-gherkin-syntax-and-scenarios.md) for comprehensive scenario writing guidance.

#### 6. Scenario Outlines

**Data-driven scenarios** - see [File 02: Gherkin Syntax and Scenarios](ex-soen-de-bedrdebd__02-gherkin-syntax-and-scenarios.md) for examples.
...
See [File 09: Step Definitions](ex-soen-de-bedrdebd__09-step-definitions.md) for comprehensive step definition guidance.
...
- **Related Files**:
  ...
  - [07. Discovery and Formulation](ex-soen-de-bedrdebd__07-discovery-and-formulation.md) - From discovery to feature files
  - [09. Step Definitions](ex-soen-de-bedrdebd__09-step-definitions.md) - Automating scenarios
  - [14. BDD and DDD](ex-soen-de-bedrdebd__14-bdd-and-ddd.md) - Aligning BDD with bounded contexts
- **Prerequisites**: Understanding of Gherkin syntax (File 02), bounded contexts (DDD)
- **Next Steps**: Read [Step Definitions](ex-soen-de-bedrdebd__09-step-definitions.md) for automation implementation
- **Last Updated**: 2026-01-20
- **Status**: Active
