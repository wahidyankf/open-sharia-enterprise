...
- **Related Files**:
  ...
  - [08. Feature Files and Organization](ex-soen-de-bedrdebd__08-feature-files-and-organization.md) - Organizing by bounded context
  - [13. BDD and TDD](ex-soen-de-bedrdebd__13-bdd-and-tdd.md) - TDD integration
- **Prerequisites**: Understanding of DDD concepts (bounded contexts, aggregates, domain events), BDD scenarios (Gherkin)
- **Next Steps**: Read [BDD in Nx Monorepo](ex-soen-de-bedrdebd__15-bdd-in-nx-monorepo.md) for practical implementation patterns
