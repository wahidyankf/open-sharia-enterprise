...
**Companion Document**: See [BDD Best Practices](ex-soen-de-bedrdebd__17-best-practices.md) for proven positive patterns.
...
**How to Fix**: Use collaborative discovery sessions (see [Best Practices #1](ex-soen-de-bedrdebd__17-best-practices.md#1-prioritize-discovery-and-collaboration)).
...
- [BDD Best Practices](ex-soen-de-bedrdebd__17-best-practices.md) - Proven positive patterns
- [BDD Introduction](ex-soen-de-bedrdebd__01-introduction-and-philosophy.md) - BDD philosophy and when to use
- [Gherkin Syntax](ex-soen-de-bedrdebd__02-gherkin-syntax-and-scenarios.md) - Given-When-Then format
- [Three Amigos Practice](ex-soen-de-bedrdebd__04-three-amigos-practice.md) - Collaborative discovery
- [Example Mapping](ex-soen-de-bedrdebd__05-example-mapping.md) - Workshop technique

**BDD in Practice**:

- [BDD Tools](ex-soen-de-bedrdebd__11-bdd-frameworks.md) - Cucumber, SpecFlow, Behave
- [BDD in Nx Monorepo](ex-soen-de-bedrdebd__15-bdd-in-nx-monorepo.md) - Monorepo-specific practices

**Complementary Practices**:

- [BDD and TDD](ex-soen-de-bedrdebd__13-bdd-and-tdd.md) - Complementary relationship
- [BDD and DDD](ex-soen-de-bedrdebd__14-bdd-and-ddd.md) - Ubiquitous language in scenarios
