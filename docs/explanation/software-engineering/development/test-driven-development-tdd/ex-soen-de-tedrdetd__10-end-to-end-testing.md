...
- **[03. Test Types and Testing Pyramid](ex-soen-de-tedrdetd__03-test-types-and-pyramid.md)** - E2E tests at pyramid top
- **[09. Integration Testing](ex-soen-de-tedrdetd__09-integration-testing.md)** - Contrast with integration tests
- **[18. Best Practices](ex-soen-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-soen-de-tedrdetd__19-anti-patterns.md)** - E2E anti-patterns
- **[15. Decision Trees and Best Practices](ex-soen-de-tedrdetd__15-decision-trees-and-best-practices.md)** - When to write E2E vs other test types
