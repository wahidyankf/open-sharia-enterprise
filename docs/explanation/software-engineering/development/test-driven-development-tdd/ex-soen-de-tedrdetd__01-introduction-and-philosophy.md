...
TDD and FP are natural allies. See [TDD and Functional Programming](ex-soen-de-tedrdetd__11-tdd-and-functional-programming.md).
...
See [TDD and DDD](ex-soen-de-tedrdetd__12-tdd-and-ddd.md) for comprehensive integration.
...
See [TDD in Nx Monorepo](ex-soen-de-tedrdetd__16-tdd-in-nx-monorepo.md).
...
- **Related Files**:
  ...
  - [02. Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md) - The fundamental TDD workflow
  - [03. Test Types and Pyramid](ex-soen-de-tedrdetd__03-test-types-and-pyramid.md) - Testing strategy
- **Prerequisites**: Basic programming knowledge, familiarity with testing concepts
- **Next Steps**: Read [Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md) to learn the core TDD workflow
