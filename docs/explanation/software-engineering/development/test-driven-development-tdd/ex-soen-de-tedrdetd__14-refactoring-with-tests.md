...
- **[02. Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md)** - TDD workflow with refactoring
- **[13. Legacy Code and Characterization Tests](ex-soen-de-tedrdetd__13-legacy-code-and-characterization-tests.md)** - Refactoring legacy code
- **[18. Best Practices](ex-soen-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-soen-de-tedrdetd__19-anti-patterns.md)** - Avoiding brittle tests
- **[12. TDD and DDD](ex-soen-de-tedrdetd__12-tdd-and-ddd.md)** - Refactoring domain models
