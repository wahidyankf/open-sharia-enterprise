...
> **Companion Document**: This antipatterns guide complements the [TDD Best Practices](ex-soen-de-tedrdetd__18-best-practices.md) document. Together they provide comprehensive guidance on effective TDD.
...
- [TDD Best Practices](ex-soen-de-tedrdetd__18-best-practices.md) - Companion document with positive patterns

**TDD Fundamentals**:

- [TDD Core Concepts](ex-soen-de-tedrdetd__01-introduction-and-philosophy.md) - Three-phase cycle, benefits, principles
- [Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md) - Detailed cycle explanation
- [Test Types and Pyramid](ex-soen-de-tedrdetd__03-test-types-and-pyramid.md) - Testing strategy
...
- [Testing Patterns](ex-soen-de-tedrdetd__06-testing-patterns.md) - Common testing patterns
- [Decision Trees and Best Practices](ex-soen-de-tedrdetd__15-decision-trees-and-best-practices.md) - When to use specific approaches
