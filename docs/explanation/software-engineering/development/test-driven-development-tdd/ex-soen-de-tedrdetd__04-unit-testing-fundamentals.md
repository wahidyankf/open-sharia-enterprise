...
When dependencies are necessary, use test doubles. See [05. Test Doubles](ex-soen-de-tedrdetd__05-test-doubles.md) for detailed coverage.
...
Use builder pattern for complex test objects. See [07. Test Data Builders](ex-soen-de-tedrdetd__07-test-data-builders.md) for details.
...
- **[05. Test Doubles](ex-soen-de-tedrdetd__05-test-doubles.md)**: Mocks, stubs, spies, fakes
- **[06. Testing Patterns](ex-soen-de-tedrdetd__06-testing-patterns.md)**: AAA, Given-When-Then, table-driven tests
- **[07. Test Data Builders](ex-soen-de-tedrdetd__07-test-data-builders.md)**: Builder pattern for test fixtures
...
- **Related Files**:
  ...
  - [02. Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md) - TDD workflow
  - [03. Test Types and Pyramid](ex-soen-de-tedrdetd__03-test-types-and-pyramid.md) - Unit vs integration vs E2E
  - [05. Test Doubles](ex-soen-de-tedrdetd__05-test-doubles.md) - Mocking dependencies
- **Prerequisites**: [02. Red-Green-Refactor Cycle](ex-soen-de-tedrdetd__02-red-green-refactor-cycle.md), [03. Test Types and Pyramid](ex-soen-de-tedrdetd__03-test-types-and-pyramid.md)
- **Next Steps**: [05. Test Doubles](ex-soen-de-tedrdetd__05-test-doubles.md)
