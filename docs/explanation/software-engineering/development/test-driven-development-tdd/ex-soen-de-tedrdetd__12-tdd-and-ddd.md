...
// Integration test with real database covered in ex-soen-de-tedrdeve__09-integration-testing.md
```
...
- **[07. Test Data Builders](ex-soen-de-tedrdetd__07-test-data-builders.md)** - Builders for aggregates and value objects
- **[09. Integration Testing](ex-soen-de-tedrdetd__09-integration-testing.md)** - Repository persistence testing
- **[11. TDD and Functional Programming](ex-soen-de-tedrdetd__11-tdd-and-functional-programming.md)** - Value objects as pure data
- **[14. Refactoring with Tests](ex-soen-de-tedrdetd__14-refactoring-with-tests.md)** - Refactoring domain models safely
