...
- **[04. Unit Testing Fundamentals](ex-soen-de-tedrdetd__04-unit-testing-fundamentals.md)** - FIRST principles and test structure
- **[06. Testing Patterns](ex-soen-de-tedrdetd__06-testing-patterns.md)** - AAA pattern and test organization
- **[11. TDD and Functional Programming](ex-soen-de-tedrdetd__11-tdd-and-functional-programming.md)** - Property-based testing assertions
- **[18. Best Practices](ex-soen-de-tedrdetd__18-best-practices.md)** - TDD best practices
- **[19. Antipatterns](ex-soen-de-tedrdetd__19-anti-patterns.md)** - Common assertion mistakes
