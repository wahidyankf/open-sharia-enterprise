...
- **[04. Unit Testing Fundamentals](ex-soen-de-tedrdetd__04-unit-testing-fundamentals.md)** - FIRST principles apply to pure functions
- **[06. Testing Patterns](ex-soen-de-tedrdetd__06-testing-patterns.md)** - AAA pattern for functional tests
- **[08. Assertion Patterns](ex-soen-de-tedrdetd__08-assertion-patterns.md)** - Assertions for functional code
- **[12. TDD and DDD](ex-soen-de-tedrdetd__12-tdd-and-ddd.md)** - Value objects are immutable and pure
- **[14. Refactoring with Tests](ex-soen-de-tedrdetd__14-refactoring-with-tests.md)** - Refactoring toward pure functions
