...
See [Strategic Design Process](./ex-soen-ar-dodrdedd__06-strategic-design-process.md) for detailed Event Storming guidance.
...
<!-- TODO: Create Glossary Template at ./templates/ex-soen-ar-dodrdedd-te__ubiquitous-language-glossary.md -->
...
See [Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md) for detailed guidance on context boundaries.

## Glossary Template Reference

Use the standardized template to document your Ubiquitous Language:

<!-- TODO: Glossary Template - ./templates/ex-soen-ar-dodrdedd-te__ubiquitous-language-glossary.md -->
...
- **[Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)** - Define where your Ubiquitous Language applies
- **[Context Mapping](./ex-soen-ar-dodrdedd__04-context-mapping.md)** - Integrate contexts with different languages
- **[Strategic Design Process](./ex-soen-ar-dodrdedd__06-strategic-design-process.md)** - Run Event Storming to discover terminology
<!-- TODO: Glossary Template - ./templates/ex-soen-ar-dodrdedd-te__ubiquitous-language-glossary.md - Document your language -->
