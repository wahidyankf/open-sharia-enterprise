...
See [Decision Trees and Best Practices](./ex-soen-ar-dodrdedd__16-decision-trees-and-best-practices.md) for comprehensive decision guidance.
...
- **[Entities](./ex-soen-ar-dodrdedd__07-entities.md)** - Understand identity-based objects within aggregates
- **[Value Objects](./ex-soen-ar-dodrdedd__08-value-objects.md)** - Immutable values within aggregates
- **[Repositories](./ex-soen-ar-dodrdedd__10-repositories.md)** - Persistence abstraction for aggregates
- **[Domain Events](./ex-soen-ar-dodrdedd__12-domain-events.md)** - Eventual consistency between aggregates
- **[Decision Trees and Best Practices](./ex-soen-ar-dodrdedd__16-decision-trees-and-best-practices.md)** - Practical aggregate design guidance
- <!-- TODO: Aggregate Design Template - ./templates/ex-soen-ar-dodrdedd-te__aggregate-design-template.md - Document your aggregates -->
