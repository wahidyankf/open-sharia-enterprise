...
- **[Entities](./ex-soen-ar-dodrdedd__07-entities.md)** - Understand objects with identity and lifecycle
- **[Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md)** - Learn how value objects and entities are organized
- **[Domain Services](./ex-soen-ar-dodrdedd__11-domain-services.md)** - Operations involving multiple value objects
...
- **[DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style value objects
