...
- **[Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md)** - Understand what repositories persist
- **[Entities](./ex-soen-ar-dodrdedd__07-entities.md)** - Objects repositories work with
- **[Domain Services](./ex-soen-ar-dodrdedd__11-domain-services.md)** - Services using repositories
- **[Layered Architecture](./ex-soen-ar-dodrdedd__15-layered-architecture.md)** - Where repositories fit
- **[DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style repositories
