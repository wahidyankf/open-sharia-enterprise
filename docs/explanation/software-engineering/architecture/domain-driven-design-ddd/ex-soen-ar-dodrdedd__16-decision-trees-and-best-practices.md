...
- **[Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md)** - Deep dive into aggregate design
- **[Value Objects](./ex-soen-ar-dodrdedd__08-value-objects.md)** - Replacing primitives with Value Objects
- **[DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md)** - Immutability and pure functions
- **[Layered Architecture](./ex-soen-ar-dodrdedd__15-layered-architecture.md)** - Organizing layers correctly
