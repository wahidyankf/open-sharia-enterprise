...
- [Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md) - Understanding aggregate structure and boundaries
- [Value Objects](./ex-soen-ar-dodrdedd__08-value-objects.md) - Creating immutable value objects
- [Repositories](./ex-soen-ar-dodrdedd__10-repositories.md) - Persisting and reconstituting aggregates
- [Domain Events](./ex-soen-ar-dodrdedd__12-domain-events.md) - Events raised during object creation
