...
See [DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md) for detailed guidance.
...
1. **Start with Strategic Design** ([Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md), [Ubiquitous Language](./ex-soen-ar-dodrdedd__02-ubiquitous-language.md))
2. **Map your domain** ([Context Mapping](./ex-soen-ar-dodrdedd__04-context-mapping.md), [Subdomains](./ex-soen-ar-dodrdedd__05-subdomains.md))
3. **Learn tactical patterns** ([Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md), [Value Objects](./ex-soen-ar-dodrdedd__08-value-objects.md), [Entities](./ex-soen-ar-dodrdedd__07-entities.md))
...
- **[C4 Architecture Model](../c4-architecture-model/README.md)**: C4 provides visualization, DDD provides domain modeling
  ...
  - See [DDD and C4 Integration](./ex-soen-ar-dodrdedd__17-ddd-and-c4-integration.md)
...
- **[Functional Programming Principles](../../../../../governance/development/pattern/functional-programming.md)**: FP and DDD align on immutability and explicit data flow
  - See [DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md)

- **[Layered Architecture](./ex-soen-ar-dodrdedd__15-layered-architecture.md)**: DDD's domain layer fits into broader architectural patterns
...
- **[Ubiquitous Language](./ex-soen-ar-dodrdedd__02-ubiquitous-language.md)**: Create a shared vocabulary with domain experts
- **[Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)**: Define clear boundaries around domain models
- **[README Learning Paths](./README.md)**: Choose a structured learning path based on your goals
- **[Strategic Design Process](./ex-soen-ar-dodrdedd__06-strategic-design-process.md)**: Learn Event Storming and workshop facilitation
