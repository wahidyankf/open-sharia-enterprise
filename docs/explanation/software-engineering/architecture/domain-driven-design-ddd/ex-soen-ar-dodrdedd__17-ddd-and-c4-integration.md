...
- Internal: Shared Kernel with Inventory Management - [Context Map](./ex-soen-ar-dodrdedd__04-context-mapping.md)
```
...
- Tax Calculation Context (Core Domain) - [DDD Documentation](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)
- Inventory Management Context (Supporting) - [DDD Documentation](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)

**Integration Patterns**:

- Tax ↔ Payment Gateway: Anti-Corruption Layer - [Context Mapping](./ex-soen-ar-dodrdedd__04-context-mapping.md#anti-corruption-layer)
```
...
**WCAG AA-Compliant Colors** (TODO: Color Palette - ./templates/ex-soen-ar-dodrdedd-te\_\_color-palette.md):
...
**Template**: Aggregate Design Template (TODO: ./templates/ex-soen-ar-dodrdedd-te\_\_aggregate-design-template.md)
...
- **[Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)** - DDD strategic pattern
- **[Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md)** - DDD tactical pattern
- **[Context Mapping](./ex-soen-ar-dodrdedd__04-context-mapping.md)** - Integration patterns
- **[Layered Architecture](./ex-soen-ar-dodrdedd__15-layered-architecture.md)** - Organizing layers in C4 component diagrams
