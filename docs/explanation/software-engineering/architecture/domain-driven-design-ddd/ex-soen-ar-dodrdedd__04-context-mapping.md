...
- **[Strategic Design Process](./ex-soen-ar-dodrdedd__06-strategic-design-process.md)** - Discover contexts and relationships through Event Storming
- **[Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)** - Understand the contexts being mapped
- **Context Map Template (TODO: ./templates/ex-soen-ar-dodrdedd-te\_\_context-map-diagram.md)** - Document your context maps
