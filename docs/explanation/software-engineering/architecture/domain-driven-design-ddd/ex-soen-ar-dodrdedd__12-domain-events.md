...
- **[Aggregates](./ex-soen-ar-dodrdedd__09-aggregates.md)** - Understand what publishes events
- **[Domain Services](./ex-soen-ar-dodrdedd__11-domain-services.md)** - Services responding to events
- **[Bounded Contexts](./ex-soen-ar-dodrdedd__03-bounded-contexts.md)** - Integration via events
- **[Context Mapping](./ex-soen-ar-dodrdedd__04-context-mapping.md)** - Event publishing patterns
- **[DDD and Functional Programming](./ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style events
- <!-- TODO: Domain Event Catalog Template - ./templates/ex-soen-ar-dodrdedd-te__domain-event-catalog.md - Document your events -->
