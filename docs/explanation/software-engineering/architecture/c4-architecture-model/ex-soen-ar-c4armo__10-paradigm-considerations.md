...
- Component Diagram: See "Example: Order Service Components" in [Level 3: Component Diagram](./ex-soen-ar-c4armo__03-level-3-component.md#example-order-service-components-java-spring-boot-microservice)
- Code Diagram: See "Example 1" and "Example 2" in [Level 4: Code Diagram](./ex-soen-ar-c4armo__05-level-4-code.md)

**FP Examples**:

- Component Diagram: See "Functional Programming Approach" in [Level 3: Component (FP)](./ex-soen-ar-c4armo__04-level-3-component-fp.md)
- Code Diagram: See "Functional Programming Approach" in [Level 4: Code (FP)](./ex-soen-ar-c4armo__06-level-4-code-fp.md)

**Paradigm-Agnostic Examples**:

- System Context: See examples in [Level 1: System Context](./ex-soen-ar-c4armo__01-level-1-system-context.md)
- Container: See examples in [Level 2: Container](./ex-soen-ar-c4armo__02-level-2-container.md)
...
See [DDD Functional Programming](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md) for FP-specific patterns.
