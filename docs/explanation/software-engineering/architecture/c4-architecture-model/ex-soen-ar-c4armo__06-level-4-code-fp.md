...
See [C4 Model Best Practices](./ex-soen-ar-c4armo__14-best-practices.md) and [DDD Functional Programming](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__14-ddd-and-functional-programming.md).
