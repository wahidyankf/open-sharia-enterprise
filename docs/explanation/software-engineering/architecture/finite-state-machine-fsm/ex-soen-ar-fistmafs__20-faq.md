...
- Basic understanding of FSM concepts (see `ex-soen-ar-fsm__01-fundamentals-and-theory.md`)
...
- **Framework Comparisons**: `ex-soen-ar-fsm__13-framework-spring-state-machine-xstate.md`
- **Best Practices**: `ex-soen-ar-fsm__17-best-practices.md`
- **Decision Guidelines**: `ex-soen-ar-fsm__16-decision-trees-and-guidelines.md`
