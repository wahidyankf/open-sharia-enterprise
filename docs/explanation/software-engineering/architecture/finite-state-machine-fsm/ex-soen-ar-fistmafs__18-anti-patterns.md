...
> **Companion Document**: For positive guidance on what to do, see [Best Practices](ex-soen-ar-fistmafs__17-best-practices.md)
...
- Understanding of FSM fundamentals (see `ex-soen-ar-fsm__01-introduction-and-philosophy.md`)
- Familiarity with implementation patterns (see `ex-soen-ar-fsm__08-oop-implementation-patterns.md`)
- Knowledge of best practices (see `ex-soen-ar-fsm__17-best-practices.md`)
...
- **FSM Fundamentals**: [ex-soen-ar-fsm\_\_01-introduction-and-philosophy.md](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)
- **Implementation Patterns**: [ex-soen-ar-fsm\_\_08-oop-implementation-patterns.md](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)
- **Testing FSMs**: [ex-soen-ar-fsm\_\_12-testing-fsm-implementations.md](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)
- **Best Practices**: [ex-soen-ar-fsm\_\_18-best-practices.md](ex-soen-ar-fistmafs__17-best-practices.md)
- **DDD Integration**: [ex-soen-ar-fsm\_\_20-integration-with-ddd-and-architecture.md](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)
...
When you catch yourself implementing any of these anti-patterns, step back and ask: **Am I adding clarity or confusion?** If the answer is confusion, refactor to follow FSM best practices. For positive guidance, refer to the [Best Practices](ex-soen-ar-fistmafs__17-best-practices.md) document.
