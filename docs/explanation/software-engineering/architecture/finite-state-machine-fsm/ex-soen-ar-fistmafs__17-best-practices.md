...
> **Companion Document**: For common mistakes to avoid, see [Anti-Patterns](ex-soen-ar-fistmafs__18-anti-patterns.md)
...
- Knowledge of testing approaches (see `ex-soen-ar-fsm__12-testing-fsm-implementations.md`)
...
- **Decision Guidelines**: [ex-soen-ar-fsm\_\_16-decision-trees-and-guidelines.md](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md)
- **Anti-Patterns**: [ex-soen-ar-fsm\_\_19-anti-patterns.md](ex-soen-ar-fistmafs__18-anti-patterns.md)
