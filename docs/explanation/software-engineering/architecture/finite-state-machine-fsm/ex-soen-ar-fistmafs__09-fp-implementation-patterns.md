...
- [Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md): Pure guard functions
- [OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md): OOP alternative
- [Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md): Event sourcing with fold
- [Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md): Property-based testing
...
1. **Compare with OOP**: [OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)
2. **Test with properties**: [Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)
3. **Integrate with event sourcing**: [Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)
4. **Choose a framework**: [Framework Comparisons](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md)
