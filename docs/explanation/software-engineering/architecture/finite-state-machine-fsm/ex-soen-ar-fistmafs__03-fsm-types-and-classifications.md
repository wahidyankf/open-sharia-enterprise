...
- [Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md) - Foundation concepts
- [State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md) - Deep dive on avoiding state explosion
- [Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md) - Comprehensive hierarchical FSM patterns
- [Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md) - Which FSM type to choose

### Architecture Documentation

- [DDD Aggregates](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__09-aggregates.md) - FSMs model aggregate state

### Templates

- Hierarchical State Machine Diagram (TODO: ./templates/ex-soen-ar-fsm-te\_\_hierarchical-state-machine-diagram.md) - Template for nested states
- State Machine Specification (TODO: ./templates/ex-soen-ar-fsm-te\_\_state-machine-specification.md) - Document FSM type and rationale

## Next Steps

1. **Avoid state explosion**: Read [State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md)
2. **Master hierarchical states**: Read [Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md)
3. **Learn transition mechanics**: Read [Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md)
4. **Design your FSM**: Use State Machine Specification (TODO: ./templates/ex-soen-ar-fsm-te\_\_state-machine-specification.md) template
