...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
...
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)**
...
3. **[FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)**
...
1. **[State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md)**
...
2. **[Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md)**
...
3. **[Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md)**
...
4. **[Design Patterns and Best Practices](ex-soen-ar-fistmafs__07-design-patterns-and-best-practices.md)**
...
1. **[OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)**
...
2. **[FP Implementation Patterns](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md)**
...
3. **[Declarative and DSL Approaches](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md)**
...
4. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)**
...
1. **[Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)**
...
2. **[Framework: Spring State Machine & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md)**
...
3. **[Framework: Statecharts & Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)**
...
1. **[Debugging and Visualization](ex-soen-ar-fistmafs__15-debugging-and-visualization.md)**
...
2. **[Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md)**
...
3. **[Best Practices and Common Mistakes](ex-soen-ar-fistmafs__17-best-practices.md)**
...
4. **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)**
...
1. **[FAQ](ex-soen-ar-fistmafs__20-faq.md)**
...
1. Read **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)** - What is FSM section (first 200 lines)
2. Review decision matrix: "Should I use an FSM?" in **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
3. Glance at **[Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md)** flowcharts
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)** - Full read
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)** - States, transitions, events, guards
3. **Choose paradigm**:
   - OOP → **[OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)**
   - FP → **[FP Implementation Patterns](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md)**
   - Declarative → **[Declarative and DSL Approaches](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md)**
...
1. **Foundation**:
   - **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
   - **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)**
   - **[FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)**
2. **Complexity Management**:
   - **[State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md)**
   - **[Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md)**
3. **Implementation**:
   - Read all paradigm chapters ([OOP](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md), [FP](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md), [Declarative](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md), [Event-Driven](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)) or focus on your paradigm
   - Read framework chapters ([Spring SSM & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md), [Statecharts & Temporal](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)) for framework selection
4. **Best Practices**:
   - **[Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)**
   - **[Best Practices and Common Mistakes](ex-soen-ar-fistmafs__17-best-practices.md)**
   - **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)**
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)**
3. **[OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)**
4. **[Framework: Spring State Machine & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md)** - Spring SSM section
5. **[Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)**
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)** - Focus on immutability and pure functions
3. **[FP Implementation Patterns](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md)**
4. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)** - Functional reactive patterns
5. **[Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)** - Property-based testing
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)** - Focus on notation standards (SCXML)
3. **[Declarative and DSL Approaches](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md)**
4. **[Framework: Statecharts & Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)** - SCXML section
5. **[Debugging and Visualization](ex-soen-ar-fistmafs__15-debugging-and-visualization.md)** - Visual FSM designers
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)** - Focus on events and event sourcing
3. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)**
4. **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)** - Event sourcing + CQRS
5. **[Framework: Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)** - Saga patterns
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[OOP Implementation Patterns](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md)** - State Pattern foundation
3. **[Framework: Spring State Machine & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md)** - Spring SSM section
4. **[Testing FSM Implementations](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)**
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)**
3. **[Framework: Spring State Machine & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md)** - XState section
4. **[Debugging and Visualization](ex-soen-ar-fistmafs__15-debugging-and-visualization.md)** - XState Viz
5. Integrate with XState framework

#### Temporal/Cadence (Workflow Orchestration)

1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)** - FSM vs workflow engines
2. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)** - Saga patterns
3. **[Framework: Statecharts & Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)** - Temporal section
...
1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)**
3. **[DDD Aggregates](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__09-aggregates.md)** - FSMs in aggregates

#### Microservices

1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)** - Concurrent regions
3. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)** - Distributed FSMs
4. **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)** - Microservices section

#### CQRS + Event Sourcing

1. **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
2. **[Event-Driven and Reactive FSM](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md)** - Event sourcing with FSMs
3. **[Integration with DDD and Architecture](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)** - CQRS + Event Sourcing
4. Apply Event-Driven Saga patterns
...
**Files**: 01, 02, 03, 04, 05, [FP Implementation](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md), [Event-Driven](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md), [Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)
...
**Files**: 01, 02, 03, 04, 05, [OOP Implementation](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md), [Spring SSM & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md), [DDD Integration](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)
...
**Files**: 01, 02, 03, 04, [Spring SSM & XState](ex-soen-ar-fistmafs__13-framework-spring-state-machine-xstate.md), [Debugging and Visualization](ex-soen-ar-fistmafs__15-debugging-and-visualization.md)
...
**Files**: 01, [FP Implementation](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md), [Event-Driven](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md), [Temporal/Cadence](ex-soen-ar-fistmafs__14-framework-statecharts-temporal-cadence.md)
...
**Files**: 01, [Declarative and DSL](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md), [Testing](ex-soen-ar-fistmafs__12-testing-fsm-implementations.md)
...
- **[DDD Aggregates](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__09-aggregates.md)**: FSMs model aggregate entity lifecycle
...
- **Java**: [Java Idioms](../../programming-languages/java/) - State Pattern, Spring State Machine integration
...
- [ ] Read **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**
- [ ] Understand states, transitions, events from **[Core Concepts](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)**
- [ ] Review OSE domain examples that match your use case

### 2. Validate FSM is Appropriate

- [ ] Use decision matrix in **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)**: "Should I use an FSM?"
...
- [ ] Review **[FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)**
...
- [ ] Review decision trees in **[Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md)**
- [ ] Read paradigm-specific chapter ([OOP](ex-soen-ar-fistmafs__08-oop-implementation-patterns.md), [FP](ex-soen-ar-fistmafs__09-fp-implementation-patterns.md), [Declarative](ex-soen-ar-fistmafs__10-declarative-and-dsl-approaches.md), [Event-Driven](ex-soen-ar-fistmafs__11-event-driven-and-reactive-fsm.md))
...
**Next step**: Begin with **[Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md)** or jump to your chosen learning path above.

**Questions?**: See **[FAQ](ex-soen-ar-fistmafs__20-faq.md)** or review decision trees in **[Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md)**.
