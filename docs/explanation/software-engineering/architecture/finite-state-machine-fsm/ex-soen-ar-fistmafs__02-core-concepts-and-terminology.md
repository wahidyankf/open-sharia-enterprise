...
- [Introduction and Philosophy](ex-soen-ar-fistmafs__01-introduction-and-philosophy.md) - Why FSMs matter
- [FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md) - Next: FSM variants
- [Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md) - Deep dive into transition mechanics
- [Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md) - Composite states and sub-states

### Architecture Documentation

- [DDD Value Objects](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__08-value-objects.md) - Context as value objects

### Templates

- Blank State Machine Diagram (TODO: ./templates/ex-soen-ar-fsm-te\_\_blank-state-machine-diagram.md) - Create your first FSM diagram
- State Transition Table (TODO: ./templates/ex-soen-ar-fsm-te\_\_state-transition-table.md) - Document transitions in tabular format

## Next Steps

1. **Understand FSM variants**: Read [FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)
2. **Learn state explosion mitigation**: Read [State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md)
3. **Master hierarchical states**: Read [Hierarchical and Nested States](ex-soen-ar-fistmafs__05-hierarchical-and-nested-states.md)
4. **Design your first FSM**: Use State Machine Specification (TODO: ./templates/ex-soen-ar-fsm-te\_\_state-machine-specification.md) template
