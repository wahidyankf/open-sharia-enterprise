...
**DDD Integration**: See [ex-soen-ar-fsm\_\_18-integration-with-ddd-and-architecture.md](ex-soen-ar-fistmafs__19-integration-with-ddd-and-architecture.md)
...
- [DDD Aggregates](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__09-aggregates.md) - FSMs model aggregate lifecycle

### Related FSM Topics

- [Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md) - Next: Learn FSM building blocks
- [FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md) - Understand FSM variants
- [Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md) - Detailed decision frameworks

## Next Steps

1. **Understand building blocks**: Read [Core Concepts and Terminology](ex-soen-ar-fistmafs__02-core-concepts-and-terminology.md)
2. **Choose FSM type**: Read [FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md)
