...
- [FSM Types and Classifications](ex-soen-ar-fistmafs__03-fsm-types-and-classifications.md) - Introduction to hierarchical FSMs
- [State Explosion and Mitigation](ex-soen-ar-fistmafs__04-state-explosion-and-mitigation.md) - Hierarchy as mitigation strategy
- [Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md) - Event propagation in hierarchies
- [Decision Trees and Guidelines](ex-soen-ar-fistmafs__16-decision-trees-and-guidelines.md) - When to use hierarchy

### Architecture Documentation

- [DDD Aggregates](../domain-driven-design-ddd/ex-soen-ar-dodrdedd__09-aggregates.md) - Hierarchical FSMs model aggregate lifecycle

### Templates

- Hierarchical State Machine Diagram (TODO: ./templates/ex-soen-ar-fsm-te\_\_hierarchical-state-machine-diagram.md) - Template for nested state diagrams
- State Machine Specification (TODO: ./templates/ex-soen-ar-fsm-te\_\_state-machine-specification.md) - Document hierarchical structure

## Next Steps

1. **Learn transition mechanics**: Read [Events, Guards, and Actions](ex-soen-ar-fistmafs__06-events-guards-and-actions.md)
2. **Study design patterns**: Read [Design Patterns and Best Practices](ex-soen-ar-fistmafs__07-design-patterns-and-best-practices.md)
3. **Choose implementation approach**: Read paradigm-specific chapters (08-11)
4. **Design your FSM**: Use Hierarchical State Machine Diagram (TODO: ./templates/ex-soen-ar-fsm-te\_\_hierarchical-state-machine-diagram.md) template
