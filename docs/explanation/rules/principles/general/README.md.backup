...
- [Simplicity Over Complexity](./ex-pr-ge__simplicity-over-complexity.md) - Favor minimum viable abstraction and avoid over-engineering. Start simple and add complexity only when proven necessary
