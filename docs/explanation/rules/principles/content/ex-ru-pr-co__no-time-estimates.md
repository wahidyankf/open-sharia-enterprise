...
**Location**: `docs/explanation/rules/conventions/tutorial/ex-ru-co-tu__naming.md`
...
**Location**: `docs/explanation/rules/conventions/content/ex-ru-co-co__quality.md`
