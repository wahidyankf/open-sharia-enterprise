...
- [Plan Execution](./ex-wf-pl__execution.md) - Execute plan tasks systematically with validation and completion tracking using plan**executor and plan**execution-checker
- [Plan Quality Gate](./ex-wf-pl__quality-gate.md) - Validate plan completeness and accuracy, apply fixes iteratively until ZERO findings using plan**checker and plan**fixer

## Related Documentation

- [Workflows Index](../README.md) - All orchestrated workflows
- [Plans Organization Convention](../../conventions/project/ex-co-pr__plans-organization.md) - Plan structure standards
