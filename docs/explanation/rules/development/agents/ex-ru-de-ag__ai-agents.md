...
**CRITICAL GUIDELINE**: When invoking agents (`.claude/agents/`) and workflows (`docs/explanation/rules/workflows/`), **do NOT think about token budget constraints**.
...
- `docs/explanation/rules/conventions/content/ex-ru-co-co__quality.md` - Content Quality Principles
- `docs/explanation/rules/conventions/formatting/ex-ru-co-fo__linking.md` - Linking Convention
```
...
- `docs/explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md` - AI agents convention

❌ Bad:

- [[ex-de__ai-agents]] - Obsidian wiki link (not GitHub compatible)
- `/docs/explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md` - Absolute path
- `docs/explanation/rules/development/agents/ex-ru-de-ag__ai-agents` - Missing .md extension
```
...
1. **Move details to conventions OR development docs (PRIMARY STRATEGY)** - **CRITICAL:** MOVE content to appropriate docs, NOT DELETE.
   ...
   **Destinations**:
   - `docs/explanation/rules/conventions/` (content/format standards)
   - `docs/explanation/rules/development/` (process/workflow standards)
...
│       └─ YES → Create/update Convention in docs/explanation/rules/conventions/
...
**MANDATORY**: Write findings PROGRESSIVELY to `generated-reports/` per [Temporary Files Convention](../../docs/explanation/rules/development/infra/ex-ru-de-in__temporary-files.md).
...
- [ ] No content duplicates Conventions (check `docs/explanation/rules/conventions/`)
...
- `docs/explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md` - AI agents convention (all agents must follow)
