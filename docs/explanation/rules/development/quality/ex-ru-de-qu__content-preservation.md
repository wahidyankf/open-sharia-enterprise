...
### docs/explanation/rules/conventions/ - Content and Format Standards
...
### docs/explanation/rules/development/ - Development Processes and Workflows
...
Is this content unique and valuable?
	...
	│   │   └─> docs/explanation/rules/development/
	│   │
...
2. Use `docs__maker` to create new convention doc in `docs/explanation/rules/conventions/` or `docs/explanation/rules/development/`
3. Move ALL relevant content to new convention (comprehensive detail)
4. Replace original content with 2-5 line summary + link
5. Update appropriate index (`docs/explanation/rules/conventions/README.md` or `docs/explanation/rules/development/README.md`)
...
- **After:**
  - New file: `docs/explanation/rules/development/infra/ex-ru-de-in__acceptance-criteria.md` (comprehensive)
...
- **After:**
  - Updated: `docs/explanation/rules/development/workflow/ex-ru-de-wo__trunk-based-development.md` (comprehensive)
...
- **After:**
  - New file: `docs/explanation/rules/conventions/formatting/ex-ru-co-fo__diagrams.md` (comprehensive)
...
- **After:**
  - New file: `docs/explanation/rules/development/quality/ex-ru-de-qu__testing-strategy.md` (comprehensive)
...
**Destination:** `docs/explanation/rules/development/`
...
2. Create new doc OR expand existing in `docs/explanation/rules/development/`
...
6. Update development index (`docs/explanation/rules/development/README.md`)
...
- **After:**
  - Updated: `docs/explanation/rules/development/workflow/ex-ru-de-wo__commit-messages.md` (comprehensive)
...
- Add new conventions to `docs/explanation/rules/conventions/README.md`
- Add new development docs to `docs/explanation/rules/development/README.md`
...
**For docs/explanation/rules/conventions/** (content/format):
...
**For docs/explanation/rules/development/** (process/workflow):
