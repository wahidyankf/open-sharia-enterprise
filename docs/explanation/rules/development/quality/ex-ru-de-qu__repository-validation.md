...
- **Validation agents** - wow**rules-checker, docs**checker, docs-link-general-checker, etc.
- **Fix agents** - wow\_\_rules-fixer and similar automated fix tools
...
```bash
# Validate link from docs/explanation/rules/conventions/formatting/ex-ru-co-fo__linking.md
file="docs/explanation/rules/conventions/formatting/ex-ru-co-fo__linking.md"
...
# Resolve path
resolved_path=$(dirname "$file")/"$link_target"
# Result: docs/explanation/rules/conventions/./ex-co__file-naming.md
...
```bash
# docs/explanation/rules/conventions/ → ex-co
# docs/tutorials/ → tu
# docs/how-to/ → hoto
# docs/reference/ → re
# docs/explanation/rules/development/ → ex-de
```
