...
- [Acceptance Criteria Convention](./ex-ru-de-in__acceptance-criteria.md) - Writing testable acceptance criteria using Gherkin format for clarity and automation
- [Temporary Files Convention](./ex-ru-de-in__temporary-files.md) - Guidelines for AI agents creating temporary uncommitted files and folders

## Related Documentation

- [Development Index](../README.md) - All development practices
- [Explicit Over Implicit Principle](../../principles/software-engineering/ex-ru-pr-se__explicit-over-implicit.md) - Why clear organization matters
