...
- **Hugo theme diagram rendering** - Covered in [Hugo Development Convention](../development/hugo/ex-de-hu__development.md)
...
**When to Use Init Directives**: Rarely needed. Most diagrams use default theming. Use only when you need to customize Mermaid's theme variables or configuration. See [Hugo Development Convention](../development/hugo/ex-de-hu__development.md) for examples of valid init directive usage.
