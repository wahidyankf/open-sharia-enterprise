...
- Tutorial-specific standards (that's tutorial/)
- Hugo-specific content rules (that's hugo/)

## Conventions

- [Content Quality Principles](./ex-co-co__quality.md) - Universal markdown content quality standards (writing style, heading hierarchy, accessibility, formatting)
- [Convention Writing](./ex-co-co__convention-writing.md) - **Meta-convention** defining how to write and organize convention documents
- [Factual Validation](./ex-co-co__factual-validation.md) - Universal methodology for validating factual correctness using web verification
- [OSS Documentation](./ex-co-co__oss-documentation.md) - Standards for repository documentation files (README, CONTRIBUTING, ADRs, security)
- [README Quality](./ex-co-co__readme-quality.md) - Quality standards for README.md files (engagement, accessibility, scannability)
