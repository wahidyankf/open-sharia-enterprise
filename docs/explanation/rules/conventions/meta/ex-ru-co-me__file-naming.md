...
### Conventions Subdirectories (`docs/explanation/rules/conventions/`)
...
### Development Subdirectories (`docs/explanation/rules/development/`)
...
### Workflows Subdirectories (`docs/explanation/rules/workflows/`)
...
### Principles Subdirectories (`docs/explanation/rules/principles/`)
...
docs/explanation/rules/conventions/README.md           # Subcategory index (conventions)
docs/explanation/rules/development/README.md           # Subcategory index (development)
docs/explanation/rules/principles/README.md            # Subcategory index (principles)
docs/explanation/rules/workflows/README.md             # Subcategory index (workflows)
```
...
```
docs/explanation/rules/conventions/formatting/ex-ru-co-fo__diagrams.md
docs/explanation/rules/conventions/formatting/ex-ru-co-fo__diagrams-example.png
```
...
**Example**: Creating a hypothetical `docs/explanation/rules/conventions/[new-category]/`:

- Directory pattern: `docs/explanation/rules/conventions/[new-category]/`
...
**Example**: Renaming `docs/explanation/rules/conventions/meta/` to `docs/explanation/rules/conventions/standards/`:

**Before**:

```
docs/explanation/rules/conventions/meta/
├── README.md
...
```
docs/explanation/rules/conventions/standards/
├── README.md
...
- Index: Update `docs/explanation/rules/conventions/README.md` to reflect new directory name
...
- Created 6 subdirectories in `docs/explanation/rules/conventions/`
...
- Created 6 subdirectories in `docs/explanation/rules/development/`
...
- Created 5 subdirectories in `docs/explanation/rules/workflows/`
