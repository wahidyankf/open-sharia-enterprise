...
1. Create principle document in `docs/explanation/rules/principles/`
2. Add "Vision Supported" section showing how it serves the vision
3. Update `docs/explanation/rules/principles/README.md` index
...
- Individual principles in `docs/explanation/rules/principles/`

**Layer 2**:

- [Conventions Index](./conventions/README.md)
- 24 convention documents in `docs/explanation/rules/conventions/`

**Layer 3**:

- [Development Index](./development/README.md)
- 15 practice documents in `docs/explanation/rules/development/`
