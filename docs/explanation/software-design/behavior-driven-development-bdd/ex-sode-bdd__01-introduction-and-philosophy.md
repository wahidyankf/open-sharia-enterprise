...
See [BDD and TDD](./ex-sode-bdd__13-bdd-and-tdd.md) for comprehensive integration guidance.
...
See [BDD and DDD](./ex-sode-bdd__14-bdd-and-ddd.md) for comprehensive integration.
...
See [BDD and TDD](./ex-sode-bdd__13-bdd-and-tdd.md) for detailed integration patterns.
...
- **Related Files**:
  ...
  - [02. Gherkin Syntax and Scenarios](./ex-sode-bdd__02-gherkin-syntax-and-scenarios.md) - Gherkin language and feature files
  - [03. Given-When-Then Pattern](./ex-sode-bdd__03-given-when-then-pattern.md) - GWT structure and patterns
...
- **Next Steps**: Read [Gherkin Syntax and Scenarios](./ex-sode-bdd__02-gherkin-syntax-and-scenarios.md) to learn the BDD specification language
