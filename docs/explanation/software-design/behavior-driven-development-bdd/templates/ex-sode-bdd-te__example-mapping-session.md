...
- **Related Templates**:
  - [Three Amigos Session](./ex-sode-bdd-te__three-amigos-session-template.md)
  - [User Story with Acceptance Criteria](./ex-sode-bdd-te__user-story-with-acceptance-criteria.md)
