...
**File**: [ex-sode-bdd-te\_\_feature-file-template.md](./ex-sode-bdd-te__feature-file-template.md)
...
**File**: [ex-sode-bdd-te\_\_scenario-template.md](./ex-sode-bdd-te__scenario-template.md)
...
**File**: [ex-sode-bdd-te\_\_user-story-with-acceptance-criteria.md](./ex-sode-bdd-te__user-story-with-acceptance-criteria.md)
...
**File**: [ex-sode-bdd-te\_\_example-mapping-session.md](./ex-sode-bdd-te__example-mapping-session.md)
...
**File**: [ex-sode-bdd-te\_\_step-definition-template.md](./ex-sode-bdd-te__step-definition-template.md)
...
**File**: [ex-sode-bdd-te\_\_scenario-outline-template.md](./ex-sode-bdd-te__scenario-outline-template.md)
...
**File**: [ex-sode-bdd-te\_\_three-amigos-session-template.md](./ex-sode-bdd-te__three-amigos-session-template.md)
...
- **BDD Core Concepts**: [Introduction and Philosophy](../ex-sode-bdd__01-introduction-and-philosophy.md)
- **Gherkin Syntax**: [Gherkin Syntax and Scenarios](../ex-sode-bdd__02-gherkin-syntax-and-scenarios.md)
- **Three Amigos**: [Three Amigos Practice](../ex-sode-bdd__04-three-amigos-practice.md)
- **Example Mapping**: [Example Mapping](../ex-sode-bdd__05-example-mapping.md)
- **Anti-patterns**: [Anti-patterns and Pitfalls](../ex-sode-bdd__16-anti-patterns-and-pitfalls.md)
- **FAQ**: [Frequently Asked Questions](../ex-sode-bdd__17-faq.md)
