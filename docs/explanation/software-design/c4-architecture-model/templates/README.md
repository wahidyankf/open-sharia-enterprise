...
1. **[Blank Context Diagram](./ex-sode-c4armo-te__blank-context-diagram.md)** - System-level view showing external actors and systems
2. **[Blank Container Diagram](./ex-sode-c4armo-te__blank-container-diagram.md)** - High-level technical building blocks (apps, databases, services)
3. **[Blank Component Diagram](./ex-sode-c4armo-te__blank-component-diagram.md)** - Internal structure of containers (classes, modules, services)
4. **[Blank Dynamic Diagram](./ex-sode-c4armo-te__blank-dynamic-diagram.md)** - Sequence diagram showing interactions over time
5. **[Blank Deployment Diagram](./ex-sode-c4armo-te__blank-deployment-diagram.md)** - Infrastructure mapping (servers, containers, cloud resources)

### Reference Materials

1. **[Color Palette Reference](./ex-sode-c4armo-te__color-palette.md)** - WCAG AA-compliant color palette with hex codes, contrast ratios, and usage guidelines
2. **[Starter Full Documentation](./ex-sode-c4armo-te__starter-full-documentation.md)** - Complete C4 documentation set for new systems (Context + Container + Component)
...
1. **Start with Context + Container**:
   - Copy [Blank Context Diagram](./ex-sode-c4armo-te__blank-context-diagram.md) to your project
   - Copy [Blank Container Diagram](./ex-sode-c4armo-te__blank-container-diagram.md) to your project
...
2. **Add Component Diagrams as Needed**:
   ...
   - Copy [Blank Component Diagram](./ex-sode-c4armo-te__blank-component-diagram.md)
   - Document one complex container at a time

3. **Add Supplementary Diagrams**:
   - **Dynamic**: For workflow documentation ([Blank Dynamic Diagram](./ex-sode-c4armo-te__blank-dynamic-diagram.md))
   - **Deployment**: For production infrastructure ([Blank Deployment Diagram](./ex-sode-c4armo-te__blank-deployment-diagram.md))

### For Comprehensive Documentation

Use [Starter Full Documentation](./ex-sode-c4armo-te__starter-full-documentation.md) which includes:
...
**See**: [Color Palette Reference](./ex-sode-c4armo-te__color-palette.md) for complete guidelines and verification checklist.
...
- **[Level 1: System Context](../ex-sode-c4armo__01-level-1-system-context.md)** - Context diagram guide
- **[Level 2: Container](../ex-sode-c4armo__02-level-2-container.md)** - Container diagram guide
- **[Level 3: Component](../ex-sode-c4armo__03-level-3-component.md)** - Component diagram guide
- **[Supplementary Diagrams](../ex-sode-c4armo__07-supplementary-diagrams.md)** - Dynamic and Deployment diagrams
- **[Best Practices](../ex-sode-c4armo__09-best-practices.md)** - When to use C4, common mistakes, tooling
