...
- **[Container Diagram](./ex-sode-c4armo-te__blank-container-diagram.md)**: Shows where [Container Name] fits in the system
- **[Code Diagram (Optional)](../ex-sode-c4armo__05-level-4-code.md)**: Shows implementation details (UML class diagram)
- **[Dynamic Diagram](./ex-sode-c4armo-te__blank-dynamic-diagram.md)**: Shows runtime interactions between components
...
- **OOP**: [Level 3: Component Diagram](../ex-sode-c4armo__03-level-3-component.md)
- **FP**: [Level 3: Component (Functional Programming)](../ex-sode-c4armo__04-level-3-component-fp.md)
- **Paradigm Guidance**: [Paradigm Considerations](../ex-sode-c4armo__10-paradigm-considerations.md)
