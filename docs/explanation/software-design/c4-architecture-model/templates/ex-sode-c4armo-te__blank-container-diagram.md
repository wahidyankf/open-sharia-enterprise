...
- **[System Context Diagram](./ex-sode-c4armo-te__blank-context-diagram.md)**: Shows where [Your System Name] fits in the broader ecosystem
- **[Component Diagram](./ex-sode-c4armo-te__blank-component-diagram.md)**: Shows internal structure of [Container Name]
- **[Deployment Diagram](./ex-sode-c4armo-te__blank-deployment-diagram.md)**: Shows how containers are deployed to infrastructure
...
**See**: [Level 2: Container](../ex-sode-c4armo__02-level-2-container.md) for detailed guidance.
