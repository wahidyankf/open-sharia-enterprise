...
- **Related Templates**:
  ...
  - [CI/CD Pipeline Template](./ex-sode-tedrdeve-te__ci-cd-pipeline-template.md)
...
- [Unit Test Template](./ex-sode-tedrdeve-te__unit-test-template.md) - Testing isolated units
- [Test Data Builder Template](./ex-sode-tedrdeve-te__test-data-builder-template.md) - Creating test data
- [CI/CD Pipeline Template](./ex-sode-tedrdeve-te__ci-cd-pipeline-template.md) - Running tests in pipeline
