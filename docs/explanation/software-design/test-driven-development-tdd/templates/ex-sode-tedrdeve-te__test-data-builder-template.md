...
- **Related Templates**:
  ...
  - [Integration Test Template](./ex-sode-tedrdeve-te__integration-test-template.md)
  - [Property-Based Test Template](./ex-sode-tedrdeve-te__property-based-test-template.md)
...
- [Unit Test Template](./ex-sode-tedrdeve-te__unit-test-template.md) - Using builders in unit tests
- [Integration Test Template](./ex-sode-tedrdeve-te__integration-test-template.md) - Using builders in integration tests
- [Property-Based Test Template](./ex-sode-tedrdeve-te__property-based-test-template.md) - Combining builders with property tests
