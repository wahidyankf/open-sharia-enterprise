...
- [Unit Test Template](./ex-sode-tedrdeve-te__unit-test-template.md) - Complementary example-based tests
- [Test Data Builder Template](./ex-sode-tedrdeve-te__test-data-builder-template.md) - Can be used in arbitraries
