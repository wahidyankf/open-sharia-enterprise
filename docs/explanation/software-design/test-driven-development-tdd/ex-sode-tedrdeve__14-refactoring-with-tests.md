...
- **[02. Red-Green-Refactor Cycle](./ex-sode-tedrdeve__02-red-green-refactor-cycle.md)** - TDD workflow with refactoring
- **[13. Legacy Code and Characterization Tests](./ex-sode-tedrdeve__13-legacy-code-and-characterization-tests.md)** - Refactoring legacy code
- **[15. Testing Anti-Patterns](./ex-sode-tedrdeve__15-testing-anti-patterns.md)** - Avoiding brittle tests
- **[12. TDD and DDD](./ex-sode-tedrdeve__12-tdd-and-ddd.md)** - Refactoring domain models
