...
TDD and FP are natural allies. See [TDD and Functional Programming](./ex-sode-tedrdeve__11-tdd-and-functional-programming.md).
...
See [TDD and DDD](./ex-sode-tedrdeve__12-tdd-and-ddd.md) for comprehensive integration.
...
See [TDD in Nx Monorepo](./ex-sode-tedrdeve__17-tdd-in-nx-monorepo.md).
...
- **Related Files**:
  ...
  - [02. Red-Green-Refactor Cycle](./ex-sode-tedrdeve__02-red-green-refactor-cycle.md) - The fundamental TDD workflow
  - [03. Test Types and Pyramid](./ex-sode-tedrdeve__03-test-types-and-pyramid.md) - Testing strategy
- **Prerequisites**: Basic programming knowledge, familiarity with testing concepts
- **Next Steps**: Read [Red-Green-Refactor Cycle](./ex-sode-tedrdeve__02-red-green-refactor-cycle.md) to learn the core TDD workflow
