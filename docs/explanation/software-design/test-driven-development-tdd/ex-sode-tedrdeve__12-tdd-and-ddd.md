...
// Integration test with real database covered in ex-sode-tedrdeve__09-integration-testing.md
```
...
- **[07. Test Data Builders](./ex-sode-tedrdeve__07-test-data-builders.md)** - Builders for aggregates and value objects
- **[09. Integration Testing](./ex-sode-tedrdeve__09-integration-testing.md)** - Repository persistence testing
- **[11. TDD and Functional Programming](./ex-sode-tedrdeve__11-tdd-and-functional-programming.md)** - Value objects as pure data
- **[14. Refactoring with Tests](./ex-sode-tedrdeve__14-refactoring-with-tests.md)** - Refactoring domain models safely
