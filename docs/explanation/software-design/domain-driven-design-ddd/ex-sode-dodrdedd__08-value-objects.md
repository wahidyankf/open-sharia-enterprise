...
- **[Entities](./ex-sode-dodrdedd__07-entities.md)** - Understand objects with identity and lifecycle
- **[Aggregates](./ex-sode-dodrdedd__09-aggregates.md)** - Learn how value objects and entities are organized
- **[Domain Services](./ex-sode-dodrdedd__11-domain-services.md)** - Operations involving multiple value objects
...
- **[DDD and Functional Programming](./ex-sode-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style value objects
