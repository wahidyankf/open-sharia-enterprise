...
- **[DDD and Functional Programming](./ex-sode-dodrdedd__14-ddd-and-functional-programming.md)** - Pure functional core fits naturally with layered architecture
- **[Aggregates](./ex-sode-dodrdedd__09-aggregates.md)** - Core domain layer building blocks
- **[Repositories](./ex-sode-dodrdedd__10-repositories.md)** - Infrastructure layer persistence abstraction
- **[DDD and C4 Integration](./ex-sode-dodrdedd__17-ddd-and-c4-integration.md)** - Visualizing layers with C4 diagrams
