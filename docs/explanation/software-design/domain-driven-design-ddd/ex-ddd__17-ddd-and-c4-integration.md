...
- Internal: Shared Kernel with Inventory Management - [Context Map](./ex-ddd__04-context-mapping.md)
```
...
- Zakat Calculation Context (Core Domain) - [DDD Documentation](./ex-ddd__03-bounded-contexts.md)
- Inventory Management Context (Supporting) - [DDD Documentation](./ex-ddd__03-bounded-contexts.md)

**Integration Patterns**:

- Zakat ↔ Payment Gateway: Anti-Corruption Layer - [Context Mapping](../domain-driven-design-ddd/ex-ddd__04-context-mapping.md#anti-corruption-layer)
```
...
**WCAG AA-Compliant Colors** (from [Color Palette](./ex-ddd__19-templates/color-palette.md)):
...
**Template**: [Aggregate Design Template](./ex-ddd__19-templates/aggregate-design-template.md)
...
- **[Bounded Contexts](./ex-ddd__03-bounded-contexts.md)** - DDD strategic pattern
- **[Aggregates](./ex-ddd__09-aggregates.md)** - DDD tactical pattern
- **[Context Mapping](./ex-ddd__04-context-mapping.md)** - Integration patterns
- **[Layered Architecture](./ex-ddd__15-layered-architecture.md)** - Organizing layers in C4 component diagrams
