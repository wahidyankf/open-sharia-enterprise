...
- [Introduction to DDD](./ex-sode-dodrdedd__01-introduction-and-philosophy.md) - Core concepts overview
- [Strategic Design](./ex-sode-dodrdedd__03-bounded-contexts.md) - Bounded contexts and context mapping
- [Tactical Patterns](./ex-sode-dodrdedd__09-aggregates.md) - Entities, value objects, aggregates
