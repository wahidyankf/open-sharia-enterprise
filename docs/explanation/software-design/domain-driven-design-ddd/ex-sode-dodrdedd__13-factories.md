...
- [Aggregates](./ex-sode-dodrdedd__09-aggregates.md) - Understanding aggregate structure and boundaries
- [Value Objects](./ex-sode-dodrdedd__08-value-objects.md) - Creating immutable value objects
- [Repositories](./ex-sode-dodrdedd__10-repositories.md) - Persisting and reconstituting aggregates
- [Domain Events](./ex-sode-dodrdedd__12-domain-events.md) - Events raised during object creation
