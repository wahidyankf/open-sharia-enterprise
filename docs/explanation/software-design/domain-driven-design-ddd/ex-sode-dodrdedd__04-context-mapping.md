...
- **[Strategic Design Process](./ex-sode-dodrdedd__06-strategic-design-process.md)** - Discover contexts and relationships through Event Storming
- **[Bounded Contexts](./ex-sode-dodrdedd__03-bounded-contexts.md)** - Understand the contexts being mapped
- **[Context Map Template](./templates/ex-sode-dodrdedd-te__context-map-diagram.md)** - Document your context maps
