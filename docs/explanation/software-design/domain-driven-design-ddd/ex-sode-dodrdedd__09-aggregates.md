...
See [Decision Trees and Best Practices](./ex-sode-dodrdedd__16-decision-trees-and-best-practices.md) for comprehensive decision guidance.
...
- **[Entities](./ex-sode-dodrdedd__07-entities.md)** - Understand identity-based objects within aggregates
- **[Value Objects](./ex-sode-dodrdedd__08-value-objects.md)** - Immutable values within aggregates
- **[Repositories](./ex-sode-dodrdedd__10-repositories.md)** - Persistence abstraction for aggregates
- **[Domain Events](./ex-sode-dodrdedd__12-domain-events.md)** - Eventual consistency between aggregates
- **[Decision Trees and Best Practices](./ex-sode-dodrdedd__16-decision-trees-and-best-practices.md)** - Practical aggregate design guidance
- **[Aggregate Design Template](./templates/ex-sode-dodrdedd-te__aggregate-design-template.md)** - Document your aggregates
