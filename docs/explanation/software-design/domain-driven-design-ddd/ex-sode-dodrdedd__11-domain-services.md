...
- **[Aggregates](./ex-sode-dodrdedd__09-aggregates.md)** - Understand what domain services operate on
- **[Entities](./ex-sode-dodrdedd__07-entities.md)** - Objects domain services work with
- **[Value Objects](./ex-sode-dodrdedd__08-value-objects.md)** - Inputs/outputs of domain services
- **[Repositories](./ex-sode-dodrdedd__10-repositories.md)** - Data access abstraction
- **[Layered Architecture](./ex-sode-dodrdedd__15-layered-architecture.md)** - Where domain services fit
- **[DDD and Functional Programming](./ex-sode-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style domain services
