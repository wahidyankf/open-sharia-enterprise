...
See [Domain Events](./ex-sode-dodrdedd__12-domain-events.md) for event publishing patterns.
...
**Note:** In FP, "anemic" entities (data structures) are acceptable because behavior lives in pure functions. See [DDD and Functional Programming](./ex-sode-dodrdedd__14-ddd-and-functional-programming.md).
...
Entities typically exist within aggregates. See [Aggregates](./ex-sode-dodrdedd__09-aggregates.md) for full context.
...
- **[Value Objects](./ex-sode-dodrdedd__08-value-objects.md)** - Understand immutable, structurally-equal domain primitives
- **[Aggregates](./ex-sode-dodrdedd__09-aggregates.md)** - Learn how entities are organized into consistency boundaries
- **[Repositories](./ex-sode-dodrdedd__10-repositories.md)** - Persistence abstraction for entities
- **[Domain Events](./ex-sode-dodrdedd__12-domain-events.md)** - Capture entity lifecycle events
- **[Decision Trees and Best Practices](./ex-sode-dodrdedd__16-decision-trees-and-best-practices.md)** - Entity vs. Value Object decision guidance
- **[DDD and Functional Programming](./ex-sode-dodrdedd__14-ddd-and-functional-programming.md)** - FP-style entities
