...
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Deep dive into aggregate design
- **[Value Objects](./ex-ddd__08-value-objects.md)** - Replacing primitives with Value Objects
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - Immutability and pure functions
- **[Layered Architecture](./ex-ddd__15-layered-architecture.md)** - Organizing layers correctly
