...
See [Bounded Context Canvas Template](./templates/ex-sode-dodrdedd-te__bounded-context-canvas.md) for full template.
...
- [Event Storming Template](./templates/ex-sode-dodrdedd-te__event-storming-output.md)
...
- **[Event Storming Template](./templates/ex-sode-dodrdedd-te__event-storming-output.md)** - Run your first Event Storming workshop
- **[Bounded Context Canvas Template](./templates/ex-sode-dodrdedd-te__bounded-context-canvas.md)** - Document each bounded context
- **[Ubiquitous Language](./ex-sode-dodrdedd__02-ubiquitous-language.md)** - Refine terminology from workshops
- **[Bounded Contexts](./ex-sode-dodrdedd__03-bounded-contexts.md)** - Deepen understanding of context boundaries
- **[Context Mapping](./ex-sode-dodrdedd__04-context-mapping.md)** - Formalize context relationships
- **[Subdomains](./ex-sode-dodrdedd__05-subdomains.md)** - Classify and prioritize subdomains
