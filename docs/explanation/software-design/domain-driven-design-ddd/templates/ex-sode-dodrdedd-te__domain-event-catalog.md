...
- [Domain Events](../ex-sode-dodrdedd__12-domain-events.md) - Domain event concepts and patterns
- [Aggregates](../ex-sode-dodrdedd__09-aggregates.md) - How aggregates raise events
- [Event Sourcing](../ex-sode-dodrdedd__12-domain-events.md) - Persisting aggregates as event streams
- [Aggregate Design Template](./ex-sode-dodrdedd-te__aggregate-design-template.md) - Document aggregates that raise events
