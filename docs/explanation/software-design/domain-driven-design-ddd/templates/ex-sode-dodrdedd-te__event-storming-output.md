...
- [Bounded Context Canvas](./ex-sode-dodrdedd-te__bounded-context-canvas.md) for Zakat Calculation Context
- [Aggregate Design Template](./ex-sode-dodrdedd-te__aggregate-design-template.md) for ZakatAssessment
- [Context Map Diagram](./ex-sode-dodrdedd-te__context-map-diagram.md) showing all 4 contexts
- [Ubiquitous Language Glossary](./ex-sode-dodrdedd-te__ubiquitous-language-glossary.md) for Zakat domain terms
...
- **[Bounded Context Canvas](./ex-sode-dodrdedd-te__bounded-context-canvas.md)**: Formalize each discovered bounded context
- **[Aggregate Design Template](./ex-sode-dodrdedd-te__aggregate-design-template.md)**: Detail aggregate structure and invariants
- **[Context Map Diagram](./ex-sode-dodrdedd-te__context-map-diagram.md)**: Visualize context relationships
- **[Domain Event Catalog](./ex-sode-dodrdedd-te__domain-event-catalog.md)**: Comprehensive event inventory
...
- **[Domain Events](../ex-sode-dodrdedd__12-domain-events.md)** - Event-driven architecture guide
