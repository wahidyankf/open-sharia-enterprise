...
See [Strategic Design Process](./ex-sode-dodrdedd__06-strategic-design-process.md) for detailed Event Storming guidance.
...
See [Glossary Template](./templates/ex-sode-dodrdedd-te__ubiquitous-language-glossary.md) for a complete template.
...
See [Bounded Contexts](./ex-sode-dodrdedd__03-bounded-contexts.md) for detailed guidance on context boundaries.

## Glossary Template Reference

Use the standardized template to document your Ubiquitous Language:

- [Glossary Template](./templates/ex-sode-dodrdedd-te__ubiquitous-language-glossary.md)
...
- **[Bounded Contexts](./ex-sode-dodrdedd__03-bounded-contexts.md)** - Define where your Ubiquitous Language applies
- **[Context Mapping](./ex-sode-dodrdedd__04-context-mapping.md)** - Integrate contexts with different languages
- **[Strategic Design Process](./ex-sode-dodrdedd__06-strategic-design-process.md)** - Run Event Storming to discover terminology
- **[Glossary Template](./templates/ex-sode-dodrdedd-te__ubiquitous-language-glossary.md)** - Document your language
