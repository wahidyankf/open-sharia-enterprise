...
- [Pure Functions Over Side Effects](./ex-pr-se__pure-functions.md) - Pure functions naturally use immutable data
- [Explicit Over Implicit](./ex-pr-se__explicit-over-implicit.md) - Immutability makes state changes explicit
- [Simplicity Over Complexity](../general/ex-pr-ge__simplicity-over-complexity.md) - Immutability simplifies reasoning
