...
- [Automation Over Manual](./ex-pr-se__automation-over-manual.md) - Automate environment setup
- [Explicit Over Implicit](./ex-pr-se__explicit-over-implicit.md) - Explicit version pinning
- [Simplicity Over Complexity](../general/ex-pr-ge__simplicity-over-complexity.md) - Simple, consistent environments
