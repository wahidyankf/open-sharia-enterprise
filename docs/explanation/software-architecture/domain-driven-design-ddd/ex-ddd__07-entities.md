...
**Note**: This diagram uses WCAG AA-compliant colors. See [Color Palette Template](./ex-ddd__19-templates/color-palette.md).
...
See [Domain Events](./ex-ddd__12-domain-events.md) for event publishing patterns.
...
**Note:** In FP, "anemic" entities (data structures) are acceptable because behavior lives in pure functions. See [DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md).
...
Entities typically exist within aggregates. See [Aggregates](./ex-ddd__09-aggregates.md) for full context.
...
- **[Value Objects](./ex-ddd__08-value-objects.md)** - Understand immutable, structurally-equal domain primitives
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Learn how entities are organized into consistency boundaries
- **[Repositories](./ex-ddd__10-repositories.md)** - Persistence abstraction for entities
- **[Domain Events](./ex-ddd__12-domain-events.md)** - Capture entity lifecycle events
...
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - FP-style entities
