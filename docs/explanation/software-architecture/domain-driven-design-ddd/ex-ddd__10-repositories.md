...
- **[Aggregates](./ex-ddd__09-aggregates.md)** - Understand what repositories persist
- **[Entities](./ex-ddd__07-entities.md)** - Objects repositories work with
- **[Domain Services](./ex-ddd__11-domain-services.md)** - Services using repositories
- **[Layered Architecture](./ex-ddd__15-layered-architecture.md)** - Where repositories fit
- **[DDD and Functional Programming](./ex-ddd__14-ddd-and-functional-programming.md)** - FP-style repositories
