...
- [Aggregates](../ex-ddd__09-aggregates.md) - Aggregate concepts and patterns
- [Entities](../ex-ddd__07-entities.md) - Entity design principles
- [Value Objects](../ex-ddd__08-value-objects.md) - Value object patterns
- [Domain Events](../ex-ddd__12-domain-events.md) - Event design and usage
- [Repositories](../ex-ddd__10-repositories.md) - Persisting aggregates
- [Factories](../ex-ddd__13-factories.md) - Creating aggregates
