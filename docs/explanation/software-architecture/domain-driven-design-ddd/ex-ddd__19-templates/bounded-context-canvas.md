...
- **[Context Map Diagram](./context-map-diagram.md)**: Visualize relationships between all bounded contexts
- **[Ubiquitous Language Glossary](./ubiquitous-language-glossary.md)**: Detailed term definitions
...
- **[Subdomains](../ex-ddd__05-subdomains.md)** - Strategic classification (Core, Supporting, Generic)
- **[Strategic Design Process](../ex-ddd__06-strategic-design-process.md)** - Event Storming workshops
