...
See [Strategic Design Process](./ex-ddd__06-strategic-design-process.md) for detailed Event Storming guidance.
...
See [Glossary Template](./ex-ddd__19-templates/ubiquitous-language-glossary.md) for a complete template.
...
See [Bounded Contexts](./ex-ddd__03-bounded-contexts.md) for detailed guidance on context boundaries.

## Glossary Template Reference

Use the standardized template to document your Ubiquitous Language:

- [Glossary Template](./ex-ddd__19-templates/ubiquitous-language-glossary.md)
...
- **[Bounded Contexts](./ex-ddd__03-bounded-contexts.md)** - Define where your Ubiquitous Language applies
- **[Context Mapping](./ex-ddd__04-context-mapping.md)** - Integrate contexts with different languages
- **[Strategic Design Process](./ex-ddd__06-strategic-design-process.md)** - Run Event Storming to discover terminology
- **[Glossary Template](./ex-ddd__19-templates/ubiquitous-language-glossary.md)** - Document your language
