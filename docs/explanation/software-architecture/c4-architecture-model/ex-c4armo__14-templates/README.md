...
1. **[Blank Context Diagram](./blank-context-diagram.md)** - System-level view showing external actors and systems
2. **[Blank Container Diagram](./blank-container-diagram.md)** - High-level technical building blocks (apps, databases, services)
3. **[Blank Component Diagram](./blank-component-diagram.md)** - Internal structure of containers (classes, modules, services)
4. **[Blank Dynamic Diagram](./blank-dynamic-diagram.md)** - Sequence diagram showing interactions over time
5. **[Blank Deployment Diagram](./blank-deployment-diagram.md)** - Infrastructure mapping (servers, containers, cloud resources)

### Reference Materials

1. **[Color Palette Reference](./color-palette.md)** - WCAG AA-compliant color palette with hex codes, contrast ratios, and usage guidelines
2. **[Starter Full Documentation](./starter-full-documentation.md)** - Complete C4 documentation set for new systems (Context + Container + Component)
...
1. **Start with Context + Container**:
   - Copy [Blank Context Diagram](./blank-context-diagram.md) to your project
   - Copy [Blank Container Diagram](./blank-container-diagram.md) to your project
...
2. **Add Component Diagrams as Needed**:
   ...
   - Copy [Blank Component Diagram](./blank-component-diagram.md)
   - Document one complex container at a time

3. **Add Supplementary Diagrams**:
   - **Dynamic**: For workflow documentation ([Blank Dynamic Diagram](./blank-dynamic-diagram.md))
   - **Deployment**: For production infrastructure ([Blank Deployment Diagram](./blank-deployment-diagram.md))

### For Comprehensive Documentation

Use [Starter Full Documentation](./starter-full-documentation.md) which includes:
...
**See**: [Color Palette Reference](./color-palette.md) for complete guidelines and verification checklist.
...
- **[Level 1: System Context](../ex-c4armo__01-level-1-system-context.md)** - Context diagram guide
- **[Level 2: Container](../ex-c4armo__02-level-2-container.md)** - Container diagram guide
