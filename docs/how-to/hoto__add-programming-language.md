...
- [ ] **Familiarity with conventions**:
  - [Programming Language Content Standard](../explanation/rules/conventions/tutorial/ex-ru-co-tu__programming-language-content.md)
  - [Hugo Content Convention - ayokoding](../explanation/rules/conventions/hugo/ex-ru-co-hu__ayokoding.md)
  - [Content Quality Principles](../explanation/rules/conventions/content/ex-ru-co-co__quality.md)
- [ ] **AI agents available**:
...
1. Navigate to ayokoding-web content directory:
   ...
   ```bash
   cd apps/ayokoding-web/content/en/learn/swe/prog-lang/
   ```
...
1. **Create `_index.md` (navigation hub)**:
   ...
   - [Overview](/en/learn/swe/prog-lang/[language]/overview)
   - [Tutorials](/en/learn/swe/prog-lang/[language]/tutorials)
     - [Overview](/en/learn/swe/prog-lang/[language]/tutorials/overview)
     - [Initial Setup](/en/learn/swe/prog-lang/[language]/tutorials/initial-setup)
     - [Quick Start](/en/learn/swe/prog-lang/[language]/tutorials/quick-start)
     - [Beginner](/en/learn/swe/prog-lang/[language]/tutorials/beginner)
     - [Intermediate](/en/learn/swe/prog-lang/[language]/tutorials/intermediate)
     - [Advanced](/en/learn/swe/prog-lang/[language]/tutorials/advanced)
   - [How-To Guides](/en/learn/swe/prog-lang/[language]/how-to)
     - [Overview](/en/learn/swe/prog-lang/[language]/how-to/overview)
     - [Cookbook](/en/learn/swe/prog-lang/[language]/how-to/cookbook)
     - [... add your 12-18 how-to guides here ...]
   - [Reference](/en/learn/swe/prog-lang/[language]/reference)
     - [Overview](/en/learn/swe/prog-lang/[language]/reference/overview)
   - [Explanation](/en/learn/swe/prog-lang/[language]/explanation)
     - [Overview](/en/learn/swe/prog-lang/[language]/explanation/overview)
...
**Solution:** Review [Hugo Content Convention - ayokoding](../explanation/rules/conventions/hugo/ex-ru-co-hu__ayokoding.md) and fix violations. Common issues:
...
- [Programming Language Content Standard](../explanation/rules/conventions/tutorial/ex-ru-co-tu__programming-language-content.md) - Complete standard definition
- [Hugo Content Convention - ayokoding](../explanation/rules/conventions/hugo/ex-ru-co-hu__ayokoding.md) - Hextra theme specifics
- [Content Quality Principles](../explanation/rules/conventions/content/ex-ru-co-co__quality.md) - Quality requirements
- [Tutorial Naming Convention](../explanation/rules/conventions/tutorial/ex-ru-co-tu__naming.md) - Tutorial level definitions
- [Factual Validation Convention](../explanation/rules/conventions/content/ex-ru-co-co__factual-validation.md) - Fact-checking methodology
- [Color Accessibility Convention](../explanation/rules/conventions/formatting/ex-ru-co-fo__color-accessibility.md) - Approved color palette
