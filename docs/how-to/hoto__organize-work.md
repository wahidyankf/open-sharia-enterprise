...
**Purpose:** Long-term, structured documentation using the [Diátaxis framework](../explanation/governance/conventions/meta/diataxis-framework.md)
...
1. **Create formal doc in docs/explanation/**
   ...
   - Follow [Diátaxis framework](../explanation/governance/conventions/meta/diataxis-framework.md)
...
2. Create appropriate docs following [Diátaxis framework](../explanation/governance/conventions/meta/diataxis-framework.md)
...
- [Diátaxis Framework](../explanation/governance/conventions/meta/diataxis-framework.md) - Understanding the four documentation types
- [File Naming Convention](../explanation/governance/conventions/meta/file-naming.md) - How to name files in `docs/`
- [Diagram and Schema Convention](../explanation/governance/conventions/formatting/diagrams.md) - When to use Mermaid vs ASCII art
