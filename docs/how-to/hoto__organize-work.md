...
**Purpose:** Long-term, structured documentation using the [Diátaxis framework](../explanation/rules/conventions/meta/diataxis-framework.md)
...
1. **Create formal doc in docs/explanation/**
   ...
   ```
   rules/conventions/formatting/new-convention.md
   ```

   - Write comprehensive explanation
   - Include examples and rationale
   - Follow [Diátaxis framework](../explanation/rules/conventions/meta/diataxis-framework.md)
...
2. Create appropriate docs following [Diátaxis framework](../explanation/rules/conventions/meta/diataxis-framework.md)
...
- [Diátaxis Framework](../explanation/rules/conventions/meta/diataxis-framework.md) - Understanding the four documentation types
- [File Naming Convention](../explanation/rules/conventions/meta/file-naming.md) - How to name files in `docs/`
- [Diagram and Schema Convention](../explanation/rules/conventions/formatting/diagrams.md) - When to use Mermaid vs ASCII art
