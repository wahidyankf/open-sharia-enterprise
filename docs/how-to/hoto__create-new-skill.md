...
- Familiarity with [AI Agents Convention](../explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md) (Skills field requirements)
- Understanding of [Repository Architecture](../explanation/ex-ru__repository-governance-architecture.md) (Skills as Layer 2 delivery infrastructure)
...
Ensure your Skill follows [Content Quality Principles](../explanation/rules/conventions/content/ex-ru-co-co__quality.md):
...
- reference.md has navigation footer: `[← Back to SKILL.md](./SKILL.md) | [→ See Examples](./examples.md)`
- examples.md has navigation footer: `[← Back to SKILL.md](./SKILL.md) | [← See Reference](./reference.md)`
...
3. **Check quality**: Apply [Content Quality Principles](../explanation/rules/conventions/content/ex-ru-co-co__quality.md)
...
- [AI Agents Convention](../explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md) - Skills field requirements
- [Repository Architecture](../explanation/ex-ru__repository-governance-architecture.md) - Skills as Layer 2 infrastructure
- [Content Quality Principles](../explanation/rules/conventions/content/ex-ru-co-co__quality.md) - Quality standards
