...
- Familiarity with [AI Agents Convention](../explanation/development/agents/ex-de-ag__ai-agents.md) (Skills field requirements)
- Understanding of [Repository Architecture](../explanation/ex__repository-governance-architecture.md) (Skills as Layer 2 delivery infrastructure)
...
Ensure your Skill follows [Content Quality Principles](../explanation/conventions/content/ex-co-co__quality.md):
...
3. **Check quality**: Apply [Content Quality Principles](../explanation/conventions/content/ex-co-co__quality.md)
...
- [AI Agents Convention](../explanation/development/agents/ex-de-ag__ai-agents.md) - Skills field requirements
- [Repository Architecture](../explanation/ex__repository-governance-architecture.md) - Skills as Layer 2 infrastructure
- [Content Quality Principles](../explanation/conventions/content/ex-co-co__quality.md) - Quality standards
