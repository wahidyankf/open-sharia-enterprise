...
**Get Java running in 15 minutes.** This tutorial provides the quickest path to running your first Java program. You'll install the Java Development Kit (JDK), verify it works, and run a simple "Hello World" application.

## What You'll Achieve

By the end of this tutorial (5-15 minutes), you'll have:
...
- **[Java Quick Start](./tu-se-pl-ja__quick-start.md)** (1-2 hours) - Learn enough Java to explore independently. Perfect if you want a quick overview of core syntax and concepts.

- **[Complete Beginner's Guide to Java](./tu-se-pl-ja__beginner.md)** (3-4 hours) - Comprehensive foundation covering Java fundamentals from zero. Choose this if you want in-depth coverage with practice exercises.
