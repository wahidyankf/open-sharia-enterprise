---
title: Complete Beginner's Guide to Java
...
- Completed [Initial Setup for Java](./tu-se-pl-ja__initial-setup.md) (Java installed and working)
- Completed [Java Quick Start](./tu-se-pl-ja__quick-start.md) (familiar with basic syntax)
...
**For Production Development** → Continue with [Intermediate Java](./tu-se-pl-ja__intermediate.md):
...
**For Quick Reference** → Use [Java Cookbook](./tu-se-pl-ja__cookbook.md) for:

- Common patterns and solutions
- Day-to-day recipes
- Code snippets you can copy

**For Expert Mastery** → Eventually [Advanced Java](./tu-se-pl-ja__advanced.md):
