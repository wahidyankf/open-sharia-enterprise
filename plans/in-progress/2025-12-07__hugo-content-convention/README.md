...
**REQ-017**: Update conventions index (docs/explanation/conventions/README.md)
...
2. **Convention Creation**
   - Create docs/explanation/conventions/ex-co\_\_hugo-content.md
...
4. **Index Updates**
   - Update docs/explanation/conventions/README.md
