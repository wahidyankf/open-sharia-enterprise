# Plan: demo-be-csas (In Progress)

C# / ASP.NET Core reimplementation of the demo backend REST API — a functional twin of
`apps/demo-be-jasb` (Java/Spring Boot), `apps/demo-be-exph` (Elixir/Phoenix),
`apps/demo-be-fsgi` (F#/Giraffe), `apps/demo-be-gogn` (Go/Gin), `apps/demo-be-pyfa`
(Python/FastAPI), `apps/demo-be-rsax` (Rust/Axum), and `apps/demo-be-ktkt` (Kotlin/Ktor)
...
- `apps/demo-be-csas/` — application source
- `infra/dev/demo-be-csas/` — Docker Compose dev infra
- `.github/workflows/e2e-demo-be-csas.yml` — E2E workflow
...
| File                            | Change                                                      |
| ------------------------------- | ----------------------------------------------------------- |
| `CLAUDE.md`                     | Add demo-be-csas to Current Apps list, add C# coverage info |
| `README.md`                     | Add demo-be-csas badge and description in demo apps section |
| `specs/apps/demo-be/README.md`  | Add C#/ASP.NET Core row to Implementations table            |
| `apps/demo-be-e2e/project.json` | Add `demo-be-csas` to `implicitDependencies`                |
