...
| `vitest`                                                | `^4.0.0`                                                              | All three apps pin `^4.0.0`.                                                                                                                                                                                                       |
...
| `@testing-library/jest-dom`                             | `^6.0.0`                                                              | Shared.                                                                                                                                                                                                                            |
| `@testing-library/react`                                | `^16.0.0`                                                             | Shared.                                                                                                                                                                                                                            |
| `@vitest/coverage-v8`                                   | `^4.0.0`                                                              | Shared.                                                                                                                                                                                                                            |
| `tailwindcss`                                           | `^4.0.0`                                                              | Shared.                                                                                                                                                                                                                            |
| `@tailwindcss/postcss`                                  | `^4.0.0`                                                              | Shared.                                                                                                                                                                                                                            |
| `@playwright/test` (E2E runner)                         | `^1.52.0`                                                             | Matches `organiclever-fe-e2e` (the E2E model sibling).                                                                                                                                                                             |
...
| [`prd.md`](./prd.md)             | Product Requirements Document — personas, user stories, functional requirements (R1-R12), Gherkin acceptance criteria, product scope, UX risks.                                                                                  |
| [`tech-docs.md`](./tech-docs.md) | File-by-file port map, dependency upgrade matrix (source → target versions with WebSearch-verified current-stable versions dated 2026-04-19), Nx target configuration, test strategy, CI/Vercel wiring, rollout risks, rollback. |
| [`delivery.md`](./delivery.md)   | Phase-by-phase checklist of one-action-per-checkbox steps. Every phase ends in an explicit "commit with message X" + "push origin main" pair so the plan-execution workflow produces one commit per phase as the user requested. |
...
worktree requirement. The plan-execution workflow should drive each phase's
commit + push on the worktree branch and surface the work as a draft PR
against `origin/main`; the `prod-wahidyankf-web` branch is created only
during P6, after all commits have merged to `main` via the worktree PR.
