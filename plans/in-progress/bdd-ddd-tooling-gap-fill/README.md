...
**Scope**: `ose-public` — `apps/rhino-cli/`, `apps/{organiclever,wahidyankf,oseplatform,ayokoding}-{web,be}/project.json`, `.husky/pre-push`
**Branch**: `worktree/bdd-ddd-tooling-gap-fill` (assigned at execution time)
...
- [delivery.md](./delivery.md) — TDD-shaped 10-phase checklist
