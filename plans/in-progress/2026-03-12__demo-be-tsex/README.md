# Plan: demo-be-tsex (In Progress)

TypeScript / Effect TS reimplementation of the demo backend REST API — a functional twin of
`apps/demo-be-jasb` (Java/Spring Boot), `apps/demo-be-pyfa` (Python/FastAPI),
`apps/demo-be-rsax` (Rust/Axum), and others, using Node.js, Vite, and Effect TS.
...
- `apps/demo-be-tsex/` — application source
- `infra/dev/demo-be-tsex/` — Docker Compose dev infra
- `.github/workflows/e2e-demo-be-tsex.yml` — E2E workflow
...
| File                            | Change                                                                     |
| ------------------------------- | -------------------------------------------------------------------------- |
| `CLAUDE.md`                     | Add demo-be-tsex to Current Apps list, add TypeScript/Effect coverage note |
| `README.md`                     | Add demo-be-tsex badge and description in demo apps section                |
| `specs/apps/demo-be/README.md`  | Add TypeScript/Effect row to Implementations table                         |
| `apps/demo-be-e2e/project.json` | Add `demo-be-tsex` to `implicitDependencies`                               |
| `.github/workflows/main-ci.yml` | Add coverage upload step for demo-be-tsex LCOV                             |
