...
| File                                                               | Change                                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `repo-governance/development/pattern/database-audit-trail.md`      | Generalize to language-agnostic pattern. Add "Migration Tool by Language" table. Keep Liquibase/JPA section as Java-specific guidance. Add sections for other languages.                                                                                                                                                            |
| `repo-governance/development/pattern/README.md`                    | Update the Database Audit Trail entry description to reflect multi-language scope                                                                                                                                                                                                                                                   |
| `repo-governance/development/README.md`                            | Update the Database Audit Trail entry in Pattern Documentation section to reflect multi-language scope                                                                                                                                                                                                                              |
...
- [Database Audit Trail Pattern](../../../repo-governance/development/pattern/database-audit-trail.md)
