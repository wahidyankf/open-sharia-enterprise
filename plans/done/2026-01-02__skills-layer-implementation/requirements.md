...
Use Mermaid diagrams with WCAG-compliant accessible colors. See [Diagram Convention](./docs/explanation/rules/conventions/formatting/ex-ru-co-fo__diagrams.md) for complete standards. Skill: `color-accessibility-diagrams` auto-loads when creating diagrams.
```
...
2. **AI Agents Convention** (`docs/explanation/rules/development/agents/ex-ru-de-ag__ai-agents.md`)
