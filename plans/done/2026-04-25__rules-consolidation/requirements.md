...
**Rationale**: This enables autonomous agent operation without user approval prompts. See [AI Agents Convention - Writing to .claude Folders](../../../repo-governance/development/agents/ai-agents.md#writing-to-claude-folders).
...
When I check repo-governance/conventions/tutorials/
