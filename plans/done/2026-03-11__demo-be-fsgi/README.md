...
- `apps/demo-be-fsgi/` — application source
- `infra/dev/demo-be-fsgi/` — Docker Compose dev infra
- `.github/workflows/e2e-demo-be-fsgi.yml` — E2E workflow
