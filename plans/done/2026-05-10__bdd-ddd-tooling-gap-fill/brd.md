...
- ~20 lines of governance update (`repo-governance/conventions/structure/specs-directory-structure.md`) clarifying allowlist policy and listing all gating surfaces (pre-push + PR gate + main-CI workflows).
