...
All implementation happens on the `main` branch using Trunk Based Development workflow with direct commits. No PRs or feature branches. See [Trunk Based Development Convention](../../rules/development/workflow/trunk-based-development.md) for complete details.
