...
All implementation happens on the `main` branch using Trunk Based Development workflow with direct commits. No PRs or feature branches. See [Trunk Based Development Convention](../../docs/explanation/development/ex-de__trunk-based-development.md) for complete details.
