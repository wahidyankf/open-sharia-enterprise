...
- **Observable fact (awareness)**: After Phase 1 completes, `grep -rnI 'ose-primer' ose-public/ --include='*.md'` returns non-empty matches in at least `README.md`, `CLAUDE.md`, `AGENTS.md`, `docs/reference/related-repositories.md`, `docs/reference/README.md`, `repo-governance/conventions/structure/ose-primer-sync.md`, `.claude/skills/repo-syncing-with-ose-primer/SKILL.md`, `.claude/agents/repo-ose-primer-adoption-maker.md`, and `.claude/agents/repo-ose-primer-propagation-maker.md`.
...
1. **Awareness layer present** — `grep -r 'ose-primer' ose-public/ --include='*.md' -l` returns non-empty matches in all of: `README.md`, `CLAUDE.md`, `AGENTS.md`, `docs/reference/related-repositories.md`, `docs/reference/README.md`, `repo-governance/conventions/structure/ose-primer-sync.md`, `.claude/skills/repo-syncing-with-ose-primer/SKILL.md`, `.claude/agents/repo-ose-primer-adoption-maker.md`, `.claude/agents/repo-ose-primer-propagation-maker.md`.
2. **Classifier present and parseable** — `repo-governance/conventions/structure/ose-primer-sync.md` contains a table whose rows are paths and whose columns include a "Direction" column with values exclusively from `{propagate, adopt, bidirectional, neither}`.
...
- Classifier in `repo-governance/conventions/structure/ose-primer-sync.md` explicitly lists every `apps/*` and `specs/apps/*` path and tags product apps + FSL specs as `neither`.
...
| Observable fact (primer parity) #6 — verdict `parity verified: ose-public may safely remove` | Actual verdict: `parity verified (content-equivalent after primer-side rename)`              | Strengthened report (`parity__phase7-strengthened__2026-04-18--22-10__report.md`, primer SHA `7c34e73f`, public SHA `ec89373b`) provides file-count evidence; `## Verdict line` section body now contains the exact expected string. Deviation resolved — gate no longer relies on operator judgment alone. |
...
- [Licensing Convention](../../../repo-governance/conventions/structure/licensing.md) — FSL vs MIT split governing classifier decisions.
