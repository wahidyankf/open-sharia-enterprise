...
- **Unit tests**: Vitest in organiclever-web and a-demo-fe-ts-nextjs; no a11y assertions
- **E2E tests**: Playwright in organiclever-web-e2e and a-demo-fe-e2e; no visual regression
...
Feature: Shared UI Library
  ...
  Scenario: Build and test pass after migration
    ...
    Then all targets pass for organiclever-web, ayokoding-web, and a-demo-fe-ts-nextjs
