...
- [2026-01-02: Skills Infrastructure Implementation](./2026-01-02__skills-layer-implementation/) - Introduce Claude Code Skills as delivery infrastructure (alongside CLAUDE.md) for progressive knowledge disclosure. Creates 8-12 model-invoked knowledge packages, maintains CLAUDE.md ≤30k characters, updates agents with optional Skills references, and provides community-shareable Shariah-compliance knowledge templates. Six-layer architecture unchanged.
