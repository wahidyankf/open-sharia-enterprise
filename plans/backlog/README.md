...
- [2026-01-02: Skills Infrastructure Implementation](./2026-01-02__skills-layer-implementation/) - Introduce Claude Code Skills as delivery infrastructure (alongside CLAUDE.md) for progressive knowledge disclosure. Creates 8-10 model-invoked knowledge packages, maintains CLAUDE.md ≤30k characters, and updates agents with optional Skills references. Six-layer architecture unchanged.
