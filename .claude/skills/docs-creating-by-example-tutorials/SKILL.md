...
**Primary Convention**: [By Example Tutorial Convention](../../../rules/conventions/tutorial/by-example.md)
...
- [Hugo ayokoding Convention](../../../rules/conventions/hugo/ayokoding.md) - Code annotation standards for ayokoding-web
