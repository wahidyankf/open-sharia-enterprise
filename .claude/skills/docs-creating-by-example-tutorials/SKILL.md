...
**Primary Convention**: [By Example Tutorial Convention](../../../rules/conventions/tutorial/ex-ru-co-tu__by-example.md)
...
- [Hugo ayokoding Convention](../../../rules/conventions/hugo/ex-ru-co-hu__ayokoding.md) - Code annotation standards for ayokoding-web
