...
6. **Update index** - Add to rules/conventions/README.md
...
7. **Update index** - Add to rules/development/README.md
...
6. **Create workflow file** - rules/workflows/
7. **Update index** - Add to rules/workflows/README.md
