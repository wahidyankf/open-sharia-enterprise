...
- `writing-gherkin-criteria` - Detailed Gherkin guidance
- `practicing-trunk-based-development` - Git workflow
- `applying-content-quality` - Universal content standards
