...
| Aspect | Description       |
| ------ | ----------------- |
| Key 1  | Brief explanation |
| Key 2  | Brief explanation |
...
Brief explanation. Link to [reference.md](./reference.md#concept-1-details) for detailed specifications.

### Concept 2

Brief explanation. See [examples.md](./examples.md#concept-2-example) for working examples.
...
- ❌ **Anti-pattern 1** - Why this is wrong. See [examples.md](./examples.md#anti-pattern-1-correction) for correct approach.
...
- [Convention Name](../../rules/conventions/path/to/convention.md) - Primary reference
- [Development Practice](../../rules/development/path/to/practice.md) - Secondary reference
