...
- **Character Escaping (CRITICAL)**: Escape special characters in Mermaid node text using HTML entities: `(` → `#40;`, `)` → `#41;`, `[` → `#91;`, `]` → `#93;`. Example: `A[O#40;1#41; lookup]` for "O(1) lookup". Prevents "syntax error in text"
