...
- `docs/explanation/development/infra/ex-de-in__temporary-files.md` - Report file naming and location standards (CRITICAL - defines `generated-reports/` usage, timestamp format, tool requirements)
