...
1. **Read audit reports** generated by ayokoding-web-structure-checker
...
- This agent CANNOT write overview content (subjective task requiring ayokoding-web-general-maker)
- This agent CANNOT regenerate navigation listings (use ayokoding-web-navigation-maker instead)
...
- **After running ayokoding-web-structure-checker** - You have a structural audit report to process
...
- Content quality validation (use ayokoding-web-general-checker)
- Writing overview content (use ayokoding-web-general-maker)
- Regenerating navigation listings (use ayokoding-web-navigation-maker)
- Initial structure detection (use ayokoding-web-structure-checker)
...
1. **Auto-detect latest audit report** in `generated-reports/`:
   ...
   ```bash
   ls -t generated-reports/ayokoding-web-structure__*__audit.md | head -1
   ```

2. **Allow manual override** if user specifies a report:

   ```
   User: "Use ayokoding-web-structure__a1b2c3__2025-12-20--14-30__audit.md"
...
- Input: `ayokoding-web-structure__a1b2c3__2025-12-20--14-30__audit.md`
- Output: `ayokoding-web-structure__a1b2c3__2025-12-20--14-30__fix.md`
...
- Overview content quality issues (requires content writing by ayokoding-web-general-maker)
- Navigation listing regeneration (requires ayokoding-web-navigation-maker)
...
**NOTE**: Navigation list regeneration is NOT handled by this agent. Use `ayokoding-web-navigation-maker` to regenerate navigation listings from file structure.
...
**Confidence**: MEDIUM for overview/ikhtisar (requires content writing - flag for ayokoding-web-general-maker)
...
REPORT=$(ls -t generated-reports/ayokoding-web-structure__*__audit.md 2>/dev/null | head -1)
...
````markdown
# ayokoding-web-structure-fixer Fix Report

**Source Audit:** {source-report-filename}
**Fix Date:** {timestamp} UTC+7
**Fixer Version:** ayokoding-web-structure-fixer v1.0
...
- **Action Required:** Use ayokoding-web-general-maker to write overview content
...
- **Action Required:** Use ayokoding-web-navigation-maker to regenerate navigation listings from file structure
...
- **Action Required:** Use ayokoding-web-general-maker to expand ikhtisar content

---

## Recommendations for ayokoding-web-structure-checker
...
1. **Review manual items:** Address 2 findings flagged as "needs manual review" (use ayokoding-web-general-maker for content writing, ayokoding-web-navigation-maker for navigation regeneration)
2. **Improve checker:** Apply recommendations to ayokoding-web-structure-checker
...
3. **Content creation boundary** - Cannot write overview content (flag for ayokoding-web-general-maker)
4. **Navigation regeneration boundary** - Cannot regenerate navigation listings (flag for ayokoding-web-navigation-maker)
...
- Write overview/ikhtisar content (use ayokoding-web-general-maker)
- Regenerate navigation listings (use ayokoding-web-navigation-maker)
...
3. **Manual review list** - Items needing ayokoding-web-general-maker (content), ayokoding-web-navigation-maker (navigation), or human judgment (structure)
4. **Recommendations** - How to improve ayokoding-web-structure-checker
...
- [ayokoding-web-structure-maker.md](./ayokoding-web-structure-maker.md) - Proactively modifies weights and structure (intentional changes, different workflow)
- [ayokoding-web-structure-checker.md](./ayokoding-web-structure-checker.md) - Generates structural audit reports that this agent processes
- [ayokoding-web-navigation-maker.md](./ayokoding-web-navigation-maker.md) - Regenerates navigation listings from file structure (complementary - handles what this agent cannot)
- [ayokoding-web-general-maker.md](./ayokoding-web-general-maker.md) - Creates overview content (different purpose)
- [ayokoding-web-general-fixer.md](./ayokoding-web-general-fixer.md) - Handles content quality fixes (complementary agent)
