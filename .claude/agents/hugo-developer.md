...
- Create markdown content in `content/` folder → Use `ayokoding-content-maker` or `ose-platform-web-content-maker`
...
| Task                                 | Delegate To                                                       |
| ------------------------------------ | ----------------------------------------------------------------- |
| Create blog posts, tutorials, essays | `ayokoding-content-maker`                                         |
| Create project updates               | `ose-platform-web-content-maker`                                  |
| Validate content quality             | `ayokoding-content-checker` or `ose-platform-web-content-checker` |
