...
- Internal links follow the [Linking Convention](../../docs/explanation/rules/conventions/formatting/ex-ru-co-fo__linking.md)
...
2. **Update `lastFullScan`** timestamp to current time (UTC+7 format)
   ...
   - See [Timestamp Format Convention](../../docs/explanation/rules/conventions/formatting/ex-ru-co-fo__timestamp.md)
...
- [AI Agents Convention](../../docs/explanation/rules/development/agents/ex-ru-de-ag-ai-agents.md) - Agent design standards
- [Linking Convention](../../docs/explanation/rules/conventions/formatting/ex-ru-co-fo__linking.md) - How links should be formatted
- [Timestamp Format Convention](../../docs/explanation/rules/conventions/formatting/ex-ru-co-fo__timestamp.md) - UTC+7 timestamp format
