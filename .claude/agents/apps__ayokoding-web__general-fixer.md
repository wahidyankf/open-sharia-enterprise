...
- Provide actionable feedback to improve ayokoding-web-general-checker accuracy
...
1. **Read audit reports** generated by ayokoding-web-general-checker
...
- **After running ayokoding-web-general-checker** - You have an audit report to process
...
- Initial validation (use ayokoding-web-general-checker for detection)
- Content creation (use ayokoding-web-general-maker for new content)
...
1. **Auto-detect latest audit report** in `generated-reports/`:
   ...
   ```bash
   ls -t generated-reports/ayokoding-web__*__audit.md | head -1
   ```

2. **Allow manual override** if user specifies a report:

   ```
   User: "Use ayokoding-web__a1b2c3__2025-12-14--20-45__audit.md"
...
- Input: `ayokoding-web__a1b2c3__2025-12-14--20-45__audit.md`
- Output: `ayokoding-web__a1b2c3__2025-12-14--20-45__fix.md`
...
This agent re-implements validation patterns from ayokoding-web-general-checker to verify findings.
...
The agent re-implements these validation checks from ayokoding-web-general-checker:
...
REPORT=$(ls -t generated-reports/ayokoding-web__*__audit.md 2>/dev/null | head -1)
...
````markdown
# ayokoding-web-general-fixer Fix Report

**Source Audit:** {source-report-filename}
**Fix Date:** {timestamp} UTC+7
**Fixer Version:** ayokoding-web-general-fixer v1.0
...
## Recommendations for ayokoding-web-general-checker
...
2. **Improve checker:** Apply recommendations to ayokoding-web-general-checker
...
4. **Recommendations** - How to improve ayokoding-web-general-checker
...
- [Hugo Content Convention - Shared](../../docs/explanation/conventions/hugo/ex-co-hu__shared.md) - Shared Hugo conventions
