...
| [Repository Cross-Vendor Parity Validation](./repo/repo-cross-vendor-parity-quality-gate.md)                              | Validate cross-vendor behavioral-parity invariants (governance/AGENTS/CLAUDE vendor-neutrality, sync no-op, count parity, color/tier-map coverage), iterate to double-zero | repo-parity-checker, repo-parity-fixer                                                                                                                                  | Medium     |
