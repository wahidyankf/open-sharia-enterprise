...
Use LaTeX notation for mathematical expressions. See [Mathematical Notation Convention](../../docs/explanation/rules/conventions/formatting/ex-ru-co-fo-mathematical-notation.md) for syntax rules and examples.
...
See [File Naming Convention](../../docs/explanation/rules/conventions/meta/ex-ru-co-me-file-naming.md) for complete details.
