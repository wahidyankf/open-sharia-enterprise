...
[`specs/apps/ose-platform/behavior/web/gherkin/`](../../behavior/web/gherkin/):
...
- **api perspective component diagram**: [component-api.md](../api/component-api.md)
- **web perspective gherkin specs**: [behavior/web/gherkin/](../../behavior/web/gherkin/)
