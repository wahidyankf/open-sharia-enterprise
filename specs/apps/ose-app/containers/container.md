# OSE Application — Container Diagram (C4 L2)
...
graph TD
    ...
    BE["ose-app-be<br/>F#/Giraffe on .NET 10<br/>port 8302"]:::app
...
| `ose-app-be`   | F#/Giraffe, .NET 10    | 8302 | REST API — document ingestion, gap analysis engine |
