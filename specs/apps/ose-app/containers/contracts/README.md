...
nx run ose-app-contracts:lint

# Bundle into single resolved YAML + JSON
nx run ose-app-contracts:bundle

# Generate browsable API documentation
nx run ose-app-contracts:docs
# Open specs/apps/ose-app/containers/contracts/generated/docs/index.html
```
...
2. Run `nx run ose-app-contracts:lint` to validate
3. Run `nx run ose-app-contracts:bundle` to regenerate the bundled spec
