# Ubiquitous Language — OSE Application

Platform-agnostic glossary of OSE Application bounded contexts.
...
3. Code identifiers match the F# type/module name verbatim.
