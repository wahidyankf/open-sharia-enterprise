...
Platform-agnostic specifications for `oseplatform-web` — the OSE Platform marketing and updates
...
└── cli/                   # oseplatform-cli specs (legacy layout, out of scope)
    └── gherkin/
        └── links-check.feature
```
...
| Field           | Meaning                                                                                                                   |
| --------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `name`          | Identifier — must match the folder name under `apps/oseplatform-web/src/contexts/`                                        |
...
### `rhino-cli ddd bc oseplatform` — structural parity
...
### `rhino-cli ddd ul oseplatform` — glossary parity
