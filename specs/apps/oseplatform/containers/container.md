...
`oseplatform-web` deploys as a **single container**, named `web`. The tRPC API runs **inside**
the same Next.js process — there is no separate `oseplatform-be` deployable. To honour C4 L2's
