...
Product-level specifications for `oseplatform-web` — what the application is for, who uses it,
and how the user experience is shaped. This is C4 Level 0: the product framing that sits above
system context. Read this first if you are new to oseplatform-web.
