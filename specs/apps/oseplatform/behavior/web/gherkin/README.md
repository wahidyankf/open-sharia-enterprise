...
UI-semantic Gherkin scenarios for `oseplatform-web`. Step style: `clicks`, `types`, `sees`,
`navigates`. Background: `Given the app is running`. Consumed by `apps/oseplatform-web-fe-e2e`
(Playwright).
