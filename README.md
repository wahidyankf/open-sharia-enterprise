...
For complete details on tools, hook workflow, and troubleshooting, see [Code Quality Convention](./rules/development/quality/code.md) and [Commit Message Convention](./rules/development/workflow/commit-messages.md). For ayokoding-web automation details, see [Pre-commit Automation](./apps/ayokoding-cli/README.md#pre-commit-automation).
...
For complete documentation framework details, see [Diátaxis Framework](./rules/conventions/meta/diataxis-framework.md) and [`docs/README.md`](./docs/README.md).
