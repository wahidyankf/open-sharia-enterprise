/**
 * Step definitions for the OSE GRC Web smoke feature.
 *
 * Covers: specs/apps/ose-grc/behavior/web/gherkin/smoke.feature
 */
...
Given("the ose-grc-web dev server is running", async () => {
