// Generated from: ../../specs/apps/oseplatform/behavior/api/gherkin/health/health.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/oseplatform/behavior/api/gherkin/health/health.feature'), { scope: 'test', box: true }],
