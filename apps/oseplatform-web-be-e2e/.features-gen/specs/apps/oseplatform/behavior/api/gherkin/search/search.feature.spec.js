// Generated from: ../../specs/apps/oseplatform/behavior/api/gherkin/search/search.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/oseplatform/behavior/api/gherkin/search/search.feature'), { scope: 'test', box: true }],
