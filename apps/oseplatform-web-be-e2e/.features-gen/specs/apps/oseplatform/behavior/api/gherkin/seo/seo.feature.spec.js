// Generated from: ../../specs/apps/oseplatform/behavior/api/gherkin/seo/seo.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/oseplatform/behavior/api/gherkin/seo/seo.feature'), { scope: 'test', box: true }],
