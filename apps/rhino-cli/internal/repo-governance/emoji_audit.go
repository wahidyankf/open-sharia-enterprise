...
// These hold vendored, generated, or build-output content that should not be
// linted for emoji. The set covers legacy archives, test artefacts, virtual
// environments, language-specific build caches, and standard output dirs.
var emojiSkipDirs = map[string]bool{
	...
	"archived": true,
	// Test artefact directories produced by Playwright and coverage tools.
	"test-results":      true,
	...
	"__pycache__":   true,
	".pytest_cache": true,
	// Dart/Flutter build artefacts.
	".dart_tool": true,
	// Generic build output and tool caches.
	"out":    true,
	".cache": true,
	// Storybook static build output.
	"storybook-static": true,
	// Playwright MCP tool cache (page snapshots generated by the MCP server).
	".playwright-mcp": true,
	// Legacy code snapshot directories inside done plans (e.g. plans/done/*/raw/).
	"raw": true,
}
