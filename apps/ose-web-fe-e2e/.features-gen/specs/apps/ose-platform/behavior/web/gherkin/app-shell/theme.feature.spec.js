// Generated from: ../../specs/apps/ose-platform/behavior/web/gherkin/app-shell/theme.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose-platform/behavior/web/gherkin/app-shell/theme.feature'), { scope: 'test', box: true }],
