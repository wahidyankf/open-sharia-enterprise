 ...
 *
 * Covers: specs/apps/organiclever/behavior/web/gherkin/routing/disabled-routes.feature
 *
...
const feature = await loadFeature(
  path.resolve(
    __dirname,
    "../../../../../../specs/apps/organiclever/behavior/web/gherkin/routing/disabled-routes.feature",
  ),
);
