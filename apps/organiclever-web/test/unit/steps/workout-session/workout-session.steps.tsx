 ...
 *
 * Covers: specs/apps/organiclever/behavior/web/gherkin/workout-session/workout-session.feature
 *
...
const feature = await loadFeature(
  path.resolve(
    __dirname,
    "../../../../../../specs/apps/organiclever/behavior/web/gherkin/workout-session/workout-session.feature",
  ),
);
