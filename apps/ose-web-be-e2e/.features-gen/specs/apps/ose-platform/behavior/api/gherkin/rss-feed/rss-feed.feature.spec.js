// Generated from: ../../specs/apps/ose-platform/behavior/api/gherkin/rss-feed/rss-feed.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose-platform/behavior/api/gherkin/rss-feed/rss-feed.feature'), { scope: 'test', box: true }],
