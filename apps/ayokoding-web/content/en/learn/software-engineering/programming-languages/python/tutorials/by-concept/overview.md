...
[Initial Setup for Python](/en/learn/software-engineering/programming-languages/python/tutorials/initial-setup)
...
[Python Quick Start](/en/learn/software-engineering/programming-languages/python/tutorials/quick-start)
...
[Complete Beginner's Guide to Python](/en/learn/software-engineering/programming-languages/python/tutorials/by-concept/beginner)
...
[Intermediate Python Programming](/en/learn/software-engineering/programming-languages/python/tutorials/by-concept/intermediate)
...
[Advanced Python Programming](/en/learn/software-engineering/programming-languages/python/tutorials/by-concept/advanced)
...
| -------------------------------- | ---------------------------------------------------------- |
| Never programmed before          | Initial Setup → Quick Start → Beginner                     |
| Programmer, new to Python        | Quick Start → Beginner → Intermediate                      |
| Experienced with Java/C++        | Quick Start → Beginner (focus on EAFP/duck typing)         |
| Experienced with JavaScript/Ruby | Beginner (similar dynamism, different idioms)              |
| Data scientist learning Python   | Quick Start → Beginner → Intermediate (focus on libraries) |
| Building web applications        | Through Intermediate (FastAPI/Django patterns)             |
| Want production Python skills    | Intermediate → Advanced                                    |
| Building automation/scripts      | Through Beginner (standard library mastery)                |
| Building data pipelines          | Through Intermediate (async/concurrency)                   |
| Performance-critical systems     | Through Advanced (GIL understanding, C extensions)         |
...
- [Python Cookbook](/en/learn/software-engineering/programming-languages/python/how-to/cookbook) - Practical recipes for common tasks
- [How-To Guides](/en/learn/software-engineering/programming-languages/python/how-to) - Problem-solving guides for specific challenges
- [Reference](/en/learn/software-engineering/programming-languages/python/reference) - Cheat sheet, glossary, and learning resources
- [Best Practices](/en/learn/software-engineering/programming-languages/python/explanation/best-practices) - Idiomatic Python patterns
