...
**Related Tutorial**: See [Advanced Tutorial - Modern Java Features](/en/learn/software-engineering/programming-languages/python/tutorials/advanced#modern-java) for pattern matching and [Intermediate Tutorial - Control Flow](/en/learn/software-engineering/programming-languages/python/tutorials/intermediate#control-flow) for switch expressions.

**Related How-To**: See [Use Records Effectively](/en/learn/software-engineering/programming-languages/java/how-to/use-records-effectively) for record patterns and [Use Sealed Classes](/en/learn/software-engineering/programming-languages/java/how-to/use-sealed-classes) for exhaustive pattern matching with sealed types.
...
**Related Explanation**: See [Best Practices - Modern Java](/en/learn/software-engineering/programming-languages/python/explanation/best-practices#modern-java) for modern Java feature usage.
