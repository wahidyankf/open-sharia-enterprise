...
**Related Tutorial**: See [Advanced Tutorial - Modern Java Features](/en/learn/software-engineering/programming-languages/python/tutorials/advanced#modern-java) for records and pattern matching and [Intermediate Tutorial - Immutability](/en/learn/software-engineering/programming-languages/python/tutorials/intermediate#immutability) for immutable design patterns.

**Related How-To**: See [Use Sealed Classes](/en/learn/software-engineering/programming-languages/java/how-to/use-sealed-classes) for sealed hierarchies with records and [Pattern Matching](/en/learn/software-engineering/programming-languages/java/how-to/pattern-matching) for advanced pattern matching.
...
**Related Explanation**: See [Best Practices - Immutability](/en/learn/software-engineering/programming-languages/python/explanation/best-practices#immutability) for immutability principles.
