...
**Note**: You'll learn these concepts in detail in the [Quick Start](/en/learn/software-engineering/programming-languages/kotlin/tutorials/quick-start) and [Beginner Guide](/en/learn/software-engineering/programming-languages/kotlin/tutorials/beginner) tutorials. For advanced function patterns, see [Intermediate Kotlin](/en/learn/software-engineering/programming-languages/kotlin/tutorials/intermediate).
...
You'll learn more about Gradle as you progress through the tutorials. For build configuration best practices, see [Kotlin Best Practices](/en/learn/software-engineering/programming-languages/kotlin/explanation/best-practices). For common Gradle tasks, check the [Kotlin Cookbook](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook).
...
- **[Kotlin Quick Start](/en/learn/software-engineering/programming-languages/kotlin/tutorials/quick-start)** - Learn 12 core Kotlin concepts to explore independently. Perfect if you want a fast overview of Kotlin syntax and features.

- **[Complete Beginner's Guide to Kotlin](/en/learn/software-engineering/programming-languages/kotlin/tutorials/beginner)** - Comprehensive foundation covering Kotlin fundamentals from zero. Choose this if you want in-depth coverage with practice exercises.
...
- **Internal Resources**:
  - [Kotlin Cheat Sheet](/en/learn/software-engineering/programming-languages/kotlin/reference/cheat-sheet) - Quick reference for Kotlin syntax
  - [Kotlin Glossary](/en/learn/software-engineering/programming-languages/kotlin/reference/glossary) - Technical terms explained
  - [Kotlin Learning Resources](/en/learn/software-engineering/programming-languages/kotlin/reference/learning-resources) - External learning materials
  - [Kotlin Anti-Patterns](/en/learn/software-engineering/programming-languages/kotlin/explanation/anti-patterns) - Common mistakes to avoid
