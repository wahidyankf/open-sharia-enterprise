...
- [Beginner Tutorial - Java Interop](/en/learn/software-engineering/programming-languages/kotlin/tutorials/beginner#java-interoperability) - Interoperability basics
- [Handle Java Interoperability](/en/learn/software-engineering/programming-languages/kotlin/how-to/integrate-with-java) - Calling Java from Kotlin
- [Extension Functions](/en/learn/software-engineering/programming-languages/kotlin/tutorials/intermediate#extension-functions) - Extending Java classes
- [Coroutines Guide](/en/learn/software-engineering/programming-languages/kotlin/tutorials/intermediate#coroutines) - Async migration patterns

**Cookbook recipes**:

- [Java Interop Patterns](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook#java-interop) - Quick reference
- [Null Safety Patterns](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook#nullable-optional) - Handling nulls
- [Collection Operations](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook#collections) - Modern collection APIs
