...
- [Scope Functions](/en/learn/software-engineering/programming-languages/kotlin/how-to/scope-functions) - Built-in extensions (let, run, apply, also, with)
- [Data Classes](/en/learn/software-engineering/programming-languages/kotlin/how-to/use-data-classes-effectively) - Classes often extended with utilities
- [Beginner Tutorial - Extensions](/en/learn/software-engineering/programming-languages/kotlin/tutorials/beginner#extension-functions) - Extension fundamentals
- [Advanced Tutorial - DSLs](/en/learn/software-engineering/programming-languages/kotlin/tutorials/advanced#dsl-building-and-metaprogramming) - Extensions in domain-specific languages

**Cookbook recipes**:

- [Type-Safe Builders](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook#type-safe-builders) - DSL with extensions
- [String Manipulation](/en/learn/software-engineering/programming-languages/kotlin/how-to/cookbook#string-manipulation) - Common string extensions
