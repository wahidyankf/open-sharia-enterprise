...
You'll learn more about modules in the [Quick Start tutorial](/en/learn/software-engineering/programming-languages/golang/tutorials/quick-start) and [Manage Go modules effectively](/en/learn/software-engineering/programming-languages/golang/how-to/manage-go-modules).
...
**Quick learner**: [Golang Quick Start](/en/learn/software-engineering/programming-languages/golang/tutorials/quick-start)

- Learn core syntax and basic patterns
- Understand enough to explore Go independently

**Comprehensive learner**: [Complete Beginner's Guide to Go](/en/learn/software-engineering/programming-languages/golang/tutorials/beginner)

- Comprehensive coverage of Go fundamentals
- Hands-on exercises and practice
- Ready to build real applications

**Problem solver**: [Golang Cookbook](/en/learn/software-engineering/programming-languages/golang/how-to/cookbook)
...
**Solution**: You don't need a module for simple programs. Just run `go run hello.go` without initializing a module. Modules are covered in [Quick Start tutorial](/en/learn/software-engineering/programming-languages/golang/tutorials/quick-start).
