...
**Related Tutorial**: See [Intermediate Tutorial - Design Patterns](/en/learn/software-engineering/programming-languages/golang/tutorials/intermediate#design-patterns) and [Advanced Tutorial - Architecture](/en/learn/software-engineering/programming-languages/golang/tutorials/advanced#architecture).

**Related How-To**: See [Write Testable Code](/en/learn/software-engineering/programming-languages/golang/how-to/write-testable-code) and [Use Interfaces Effectively](/en/learn/software-engineering/programming-languages/golang/how-to/use-interfaces-effectively).
