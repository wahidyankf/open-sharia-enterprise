...
- Elixir installed and working (complete [Initial Setup](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) first)
- Text editor ready
- Terminal access
...
- [Initial Setup](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) - Install and configure Elixir

**Next Steps:**

- [Beginner Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner) - Deep dive into language features
- [Intermediate Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate) - OTP and concurrency
- [Advanced Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced) - Expert topics

**How-To Guides:**

- [Elixir Cookbook](/en/learn/software-engineering/programming-languages/elixir/how-to/cookbook) - Practical recipes
- [How to Use Pattern Matching Effectively](/en/learn/software-engineering/programming-languages/elixir/how-to/use-pattern-matching-effectively) - Pattern matching guide
- [How to Work with Lists](/en/learn/software-engineering/programming-languages/elixir/how-to/work-with-lists) - List operations
- [How to Use Pipe Operator](/en/learn/software-engineering/programming-languages/elixir/how-to/use-pipe-operator) - Pipeline patterns
- [How to Handle Errors](/en/learn/software-engineering/programming-languages/elixir/how-to/handle-errors) - Error handling

**Explanations:**

- [Best Practices](/en/learn/software-engineering/programming-languages/elixir/explanation/best-practices) - Elixir standards
- [Anti-Patterns](/en/learn/software-engineering/programming-languages/elixir/explanation/anti-patterns) - Mistakes to avoid

**Reference:**

- [Elixir Cheat Sheet](/en/learn/software-engineering/programming-languages/elixir/reference/cheat-sheet) - Syntax reference
...
1. **[Beginner Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner)** - Master all language features (0-60% coverage)
...
2. **[Cookbook](/en/learn/software-engineering/programming-languages/elixir/how-to/cookbook)** - Quick recipes for common problems
