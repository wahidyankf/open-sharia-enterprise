...
1. **[Intermediate Tutorial](/en/learn/software-engineering/programming-languages/elixir/by-concept/intermediate)** - OTP deep dive (60-85%)
   - GenServer patterns
   - Supervision trees
   - Phoenix framework
   - Ecto database patterns

2. **Build Projects** - Apply your knowledge to real applications
