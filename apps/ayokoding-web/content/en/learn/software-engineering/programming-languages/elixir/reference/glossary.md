...
**See also**: [Intermediate Tutorial - Task and Agent](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-4-task-and-agent-for-concurrent-tasks)
...
**See also**: [Quick Start - Functions and Modules](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start#section-3-functions-and-modules)
...
**See also**: [Beginner Tutorial - Protocols and Behaviours](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-11-protocols-and-behaviours)
...
**See also**: [Beginner Tutorial - Comprehensions](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-14-comprehensions-advanced)
...
**See also**: [Beginner Tutorial - Pattern Matching](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-1-pattern-matching-advanced)
...
**See also**: [Beginner Tutorial - Data Structures](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-2-data-structures-complete)
...
**See also**: [Advanced Tutorial - Metaprogramming and Macros](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced#section-4-metaprogramming-and-macros)
...
**See also**: [Quick Start - Pattern Matching](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start#section-1-pattern-matching)
...
**See also**: [Quick Start - Pipe Operator](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start#section-4-pipe-operator)
...
**See also**: [Beginner Tutorial - Processes and OTP Basics](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-9-processes-and-otp-basics)
...
**See also**: [Quick Start - Lists and Recursion](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start#section-5-lists-and-recursion)
...
**See also**: [Beginner Tutorial - Enum and Stream](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-5-enum-and-stream-for-collections)
...
**See also**: [Intermediate Tutorial - Application Structure](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-3-application-structure)
...
**See also**: [Intermediate Tutorial - GenServer](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-1-genserver-for-state-management)
...
**See also**: [Intermediate Tutorial - Supervisor](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-2-supervisor-for-fault-tolerance)
...
**See also**: [Intermediate Tutorial - Phoenix Framework](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-5-phoenix-framework-introduction)
...
**See also**: [Intermediate Tutorial - Ecto for Databases](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-7-ecto-for-databases)
...
**See also**: [Intermediate Tutorial - LiveView](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate#section-6-liveview-for-real-time-interfaces)
...
**See also**: [Advanced Tutorial - BEAM VM Internals](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced#section-2-beam-vm-internals)
...
**See also**: [Advanced Tutorial - Distributed Elixir](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced#section-3-distributed-elixir)
...
**See also**: [Advanced Tutorial - Type System](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced#section-1-type-system-elixir-119)
...
**See also**: [Beginner Tutorial - Testing with ExUnit](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner#section-8-testing-with-exunit)
...
**See also**: [Initial Setup - IEx Basics](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup#section-4-interactive-elixir-iex)
...
**See also**: [Quick Start - Mix Project Basics](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start#section-10-mix-project-basics)
...
**See also**: [Advanced Tutorial - Production Deployment](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced#section-7-production-deployment)

---

Ready to dive deeper? Explore [Tutorials](/en/learn/software-engineering/programming-languages/elixir/tutorials/) for comprehensive learning or browse [How-To Guides](/en/learn/software-engineering/programming-languages/elixir/how-to/) for practical solutions.
