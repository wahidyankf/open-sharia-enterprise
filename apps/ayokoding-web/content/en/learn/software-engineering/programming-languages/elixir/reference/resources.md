...
1. Complete [Initial Setup Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup)
2. Work through [Quick Start](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start)
3. Read "Programming Elixir" or "Elixir in Action"
4. Complete [Beginner Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner)
5. Study [Intermediate Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate) (Phoenix sections)
6. Read "Programming Phoenix"
7. Build a complete Phoenix application
8. Explore [LiveView](/en/learn/software-engineering/programming-languages/elixir/how-to/liveview) and [Ecto](/en/learn/software-engineering/programming-languages/elixir/how-to/ecto) guides

### Path 2: Backend Systems (OTP Focus)

1. Complete [Initial Setup](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) and [Quick Start](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start)
2. Read "The Little Elixir & OTP Guidebook"
3. Complete [Beginner Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/beginner) (OTP sections)
4. Study [Intermediate Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/intermediate) (GenServer, Supervisor)
5. Read "Designing Elixir Systems with OTP"
6. Build a distributed concurrent system
7. Study [Advanced Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced) (BEAM internals, distribution)

### Path 3: Complete Mastery

1. Follow Web Developer or Backend Systems path
2. Complete [Advanced Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/advanced)
...
Ready to start learning? Begin with our [Initial Setup Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) or dive into [Quick Start](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start)!
