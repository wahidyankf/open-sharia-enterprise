...
- Completed [Initial Setup](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) and [Quick Start](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start)
...
- [Initial Setup](/en/learn/software-engineering/programming-languages/elixir/tutorials/initial-setup) - Installation guide
- [Quick Start](/en/learn/software-engineering/programming-languages/elixir/tutorials/quick-start) - Core concepts overview
...
- [Elixir Cookbook](/en/learn/software-engineering/programming-languages/elixir/how-to/cookbook) - Practical solutions
- [How to Write Tests in Elixir](/en/learn/software-engineering/programming-languages/elixir/how-to/write-tests-elixir) - Testing guide
- [How to Use Protocols](/en/learn/software-engineering/programming-languages/elixir/how-to/use-protocols) - Protocol patterns
- [How to Handle Errors](/en/learn/software-engineering/programming-languages/elixir/how-to/handle-errors) - Error strategies
- [How to Work with Structs](/en/learn/software-engineering/programming-languages/elixir/how-to/work-with-structs) - Struct usage

**Explanations:**

- [Best Practices](/en/learn/software-engineering/programming-languages/elixir/explanation/best-practices) - Coding standards
- [Anti-Patterns](/en/learn/software-engineering/programming-languages/elixir/explanation/anti-patterns) - Common pitfalls

**Reference:**

- [Elixir Cheat Sheet](/en/learn/software-engineering/programming-languages/elixir/reference/cheat-sheet) - Quick reference
- [Elixir Glossary](/en/learn/software-engineering/programming-languages/elixir/reference/glossary) - Terminology
...
1. **[Intermediate Tutorial](/en/learn/software-engineering/programming-languages/elixir/tutorials/by-concept/intermediate)** - OTP deep dive (60-85%)
   - GenServer patterns
   - Supervision trees
   - Phoenix framework
   - Ecto database patterns

2. **[Cookbook](/en/learn/software-engineering/programming-languages/elixir/how-to/cookbook)** - Solutions to common problems
