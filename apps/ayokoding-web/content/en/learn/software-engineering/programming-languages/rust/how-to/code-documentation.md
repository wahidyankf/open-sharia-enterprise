...
**Related Patterns**: See [Write Effective Tests](/en/learn/software-engineering/programming-languages/rust/how-to/write-effective-tests) for documentation testing strategies, [Error Handling Strategies](/en/learn/software-engineering/programming-languages/rust/how-to/error-handling-strategies) for documenting error conditions, [Testing Patterns](/en/learn/software-engineering/programming-languages/rust/how-to/testing-patterns) for integration with regular tests.

**Tutorial**: See [Beginner Tutorial](/en/learn/software-engineering/programming-languages/rust/tutorials/beginner) for documentation basics.

**Cookbook**: See [Cookbook](/en/learn/software-engineering/programming-languages/rust/how-to/cookbook) for documentation examples throughout recipes.
