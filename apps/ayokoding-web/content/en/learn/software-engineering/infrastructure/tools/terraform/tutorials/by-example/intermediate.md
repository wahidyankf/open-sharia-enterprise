...
Proceed to [Advanced](/en/learn/software-engineering/infrastructure/tools/terraform/tutorials/by-example/advanced) for custom providers, testing frameworks, security patterns, multi-environment architecture, and CI/CD integration (Examples 57-84).
