...
Set up test cloud account credentials, then proceed to [Beginner](/en/learn/software-engineering/infrastructure/tools/terraform/tutorials/by-example/beginner) examples.
