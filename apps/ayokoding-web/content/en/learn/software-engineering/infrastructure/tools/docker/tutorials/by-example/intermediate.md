...
**Next steps**: Continue to [Advanced](/en/learn/software-engineering/infrastructure/tools/docker/tutorials/by-example/advanced) for Docker Swarm orchestration, security hardening, CI/CD integration, registry operations, and production deployment patterns (75-95% coverage).
