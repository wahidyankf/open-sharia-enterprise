...
- Phoenix installed (see [Initial Setup](/en/learn/software-engineering/web-platform/elixir-phoenix/tutorials/initial-setup))
...
2. **Explore By Example**: [Elixir Phoenix By Example](/en/learn/software-engineering/web-platform/elixir-phoenix/tutorials/by-example)
