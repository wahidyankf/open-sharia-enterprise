...
draft: false
description: Introduction to Java Spring Boot web framework tutorials covering hands-on learning through annotated examples
---
...
The [By Example tutorial](/en/learn/software-engineering/web-platform/java-spring-boot/tutorials/by-example) provides comprehensive coverage of Spring Boot framework fundamentals through 75-90 annotated examples. This approach suits experienced developers who prefer learning through code exploration.
...
Start with the [By Example tutorial](/en/learn/software-engineering/web-platform/java-spring-boot/tutorials/by-example) to learn Spring Boot web development through annotated, practical examples. Work through the examples at your own pace, experimenting with code and adapting patterns to your applications.
