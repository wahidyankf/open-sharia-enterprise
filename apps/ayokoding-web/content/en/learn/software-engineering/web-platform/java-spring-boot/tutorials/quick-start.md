...
- Spring Boot installed (see [Initial Setup](/en/learn/software-engineering/web-platform/java-spring-boot/tutorials/initial-setup))
...
2. **Explore By Example**: [Java Spring Boot By Example](/en/learn/software-engineering/web-platform/java-spring-boot/tutorials/by-example)
