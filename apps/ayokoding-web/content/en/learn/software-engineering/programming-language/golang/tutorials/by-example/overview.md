...
- Go installed and verified (follow the [initial-setup](/en/learn/software-engineering/programming-language/golang/tutorials/initial-setup) tutorial if needed)
