...
**Next**: Continue to [Intermediate](/en/learn/software-engineering/programming-language/python/tutorials/by-example/intermediate) (Examples 28-54) for production patterns, decorators, testing, and advanced language features.
