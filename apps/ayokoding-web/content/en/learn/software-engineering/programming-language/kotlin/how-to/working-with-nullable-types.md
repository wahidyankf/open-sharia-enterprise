...
- [Smart Casts](/en/learn/software-engineering/programming-language/kotlin/how-to/using-smart-casts) - Automatic type casting after checks
- [Elvis and Safe Call](/en/learn/software-engineering/programming-language/kotlin/how-to/avoid-null-pointer-errors) - Advanced null handling patterns
- [Beginner Tutorial - Type System](/en/learn/software-engineering/programming-language/kotlin/tutorials/beginner#type-system-and-variables) - Fundamentals of Kotlin's type system
- [Quick Start - Null Safety](/en/learn/software-engineering/programming-language/kotlin/tutorials/quick-start#null-safety) - Introduction to null safety
...
- [Result Type for Errors](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#result-type) - Functional error handling
