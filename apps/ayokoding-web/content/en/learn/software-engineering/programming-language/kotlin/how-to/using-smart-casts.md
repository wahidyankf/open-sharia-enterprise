...
- [Working with Nullable Types](/en/learn/software-engineering/programming-language/kotlin/how-to/working-with-nullable-types) - Foundation for null-safe smart casts
- [Sealed Classes](/en/learn/software-engineering/programming-language/kotlin/how-to/sealed-classes-interfaces) - Exhaustive when with smart casts
- [Beginner Tutorial - Smart Casts](/en/learn/software-engineering/programming-language/kotlin/tutorials/beginner#smart-casts) - Smart cast fundamentals
- [Advanced Tutorial - Compiler Internals](/en/learn/software-engineering/programming-language/kotlin/tutorials/advanced#compiler-internals) - How smart casts work under the hood

**Cookbook recipes**:

- [Type-Safe Builders](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#type-safe-builders) - Smart casts with DSLs
- [Sealed Data Structures](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#sealed-data-structures) - Pattern matching with smart casts
