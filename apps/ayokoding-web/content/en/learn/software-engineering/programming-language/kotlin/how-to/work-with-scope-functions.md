...
- [Nullable Types](/en/learn/software-engineering/programming-language/kotlin/how-to/working-with-nullable-types) - let with null safety
- [Extension Functions](/en/learn/software-engineering/programming-language/kotlin/how-to/extension-functions) - Custom scope-like functions
- [Beginner Tutorial - Scope Functions](/en/learn/software-engineering/programming-language/kotlin/tutorials/beginner#scope-functions) - Scope function fundamentals
- [Best Practices - Scope Functions](/en/learn/software-engineering/programming-language/kotlin/explanation/best-practices#scope-functions) - Idiomatic usage guidelines

**Cookbook recipes**:

- [Builder Pattern with apply](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#builder-apply) - Configuration patterns
- [Type-Safe Builders](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#type-safe-builders) - DSL with scope functions
