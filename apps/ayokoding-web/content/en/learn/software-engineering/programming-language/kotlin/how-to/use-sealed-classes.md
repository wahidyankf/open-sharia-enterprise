...
- [Data Classes](/en/learn/software-engineering/programming-language/kotlin/how-to/use-data-classes-effectively) - Often used as sealed class members
- [Smart Casts](/en/learn/software-engineering/programming-language/kotlin/how-to/using-smart-casts) - Automatic casting in when expressions
- [Beginner Tutorial - Sealed Classes](/en/learn/software-engineering/programming-language/kotlin/tutorials/beginner#sealed-classes) - Sealed class fundamentals
- [Intermediate Tutorial - Design Patterns](/en/learn/software-engineering/programming-language/kotlin/tutorials/intermediate#design-patterns) - State pattern with sealed classes

**Cookbook recipes**:

- [Sealed Data Structures](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#sealed-data-structures) - Custom data structures with sealed classes
- [Observer Pattern with Flow](/en/learn/software-engineering/programming-language/kotlin/how-to/cookbook#observer-flow) - Sealed classes for events
