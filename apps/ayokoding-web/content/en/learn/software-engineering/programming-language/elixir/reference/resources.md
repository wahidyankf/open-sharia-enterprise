---
title: Elixir Learning Resources
date: 2025-12-21T00:00:00+07:00
draft: false
weight: 1000003
description: Curated Elixir learning resources - official documentation, books, online courses, community forums, conferences, and tools
tags: ["elixir", "reference", "resources", "learning", "community"]
---
...
- URL: [https://elixir-lang.org/](https://elixir-lang.org/)
...
- URL: [https://hexdocs.pm/elixir/](https://hexdocs.pm/elixir/)
...
- URL: [https://elixirschool.com/](https://elixirschool.com/)
...
- URL: [https://elixir-lang.org/getting-started/introduction.html](https://elixir-lang.org/getting-started/introduction.html)
...
- URL: [https://hexdocs.pm/phoenix/](https://hexdocs.pm/phoenix/)
...
- URL: [https://hexdocs.pm/phoenix_live_view/](https://hexdocs.pm/phoenix_live_view/)
...
- URL: [https://hexdocs.pm/ecto/](https://hexdocs.pm/ecto/)
...
- URL: [https://hexdocs.pm/mix/](https://hexdocs.pm/mix/)
...
- URL: [https://hexdocs.pm/ex_unit/](https://hexdocs.pm/ex_unit/)
...
- URL: [https://exercism.org/tracks/elixir](https://exercism.org/tracks/elixir)
...
- URL: [https://elixircasts.io/](https://elixircasts.io/)
...
- URL: [https://pragmaticstudio.com/elixir](https://pragmaticstudio.com/elixir)
...
- URL: [https://www.learnphoenix.tv/](https://www.learnphoenix.tv/)
- Content: Phoenix framework video tutorials
- Best for: Phoenix-specific in-depth learning

**Alchemist Camp**

- URL: [https://alchemist.camp/](https://alchemist.camp/)
...
- URL: [https://elixirforum.com/](https://elixirforum.com/)
...
- URL: [https://stackoverflow.com/questions/tagged/elixir](https://stackoverflow.com/questions/tagged/elixir)
- Activity: Active
- Best for: Specific technical questions with code examples

**Reddit /r/elixir**

- URL: [https://www.reddit.com/r/elixir/](https://www.reddit.com/r/elixir/)
...
- URL: [https://elixirweekly.net/](https://elixirweekly.net/)
- Frequency: Weekly
...
- URL: [https://elixirdigest.net/](https://elixirdigest.net/)
- Frequency: Bi-weekly
...
- URL: [https://elixirconf.com/](https://elixirconf.com/)
...
- URL: [https://www.elixirconf.eu/](https://www.elixirconf.eu/)
...
- URL: [https://codesync.global/conferences/](https://codesync.global/conferences/)
...
- Platform: [Meetup.com](https://www.meetup.com/topics/elixir/)
...
- URL: [ElixirConf talks](https://www.youtube.com/@ElixirConf)
...
- URL: [https://marketplace.visualstudio.com/items?itemName=JakeBecker.elixir-ls](https://marketplace.visualstudio.com/items?itemName=JakeBecker.elixir-ls)
...
- URL: [https://github.com/rrrene/credo](https://github.com/rrrene/credo)
- Purpose: Static code analysis and linter
- Usage: `mix credo` or `mix credo --strict`

**Dialyzer (via Dialyxir)**

- URL: [https://github.com/jeremyjh/dialyxir](https://github.com/jeremyjh/dialyxir)
- Purpose: Type checking and discrepancy analysis
- Usage: `mix dialyzer`

**ExCoveralls**

- URL: [https://github.com/parroty/excoveralls](https://github.com/parroty/excoveralls)
- Purpose: Test coverage reporting
- Usage: `mix coveralls`

**Sobelow**

- URL: [https://github.com/nccgroup/sobelow](https://github.com/nccgroup/sobelow)
...
- URL: [https://github.com/bencheeorg/benchee](https://github.com/bencheeorg/benchee)
...
- URL: [https://github.com/ferd/recon](https://github.com/ferd/recon)
...
- URL: [https://github.com/rrrene/inch_ex](https://github.com/rrrene/inch_ex)
...
- URL: [https://hexdocs.pm/absinthe/](https://hexdocs.pm/absinthe/)

**Broadway**

- Concurrent data processing pipelines
- URL: [https://hexdocs.pm/broadway/](https://hexdocs.pm/broadway/)

**GenStage**

- Producer-consumer pipelines with back-pressure
- URL: [https://hexdocs.pm/gen_stage/](https://hexdocs.pm/gen_stage/)

**Tesla**

- HTTP client library
- URL: [https://hexdocs.pm/tesla/](https://hexdocs.pm/tesla/)

**Jason**

- High-performance JSON parser
- URL: [https://hexdocs.pm/jason/](https://hexdocs.pm/jason/)

**Poison**

- Alternative JSON library
- URL: [https://hexdocs.pm/poison/](https://hexdocs.pm/poison/)
...
- URL: [https://hexdocs.pm/mox/](https://hexdocs.pm/mox/)

## Awesome Lists

**Awesome Elixir**

- URL: [https://github.com/h4cc/awesome-elixir](https://github.com/h4cc/awesome-elixir)
...
- URL: [https://github.com/droptheplot/awesome-phoenix](https://github.com/droptheplot/awesome-phoenix)
...
1. Complete [Initial Setup Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/initial-setup)
2. Work through [Quick Start](/en/learn/software-engineering/programming-language/elixir/tutorials/quick-start)
3. Read "Programming Elixir" or "Elixir in Action"
4. Complete [Beginner Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/beginner)
5. Study [Intermediate Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/intermediate) (Phoenix sections)
6. Read "Programming Phoenix"
7. Build a complete Phoenix application
8. Explore [LiveView](/en/learn/software-engineering/programming-language/elixir/how-to/liveview) and [Ecto](/en/learn/software-engineering/programming-language/elixir/how-to/ecto) guides

### Path 2: Backend Systems (OTP Focus)

1. Complete [Initial Setup](/en/learn/software-engineering/programming-language/elixir/tutorials/initial-setup) and [Quick Start](/en/learn/software-engineering/programming-language/elixir/tutorials/quick-start)
2. Read "The Little Elixir & OTP Guidebook"
3. Complete [Beginner Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/beginner) (OTP sections)
4. Study [Intermediate Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/intermediate) (GenServer, Supervisor)
5. Read "Designing Elixir Systems with OTP"
6. Build a distributed concurrent system
7. Study [Advanced Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/advanced) (BEAM internals, distribution)

### Path 3: Complete Mastery

1. Follow Web Developer or Backend Systems path
2. Complete [Advanced Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/advanced)
...
- URL: [https://elixir-lang.org/blog/](https://elixir-lang.org/blog/)
- Content: Release announcements, major updates

**Phoenix Blog**

- URL: [https://phoenixframework.org/blog](https://phoenixframework.org/blog)
- Content: Phoenix framework updates

**José Valim's Blog**

- URL: [https://dashbit.co/blog](https://dashbit.co/blog)
...
- URL: [https://elixirschool.com/id](https://elixirschool.com/id)
...
- URL: [/id/belajar/rekayasa-perangkat-lunak/bahasa-pemrograman/elixir/](/id/belajar/rekayasa-perangkat-lunak/bahasa-pemrograman/elixir/)

Ready to start learning? Begin with our [Initial Setup Tutorial](/en/learn/software-engineering/programming-language/elixir/tutorials/initial-setup) or dive into [Quick Start](/en/learn/software-engineering/programming-language/elixir/tutorials/quick-start)!
