...
- **Production deployment patterns** - See [Intermediate Tutorial](/en/learn/software-engineering/programming-language/java/tutorials/intermediate) and [Advanced Tutorial](/en/learn/software-engineering/programming-language/java/tutorials/advanced)
...
- Java installed and working (JDK 17 or later recommended, see [Initial Setup](/en/learn/software-engineering/programming-language/java/tutorials/initial-setup))
