...
**Next Steps**: Continue to [Advanced](/en/learn/software-engineering/programming-language/rust/tutorials/by-example/advanced) (Examples 58-85) for unsafe code, macros, async/await, and performance optimization.
