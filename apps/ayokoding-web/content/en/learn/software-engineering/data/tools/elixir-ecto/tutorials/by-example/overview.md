...
- **New to Ecto**: Start with [Beginner Examples (1-30)](/en/learn/software-engineering/data/tools/elixir-ecto/tutorials/by-example/beginner)
- **Experienced with other ORMs**: Jump to [Intermediate Examples (31-60)](/en/learn/software-engineering/data/tools/elixir-ecto/tutorials/by-example/intermediate)
- **Performance optimization**: Skip to [Advanced Examples (61-85)](/en/learn/software-engineering/data/tools/elixir-ecto/tutorials/by-example/advanced)
