...
- [Beginner Examples (1-25)](/en/learn/software-engineering/platform-web/jvm-spring-boot/by-example/beginner) - Dependency injection, REST controllers, Spring Data JPA, configuration, file handling, CORS
- [Intermediate Examples (26-55)](/en/learn/software-engineering/platform-web/jvm-spring-boot/by-example/intermediate) - Security, testing, caching, async processing, WebSocket, API versioning, advanced patterns
- [Advanced Examples (56-85)](/en/learn/software-engineering/platform-web/jvm-spring-boot/by-example/advanced) - Microservices, Kubernetes, event sourcing, CQRS, API Gateway, performance tuning, observability
