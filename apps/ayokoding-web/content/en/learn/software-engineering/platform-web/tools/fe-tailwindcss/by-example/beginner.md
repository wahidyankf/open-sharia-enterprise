...
<div class="p-3 text-blue-600 text-lg">
...
<div class="space-y-4 w-64">
  ...
  <p class="no-underline text-blue-600">Link without underline</p>
...
<div class="space-y-4 max-w-xs">
  ...
  <p class="leading-snug text-base">
  ...
  <p class="tracking-tight text-lg font-bold">Tight Tracking Heading</p>
  <!-- => tracking-tight: letter-spacing: -0.025em (tighter for large headings) -->

  <p class="tracking-normal text-base">Normal Tracking Body</p>
  <!-- => tracking-normal: letter-spacing: 0em (default, no modification) -->

  <p class="tracking-wide text-sm uppercase">Wide Tracking Labels</p>
...
<div class="space-y-3">
  ...
  <div class="bg-blue-100 pt-8 pb-2 pl-4 pr-2">
...
<div class="bg-gray-50 p-4">
  ...
  <div class="bg-blue-200 w-32 mx-auto mb-4">
  ...
  <div class="bg-green-200 mt-6 mb-2">
  ...
  <div class="flex">
    ...
    <span class="bg-purple-200 px-2 ml-auto">ml-auto pushes right</span>
...
<div class="flex space-x-4 bg-gray-50 p-4 mt-4">
...
<div class="flex gap-4 bg-gray-50 p-4 mt-4">
...
<div class="grid grid-cols-3 gap-x-6 gap-y-2 bg-gray-50 p-4 mt-4">
...
<div class="space-y-2 bg-gray-50 p-4">
  <div class="bg-blue-200 w-16 p-1">w-16 = 4rem (64px)</div>
  <!-- => w-16: width: 4rem = 64px (each unit = 0.25rem = 4px) -->

  <div class="bg-blue-200 w-32 p-1">w-32 = 8rem (128px)</div>
  <!-- => w-32: width: 8rem = 128px -->

  <div class="bg-blue-200 w-64 p-1">w-64 = 16rem (256px)</div>
  <!-- => w-64: width: 16rem = 256px -->

  <!-- => Fractional widths (percentage-based) -->
  <div class="flex gap-2">
    <div class="bg-green-200 w-1/2 p-1">w-1/2 (50%)</div>
    <!-- => w-1/2: width: 50% of parent -->
    <div class="bg-green-200 w-1/2 p-1">w-1/2 (50%)</div>
  </div>

  <div class="flex gap-2">
    <div class="bg-yellow-200 w-1/3 p-1">w-1/3 (33%)</div>
    <!-- => w-1/3: width: 33.333% -->
    <div class="bg-yellow-200 w-2/3 p-1">w-2/3 (67%)</div>
    <!-- => w-2/3: width: 66.667% -->
  </div>

  <!-- => Full width and max-width -->
  <div class="bg-purple-200 w-full p-1">w-full = 100% width</div>
  <!-- => w-full: width: 100% of parent container -->

  <div class="bg-red-200 max-w-xs p-1">max-w-xs constrains to 320px max</div>
  ...
  <div class="flex items-end gap-2 h-16">
    ...
    <div class="bg-blue-300 w-8 h-4">h-4</div>
    <!-- => h-4: height: 1rem (16px) -->
    <div class="bg-blue-400 w-8 h-8">h-8</div>
    <!-- => h-8: height: 2rem (32px) -->
    <div class="bg-blue-500 w-8 h-12">h-12</div>
...
<div class="space-y-4 p-4 bg-gray-50">
  ...
  <div class="bg-blue-100 max-w-lg mx-auto p-4">
  ...
  <div class="flex gap-2">
    <button class="bg-blue-600 text-white px-3 py-1 min-w-[80px]">
      <!-- => min-w-[80px]: min-width: 80px (arbitrary value syntax) -->
      <!-- => Prevents button from shrinking smaller than 80px -->
      OK
    </button>
    <button class="bg-gray-600 text-white px-3 py-1 min-w-[80px]">Cancel</button>
  </div>

  <!-- => max-h with overflow for scrollable containers -->
  <div class="bg-white border border-gray-200 max-h-32 overflow-y-auto">
  ...
  <div class="h-screen bg-green-100 flex items-center justify-center">
...
<div class="space-y-2 p-4">
  ...
  <div class="bg-white p-3 border">bg-white (#ffffff) - Cards, modals</div>
  ...
  <div class="bg-gray-900 text-white p-3">bg-gray-900 - Dark mode background</div>
  ...
  <div class="bg-blue-600 text-white p-3">bg-blue-600 - Primary action</div>
  <!-- => bg-blue-600: background-color: #2563eb -->

  <div class="bg-green-100 text-green-800 p-3">bg-green-100 - Success toast</div>
  <!-- => bg-green-100: light green background for success states -->
  <!-- => text-green-800: dark green text ensures readable contrast -->

  <div class="bg-red-100 text-red-800 p-3">bg-red-100 - Error state</div>
  <!-- => bg-red-100: light red for error backgrounds -->

  <div class="bg-yellow-100 text-yellow-800 p-3">bg-yellow-100 - Warning</div>
...
<div class="space-y-3 p-4">
  ...
  <div class="divide-y divide-gray-200 bg-white border border-gray-200">
...
<div class="flex flex-wrap gap-3 p-4">
  <div class="bg-blue-200 p-4 w-24 h-24 rounded-none flex items-center justify-center text-xs">
    <!-- => rounded-none: border-radius: 0 (sharp corners) -->
    rounded-none
  </div>

  <div class="bg-blue-200 p-4 w-24 h-24 rounded flex items-center justify-center text-xs">
    <!-- => rounded: border-radius: 0.25rem (4px, slight rounding) -->
    rounded (4px)
  </div>

  <div class="bg-blue-200 p-4 w-24 h-24 rounded-lg flex items-center justify-center text-xs">
    <!-- => rounded-lg: border-radius: 0.5rem (8px, card-style rounding) -->
    rounded-lg
  </div>

  <div class="bg-blue-200 p-4 w-24 h-24 rounded-xl flex items-center justify-center text-xs">
    <!-- => rounded-xl: border-radius: 0.75rem (12px, modern card style) -->
    rounded-xl
  </div>

  <div class="bg-blue-200 p-4 w-24 h-24 rounded-2xl flex items-center justify-center text-xs">
    <!-- => rounded-2xl: border-radius: 1rem (16px, large rounding) -->
    rounded-2xl
  </div>

  <div class="bg-blue-200 p-4 w-24 h-24 rounded-full flex items-center justify-center text-xs">
  ...
  <button class="bg-blue-600 text-white px-4 py-2 rounded-l-full">
    <!-- => rounded-l-full: rounds left side fully (border-top-left and bottom-left) -->
    Left pill
  </button>
  <button class="bg-blue-700 text-white px-4 py-2 rounded-r-full">
...
<div class="flex flex-col gap-2 p-4 bg-gray-50 mt-4">
...
<div class="flex justify-between p-4 bg-gray-50 mt-4">
...
<div class="flex items-center gap-4 p-4 bg-gray-50 h-24 mt-4">
  <!-- => items-center: align-items: center -->
  <!-- => h-24: height: 6rem - makes vertical centering visible -->
  <div class="bg-purple-200 p-2 h-8">Short</div>
  <div class="bg-purple-200 p-6">Tall item</div>
  <div class="bg-purple-200 p-2 h-10">Medium</div>
...
<div class="flex gap-2 p-4 bg-gray-50">
  ...
  <div class="bg-green-200 px-3 py-2 flex-1">
...
<div class="flex gap-2 p-4 bg-gray-50 mt-4">
  <div class="bg-purple-200 px-3 py-2 flex-1">flex-1 (50%)</div>
  <!-- => Each flex-1 gets equal share of available space -->
  <div class="bg-purple-200 px-3 py-2 flex-1">flex-1 (50%)</div>
</div>

<!-- => grow vs shrink behavior -->
<div class="flex gap-2 p-4 bg-gray-50 mt-4 w-64">
  <!-- => w-64: narrow container to see shrink behavior -->

  <div class="bg-yellow-200 p-2 shrink-0">
...
<div class="flex flex-wrap gap-2 p-4 bg-gray-50 mt-4 w-64">
...
<div class="grid grid-cols-2 gap-6 p-4 mt-4">
...
<div class="grid grid-cols-4 gap-4 p-4 mt-4">
  <!-- => 4-column grid for spanning demonstrations -->

  <div class="bg-purple-200 p-4 col-span-4">
    <!-- => col-span-4: grid-column: span 4 / span 4 (full width) -->
    Header (col-span-4: full width)
  </div>

  <div class="bg-purple-300 p-4 col-span-3">
...
<div class="grid gap-4 p-4" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr))">
  ...
  <div class="bg-blue-200 p-4 rounded">Card 1</div>
  <div class="bg-blue-200 p-4 rounded">Card 2</div>
  <div class="bg-blue-200 p-4 rounded">Card 3</div>
  <div class="bg-blue-200 p-4 rounded">Card 4</div>
  <div class="bg-blue-200 p-4 rounded">Card 5</div>
</div>

<!-- => Arbitrary grid columns with Tailwind v3 arbitrary values -->
<div class="grid grid-cols-[1fr_2fr_1fr] gap-4 p-4 mt-4">
...
<!-- => Named grid rows -->
<div class="grid grid-rows-3 gap-2 p-4 mt-4 h-48">
...
<div class="space-y-4 p-4">
  ...
  <input
    class="border border-gray-300 px-3 py-2 rounded focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
  ...
  <button class="bg-blue-600 hover:bg-blue-700 active:bg-blue-900 text-white px-4 py-2 rounded">
...
<div class="space-y-4 p-4">
  ...
  <button
    class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-blue-600"
    disabled
  >
  ...
  <input
    class="border border-gray-300 px-3 py-2 rounded bg-white disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed"
  ...
  <button class="bg-blue-600 text-white px-4 py-2 rounded opacity-75 cursor-wait">
  ...
  <!-- => Visited link state -->
  <div class="space-y-2">
    <a href="#visited-example" class="text-blue-600 visited:text-purple-600 hover:underline block">
...
<div class="space-y-4 p-4">
  <button
    class="bg-gray-200 px-4 py-2 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
  >
  ...
  <div
    class="border-2 border-gray-200 rounded-lg p-4 focus-within:border-blue-500 focus-within:shadow-md transition-all"
  >
...
<div class="p-4 space-y-4">
  ...
  <p class="bg-gray-100 p-2">
    Text with
    <span class="inline-block bg-green-200 px-3 py-1 rounded">inline-block</span>
  ...
  <div class="block md:hidden bg-orange-200 p-2">
    <!-- => block: visible on mobile -->
    <!-- => md:hidden: hidden on tablet and above -->
    Mobile only content
  </div>

  <div class="hidden md:block bg-teal-200 p-2">
...
<div class="space-y-8 p-4">
  ...
  <div class="relative bg-blue-100 p-8 h-32">
  ...
  <div class="h-40 overflow-y-auto bg-gray-100">
    ...
    <div class="sticky top-0 bg-white shadow-sm p-2 font-semibold z-10">
  ...
  <div class="relative h-20">
    <div class="absolute inset-0 bg-blue-300 z-0">z-0 (bottom)</div>
    <!-- => inset-0: top/right/bottom/left: 0 (fills container) -->
    <!-- => z-0: z-index: 0 -->
    <div class="absolute inset-2 bg-green-300 z-10">z-10 (middle)</div>
    <!-- => inset-2: offset 0.5rem from each edge -->
    <!-- => z-10: z-index: 10 (above z-0) -->
    <div class="absolute inset-4 bg-yellow-300 z-20 flex items-center justify-center">z-20 (top)</div>
...
<div class="space-y-4 p-4">
  ...
  <div class="bg-blue-100 w-48 h-16 overflow-hidden">
  ...
  <div class="bg-green-100 w-48 h-16 overflow-auto">
  ...
  <div class="bg-yellow-100 w-48 overflow-x-hidden">
  ...
  <div class="w-20 h-20 rounded-full overflow-hidden bg-gray-200">
    ...
    <img src="https://via.placeholder.com/80" alt="Profile avatar" class="w-full h-full object-cover" />
...
<div class="space-y-4 p-4">
  ...
  <div class="flex flex-wrap gap-3">
    <div class="bg-blue-200 px-4 py-2 cursor-pointer rounded">
      <!-- => cursor-pointer: cursor: pointer (hand cursor, signals clickable) -->
      cursor-pointer (clickable)
    </div>

    <div class="bg-gray-200 px-4 py-2 cursor-not-allowed rounded opacity-50">
      <!-- => cursor-not-allowed: cursor: not-allowed (disabled/unavailable) -->
      cursor-not-allowed (disabled)
    </div>

    <div class="bg-green-200 px-4 py-2 cursor-move rounded">
      <!-- => cursor-move: cursor: move (draggable item) -->
      cursor-move (draggable)
    </div>

    <div class="bg-yellow-200 px-4 py-2 cursor-text rounded">
      <!-- => cursor-text: cursor: text (I-beam, signals text input area) -->
      cursor-text (text input)
    </div>

    <div class="bg-purple-200 px-4 py-2 cursor-wait rounded">
      <!-- => cursor-wait: cursor: wait (spinner, signals loading) -->
      cursor-wait (loading)
    </div>

    <div class="bg-red-200 px-4 py-2 cursor-crosshair rounded">
  ...
  <div class="relative">
    <a href="#" class="block bg-blue-600 text-white px-4 py-2 rounded text-center"> Underlying Link </a>
    <div class="absolute inset-0 bg-gray-900/50 pointer-events-none rounded">
      ...
      <span class="text-white text-xs p-1">Overlay (clicks pass through)</span>
    </div>
  </div>
  ...
  <div class="space-y-2">
    ...
    <p class="select-none bg-gray-100 p-2 rounded">
