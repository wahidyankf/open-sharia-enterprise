...
- [Example 1: Spring Boot Application Starter](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-1-spring-boot-application-starter)
- [Example 2: Dependency Injection Fundamentals](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-2-dependency-injection-fundamentals)
- [Example 3: Bean Lifecycle & Scopes](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-3-bean-lifecycle--scopes)
- [Example 4: Component Scanning & Stereotypes](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-4-component-scanning--stereotypes)
- [Example 5: First REST Controller](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-5-first-rest-controller)
- [Example 6: Path Variables & Query Parameters](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-6-path-variables--query-parameters)
- [Example 7: Request & Response Bodies](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-7-request--response-bodies)
- [Example 8: HTTP Methods & Status Codes](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-8-http-methods--status-codes)
- [Example 9: Content Negotiation](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-9-content-negotiation)
- [Example 10: Spring Data JPA Introduction](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-10-spring-data-jpa-introduction)
- [Example 11: Custom Queries](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-11-custom-queries)
- [Example 12: Entity Relationships](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-12-entity-relationships)
- [Example 13: Pagination & Sorting](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-13-pagination--sorting)
- [Example 14: Database Initialization](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-14-database-initialization)
- [Example 15: Application Properties](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-15-application-properties)
- [Example 16: Configuration Classes](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-16-configuration-classes)
- [Example 17: Profiles for Environments](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-17-profiles-for-environments)
- [Example 18: Global Exception Handling](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-18-global-exception-handling)
- [Example 19: Bean Validation](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-19-bean-validation)
- [Example 20: Custom Validators](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-20-custom-validators)
- [Example 21: Exception Hierarchy - Custom Exceptions](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-21-exception-hierarchy---custom-exceptions)
- [Example 22: File Upload & Download](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-22-file-upload--download)
- [Example 23: Logging Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-23-logging-configuration)
- [Example 24: Request/Response Interceptors](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-24-requestresponse-interceptors)
- [Example 25: CORS Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/beginner#example-25-cors-configuration)

### Intermediate (Examples 21–50)

- [Example 21: @Transactional Basics](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-21-transactional-basics)
- [Example 22: Isolation Levels](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-22-isolation-levels)
- [Example 23: Optimistic Locking](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-23-optimistic-locking)
- [Example 24: Batch Operations](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-24-batch-operations)
- [Example 25: Security Auto-Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-25-security-auto-configuration)
- [Example 26: Custom Authentication](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-26-custom-authentication)
- [Example 27: Method-Level Authorization](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-27-method-level-authorization)
- [Example 28: JWT Authentication](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-28-jwt-authentication)
- [Example 29: OAuth2 Integration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-29-oauth2-integration)
- [Example 30: @SpringBootTest](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-30-springboottest)
- [Example 31: @WebMvcTest](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-31-webmvctest)
- [Example 32: TestContainers](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-32-testcontainers)
- [Example 33: Mocking with Mockito](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-33-mocking-with-mockito)
- [Example 34: Cache Abstraction](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-34-cache-abstraction)
- [Example 35: Redis Integration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-35-redis-integration)
- [Example 36: Cache Strategies](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-36-cache-strategies)
- [Example 37: @Async Methods](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-37-async-methods)
- [Example 38: Task Executors](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-38-task-executors)
- [Example 39: Application Events](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-39-application-events)
- [Example 40: Scheduling](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-40-scheduling)
- [Example 41: WebSocket - Real-Time Communication](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-41-websocket---real-time-communication)
- [Example 42: Server-Sent Events (SSE) - Unidirectional Streaming](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-42-server-sent-events-sse---unidirectional-streaming)
- [Example 43: API Versioning Strategies](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-43-api-versioning-strategies)
- [Example 44: Custom Argument Resolvers](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-44-custom-argument-resolvers)
- [Example 45: Filter vs Interceptor vs AOP](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-45-filter-vs-interceptor-vs-aop)
- [Example 46: Custom Annotations with AOP](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-46-custom-annotations-with-aop)
- [Example 47: Bean Post Processors](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-47-bean-post-processors)
- [Example 48: Custom Spring Boot Starter (Simplified)](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-48-custom-spring-boot-starter-simplified)
- [Example 49: Reactive Repositories with R2DBC](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-49-reactive-repositories-with-r2dbc)
- [Example 50: Composite Keys and Embedded IDs](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/intermediate#example-50-composite-keys-and-embedded-ids)

### Advanced (Examples 41–70)

- [Example 41: RestTemplate - Synchronous HTTP Client](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-41-resttemplate---synchronous-http-client)
- [Example 42: WebClient - Reactive Non-Blocking Client](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-42-webclient---reactive-non-blocking-client)
- [Example 43: Feign Clients - Declarative REST Clients](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-43-feign-clients---declarative-rest-clients)
- [Example 44: Service Discovery - Eureka Client](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-44-service-discovery---eureka-client)
- [Example 45: Spring Boot Actuator - Health & Metrics](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-45-spring-boot-actuator---health--metrics)
- [Example 46: Custom Metrics - Micrometer](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-46-custom-metrics---micrometer)
- [Example 47: Distributed Tracing - Micrometer Tracing](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-47-distributed-tracing---micrometer-tracing)
- [Example 48: Structured Logging - JSON with MDC](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-48-structured-logging---json-with-mdc)
- [Example 49: Circuit Breaker - Resilience4j](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-49-circuit-breaker---resilience4j)
- [Example 50: Retry Pattern - Exponential Backoff](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-50-retry-pattern---exponential-backoff)
- [Example 51: Rate Limiting - API Throttling](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-51-rate-limiting---api-throttling)
- [Example 52: Bulkhead Pattern - Thread Pool Isolation](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-52-bulkhead-pattern---thread-pool-isolation)
- [Example 53: Custom Starter - Creating Reusable Auto-Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-53-custom-starter---creating-reusable-auto-configuration)
- [Example 54: Conditional Beans - Context-Aware Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-54-conditional-beans---context-aware-configuration)
- [Example 55: Configuration Properties - Type-Safe Configuration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-55-configuration-properties---type-safe-configuration)
- [Example 56: Custom Actuator Endpoints - Operational Insights](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-56-custom-actuator-endpoints---operational-insights)
- [Example 57: Docker Containerization - Layered JARs](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-57-docker-containerization---layered-jars)
- [Example 58: Health Checks - Liveness vs Readiness](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-58-health-checks---liveness-vs-readiness)
- [Example 59: Graceful Shutdown - In-Flight Request Handling](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-59-graceful-shutdown---in-flight-request-handling)
- [Example 60: Externalized Configuration - Spring Cloud Config](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-60-externalized-configuration---spring-cloud-config)
- [Example 61: Kubernetes ConfigMaps and Secrets](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-61-kubernetes-configmaps-and-secrets)
- [Example 62: API Gateway Pattern with Spring Cloud Gateway](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-62-api-gateway-pattern-with-spring-cloud-gateway)
- [Example 63: Event Sourcing Pattern](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-63-event-sourcing-pattern)
- [Example 64: CQRS Pattern - Command Query Responsibility Segregation](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-64-cqrs-pattern---command-query-responsibility-segregation)
- [Example 65: Multi-Tenancy Strategies](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-65-multi-tenancy-strategies)
- [Example 66: Spring Native - GraalVM Native Images](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-66-spring-native---graalvm-native-images)
- [Example 67: GraphQL API with Spring for GraphQL](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-67-graphql-api-with-spring-for-graphql)
- [Example 68: Saga Pattern - Distributed Transactions](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-68-saga-pattern---distributed-transactions)
- [Example 69: Performance Tuning - JVM and Spring Boot](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-69-performance-tuning---jvm-and-spring-boot)
- [Example 70: Observability Stack Integration](/en/learn/software-engineering/platform-web/tools/jvm-spring-boot/by-example/advanced#example-70-observability-stack-integration)
