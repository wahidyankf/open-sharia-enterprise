...
Continue to [Intermediate](/en/learn/software-engineering/linux-platform/shell/tutorials/by-example/intermediate) examples for advanced text processing, scripting patterns, process management, and automation techniques (40-75% coverage).
