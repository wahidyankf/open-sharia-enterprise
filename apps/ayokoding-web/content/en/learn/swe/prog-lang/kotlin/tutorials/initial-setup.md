...
- **[Kotlin Quick Start](/en/learn/swe/prog-lang/kotlin/tutorials/quick-start)** - Learn 12 core Kotlin concepts to explore independently. Perfect if you want a fast overview of Kotlin syntax and features.

- **[Complete Beginner's Guide to Kotlin](/en/learn/swe/prog-lang/kotlin/tutorials/beginner)** - Comprehensive foundation covering Kotlin fundamentals from zero. Choose this if you want in-depth coverage with practice exercises.
