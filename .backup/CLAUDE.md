...
See [Core Principles Index](./rules/principles/README.md) for all 10 foundational principles.

## Documentation Standards

All documentation must follow core conventions defined in `rules/conventions/`:
...
See [Conventions Index](./rules/conventions/README.md) for 24 documentation conventions and [Development Index](./rules/development/README.md) for 16 development practices.
...
1. Create detailed documentation in `rules/conventions/` or `rules/development/`
